...
sim_no_health_system = Simulation(
    start_date=start_date, seed=seed, log_config=log_config_no_hs
)
...
sim_no_health_system.register(
    ...
    healthsystem.HealthSystem(
        ...
        service_availability=service_availability_no_hs,
    ),
...
sim_with_health_system = Simulation(
    start_date=start_date, seed=seed, log_config=log_config_with_hs
)
...
sim_with_health_system.register(
    ...
    healthsystem.HealthSystem(
        resourcefilepath=resourcefilepath,
        service_availability=service_availability_with_hs,
    ),
    symptommanager.SymptomManager(resourcefilepath=resourcefilepath),
    healthseekingbehaviour.HealthSeekingBehaviour(resourcefilepath=resourcefilepath),
    healthburden.HealthBurden(resourcefilepath=resourcefilepath),
...
inc_no_hs = log_df_no_hs["tlo.methods.rti"]["summary_1m"][
    "incidence of rti per 100,000"
]
inc_with_hs = log_df_with_hs["tlo.methods.rti"]["summary_1m"][
    "incidence of rti per 100,000"
]
inc_death_no_hs = log_df_no_hs["tlo.methods.rti"]["summary_1m"][
    "incidence of rti death per 100,000"
]
inc_death_with_hs = log_df_with_hs["tlo.methods.rti"]["summary_1m"][
    "incidence of rti death per 100,000"
]
# ------------------------------------- PLOTS  ------------------------------------- #
...
plt.bar(
    [1, 2],
    [mean_inc_rti_death_no_hs, mean_inc_rti_death_with_hs],
