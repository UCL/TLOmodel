...
# Resource file path
filepath_gbd_file = Path("./resources") / "demography" / "ResourceFile_Deaths_and_DALYS_GBD2019.csv"
...
def get_list_of_gbd_causes():
    ...
    raw = pd.read_csv(filepath_gbd_file)
...
def load_gbd_deaths_and_dalys_data(output):
    ...
    gbd = pd.read_csv(filepath_gbd_file)
