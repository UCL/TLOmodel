...
It can be submitted on Azure Batch by running:
    ...
    tlo batch-submit src/scripts/wasting_analyses/scenarios/scenario_wasting_full_model_CS_FS.py

or locally using:

    tlo scenario-run src/scripts/wasting_analyses/scenarios/scenario_wasting_full_model_CS_FS.py
"""
# import itertools
import warnings
