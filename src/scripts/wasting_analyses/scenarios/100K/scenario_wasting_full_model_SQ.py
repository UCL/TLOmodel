...
It can be submitted on Azure Batch by running:
    ...
    tlo batch-submit src/scripts/wasting_analyses/scenarios/100K/scenario_wasting_full_model_SQ.py

or locally using:

    tlo scenario-run src/scripts/wasting_analyses/scenarios/100K/scenario_wasting_full_model_SQ.py
"""
# import itertools
import warnings
