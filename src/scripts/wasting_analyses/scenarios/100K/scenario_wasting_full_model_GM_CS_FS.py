...
It can be submitted on Azure Batch by running:
    ...
    tlo batch-submit src/scripts/wasting_analyses/scenarios/100K/scenario_wasting_full_model_GM_CS_FS.py

or locally using:

    tlo scenario-run src/scripts/wasting_analyses/scenarios/100K/scenario_wasting_full_model_GM_CS_FS.py
"""
# import itertools
import warnings
...
class WastingAnalysis(BaseScenario):
    ...
    def log_configuration(self):
        return {
            'filename': 'wasting_analysis__full_model_GM_CS_FS',
    ...
    # Scaling up Growth Monitoring attendance & Care-Seeking & Food Supplements availability (GM & CS & FS) scenarios
