...
# Save resource, output, and figure output paths
resourcefilepath = Path("./resources")
outputfilepath = Path('./outputs/sejjej5@ucl.ac.uk/wasting/scenarios/costing_outputs')
figurespath = Path('./outputs/sejjej5@ucl.ac.uk/wasting/scenarios/_outcomes')
...
TARGET_PERIOD = (Date(2015, 1, 1), Date(2030, 12, 31))
relevant_period_for_costing = [i.year for i in TARGET_PERIOD]
list_of_relevant_years_for_costing = list(range(relevant_period_for_costing[0], relevant_period_for_costing[1] + 1))
list_of_years_for_plot = list(range(2015, 2031))
...
input_costs = estimate_input_cost_of_scenarios(results_folder, resourcefilepath, _draws = cost_scenarios_draw_nmbs,
