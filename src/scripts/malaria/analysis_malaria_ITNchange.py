...
mort_baseline = np.mean(
    [mort_baseline1.mort_rate, mort_baseline2.mort_rate, mort_baseline3.mort_rate],
    axis=0,
)

mort_itn07 = np.mean(
    [mort_itn071.mort_rate, mort_itn072.mort_rate, mort_itn073.mort_rate], axis=0
)

mort_itn08 = np.mean(
    [mort_itn081.mort_rate, mort_itn082.mort_rate, mort_itn083.mort_rate], axis=0
)

mort_itn09 = np.mean(
    [mort_itn091.mort_rate, mort_itn092.mort_rate, mort_itn093.mort_rate], axis=0
)
# --------------------------------------- create plots --------------------------------------- #
# FIGURES
...
plt.legend(
    ["Baseline", "ITN 0.7", "ITN 0.8", "ITN 0.9"],
