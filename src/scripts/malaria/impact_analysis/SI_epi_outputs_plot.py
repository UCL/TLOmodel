...
results_deaths.to_csv(outputspath / "Apr2024_HTMresults/SI_full_deaths.csv")
...
ax7.legend(loc='upper right',
           labels=['Status Quo', 'Exclude HTM services', 'Treatment ineffective'],
