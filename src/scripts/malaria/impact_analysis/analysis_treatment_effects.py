...
class EffectOfProgrammes(BaseScenario):
    def __init__(self):
        ...
        self.number_of_draws = 4  # todo reset for full runs
    ...
    def draw_parameters(self, draw_number, rng):
        ...
        return {
            'HealthSystem': {
                ...
                #                          service_availability['No_Malaria_*'], service_availability['No_HTM']][draw_number],
                'Service_Availability': [service_availability['No_Hiv_*'], service_availability['No_Tb_*'],
                                         service_availability['No_Malaria_*'], service_availability['No_HTM']][draw_number],
