...
# %%
## 1. DATA IMPORT ##
raw_hhfa = pd.read_csv(path_to_files_in_the_tlo_shared_drive / '0 raw/2_Final data/Q1.csv',
                       low_memory=False)  # import 2018 data
varnames = pd.read_csv(path_to_files_in_the_tlo_shared_drive / '1 processing/variable_list.csv',
