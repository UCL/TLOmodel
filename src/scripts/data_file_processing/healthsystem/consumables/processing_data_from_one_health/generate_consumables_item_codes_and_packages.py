...
workingfile_ehp_consumables = (
    path_to_dropbox / "05 - Resources/Module-healthsystem/From Matthias Arnold/ORIGINAL_Intervention input.xlsx"
)

workingfile_one_health = path_to_dropbox / "07 - Data/OneHealth projection files/OneHealth commodities.xlsx"
...
wb.at[403, "Intervention"] = wb.at[403, "Intervention"] + " for " + wb.at[402, "Drug/Supply Inputs"]
wb.at[403, "Proportion of patients receiving this input"] = 100

wb.at[405, "Intervention"] = wb.at[405, "Intervention"] + " for " + wb.at[404, "Drug/Supply Inputs"]
...
wb.at[553, "Intervention"] = wb.at[553, "Intervention"] + " for " + wb.at[552, "Drug/Supply Inputs"]
wb.at[553, "Proportion of patients receiving this input"] = 100

wb.at[554, "Intervention"] = wb.at[555, "Intervention"] + " for " + wb.at[554, "Drug/Supply Inputs"]
...
wb = wb.rename(columns={"Drug/Supply Inputs": "Items", "Intervention": "Intervention_Pkg", "Cat": "Intervention_Cat"})

wb = wb.loc[:, ["Intervention_Cat", "Intervention_Pkg", "Items", "Expected_Units_Per_Case", "Unit_Cost"]]

# Assign a unique package code
unique_intvs = pd.unique(wb["Intervention_Pkg"])
intv_codes = pd.DataFrame({"Intervention_Pkg": unique_intvs, "Intervention_Pkg_Code": np.arange(0, len(unique_intvs))})
...
item_codes = pd.DataFrame({"Items": unique_items, "Item_Code": np.arange(0, len(unique_items))})
