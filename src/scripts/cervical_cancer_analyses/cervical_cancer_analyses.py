...
out_df = out_df[out_df['rounded_decimal_year'] >= 2012]
...
out_df_6 = out_df_6[out_df_6['rounded_decimal_year'] >= 2012]
...
out_df_9 = out_df_9[out_df_9['rounded_decimal_year'] >= 2012]
...
out_df_4 = out_df_4[out_df_4['rounded_decimal_year'] >= 2012]
...
out_df_13 = out_df_13[out_df_13['rounded_decimal_year'] >= 2012]
...
out_df_14 = out_df_14[out_df_14['rounded_decimal_year'] >= 2012]
...
print(out_df)
plt.figure(figsize=(10, 6))
plt.plot(out_df['rounded_decimal_year'], out_df['n_via_past_year'], marker='o')
plt.title('Number of women screened with via in past year')
plt.xlabel('Year')
plt.ylabel('Number')
plt.grid(True)
# plt.ylim(0, 3000000)
...
print(out_df)
plt.figure(figsize=(10, 6))
plt.plot(out_df['rounded_decimal_year'], out_df['n_xpert_past_year'], marker='o')
plt.title('Number of women screened with xpert in past year')
plt.xlabel('Year')
plt.ylabel('Number')
plt.grid(True)
# plt.ylim(0, 3000000)
