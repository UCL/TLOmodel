...
def apply(results_folder: Path, output_folder: Path, resourcefilepath: Path = None):
    ...
    for draw in range(len(scenario_names)):
        ...
        pd.DataFrame(all_years_data_population_lower)
        pd.DataFrame(all_years_data_population_upper)
        ...
        axes[0, 0].grid(False)
        axes[0, 0].legend(title="Treatment Type", bbox_to_anchor=(1.0, 1), loc="upper left")

        # Panel B: Never Ran Appointments
        for i, appt_type in enumerate(df_all_years_never_ran_mean.index):
            axes[0, 1].plot(
                df_all_years_never_ran_mean.columns,
                df_all_years_never_ran_mean.loc[appt_type],
                marker="o",
                label=appt_type,
            )
        ...
        axes[0, 1].legend(title="Appointment Type", bbox_to_anchor=(1.0, 1), loc="upper left")
        axes[0, 1].grid(False)
        ...
        axes[1, 0].legend(title="Appointment Type", bbox_to_anchor=(1.0, 1), loc="upper left")
        axes[1, 0].grid(False)
        ...
        axes[1, 1].legend(title="Appointment Type", bbox_to_anchor=(1.0, 1), loc="upper left")
        axes[1, 1].grid(False)
        ...
        df_treatments_normalized_mean = df_all_years_treatments_mean.div(
            df_all_years_treatments_mean.iloc[:, 0], axis=0
        )
        df_never_ran_normalized_mean = df_all_years_never_ran_mean.div(df_all_years_never_ran_mean.iloc[:, 0], axis=0)
        df_weather_delayed_normalized_mean = df_all_years_weather_delayed_mean.div(
            df_all_years_weather_delayed_mean.iloc[:, 0], axis=0
        )
        df_weather_cancelled_normalized_mean = df_all_years_weather_cancelled_mean.div(
            df_all_years_weather_cancelled_mean.iloc[:, 0], axis=0
        )
        ...
        for i, treatment_type in enumerate(df_treatments_normalized_mean.index):
            axes[0, 0].plot(
                df_treatments_normalized_mean.columns,
                df_treatments_normalized_mean.loc[treatment_type],
                marker="o",
                label=treatment_type,
            )
        ...
        for i, appt_type in enumerate(df_never_ran_normalized_mean.index):
            axes[0, 1].plot(
                df_never_ran_normalized_mean.columns,
                df_never_ran_normalized_mean.loc[appt_type],
                marker="o",
                label=appt_type,
            )
        ...
        for i, appt_type in enumerate(df_weather_delayed_normalized_mean.index):
            axes[1, 0].plot(
                df_weather_delayed_normalized_mean.columns,
                df_weather_delayed_normalized_mean.loc[appt_type],
                marker="o",
                label=appt_type,
            )
        ...
        for i, appt_type in enumerate(df_weather_cancelled_normalized_mean.index):
            axes[1, 1].plot(
                df_weather_cancelled_normalized_mean.columns,
                df_weather_cancelled_normalized_mean.loc[appt_type],
                marker="o",
                label=appt_type,
            )
    ...
    never_ran_totals_err = np.array(
        [never_ran_totals_mean - never_ran_totals_lower, never_ran_totals_upper - never_ran_totals_mean]
    )
    ...
    axes[0, 1].bar(
        never_ran_totals_mean.index,
        never_ran_totals_mean.values,
        color=scenario_colours,
        yerr=never_ran_totals_err,
        capsize=20,
    )
    ...
    axes[1, 0].bar(
        weather_delayed_totals_mean.iloc[1:].index,
        weather_delayed_totals_mean.iloc[1:].values,
        color=scenario_colours[1:],
        yerr=weather_delayed_totals_err[:, 1:],
        capsize=20,
    )
    ...
    axes[1, 1].bar(
        weather_cancelled_totals_mean.iloc[1:].index,
        weather_cancelled_totals_mean.iloc[1:].values,
        color=scenario_colours[1:],
        yerr=weather_cancelled_totals_err[:, 1:],
        capsize=20,
    )
