...
malawi_admin2 = gpd.read_file(Path(resourcefilepath) / "mapping" / "ResourceFile_mwi_admbnda_adm2_nso_20181016.shp")
...
joined.to_file(
    Path(resourcefilepath) / "climate_change_impacts" / "worldpop_density_with_districts.shp", driver="ESRI Shapefile"
)
