...
def apply(results_folder: Path, output_folder: Path, resourcefilepath: Path = None):
    ...
    scenario_labels_final = ["Scenario"] #["Baseline", "SSP2-4.5"]
    ...
    final_data = {}
    HSI_of_interest = "Weather_cancelled_HSI_Event"
    ...
    for treatment in df_final.index:
        ...
        ax_final.bar(
            scenario_labels_final, values, bottom=bottom, color=get_color_short_treatment_id(treatment), label=treatment
        )
