...
def apply(results_folder: Path, output_folder: Path, resourcefilepath: Path = None):
    ...
    for draw in scenarios_of_interest:
        ...
        all_years_data_dalys_mean = df_all_years_DALYS_mean.sum(axis=1)
        all_years_data_dalys_lower = df_all_years_DALYS_lower.sum(axis=1)
        all_years_data_dalys_upper = df_all_years_DALYS_upper.sum(axis=1)
    ...
    print("all_draws_dalys_mean", all_draws_dalys_mean)
    ...
    print("df_dalys_all_draws_mean", df_dalys_all_draws_mean)
