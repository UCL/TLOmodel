...
running under different MODES and POLICIES (scenario_variable_clinic_config.py)"""
...
def apply(results_folder: Path, output_folder: Path, resourcefilepath: Path = None, ):
    ...
    def get_parameter_names_from_scenario_file() -> Tuple[str]:
        ...
        from scripts.clinics_config_analyses.scenario_variable_clinic_config import (
            VariableClinicConfig,
        )
        e = VariableClinicConfig()
    ...
    print(pop_model)
    print("DALYs by year index **************")
    print(dalys_by_year.index)
    print("Population model index **************")
    print(pop_model.index)
    ...
    year_target = 2026 # This global variable will be passed to custom function
...
# Run as follows
# python src/scripts/clinics_config_analyses/extract_data.py --results-path outputs/s.bhatia@imperial.ac.uk/variable_clinic_config-2026-06-05T135943Z --output-path ConvertedOutputs
# python src/scripts/clinics_config_analyses/extract_data.py --results-path outputs/s.bhatia@imperial.ac.uk/variable_clinic_config-2026-06-06T064750Z --output-path ConvertedOutputs
