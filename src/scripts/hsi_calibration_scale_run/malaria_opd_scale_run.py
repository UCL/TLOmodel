...
```tlo batch-submit src/scripts/hsi_calibration_scale_run/malaria_opd_scale_run.py```

or locally using:
    ```tlo scenario-run src/scripts/hsi_calibration_scale_run/malaria_opd_scale_run.py```
