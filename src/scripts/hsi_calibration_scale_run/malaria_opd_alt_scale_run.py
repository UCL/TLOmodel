...
```tlo batch-submit src/scripts/hsi_calibration_scale_run/malaria_opd_alt_scale_run.py```

or locally using:
    ```tlo scenario-run src/scripts/hsi_calibration_scale_run/malaria_opd_alt_scale_run.py``
...
class LongRun(BaseScenario):
    ...
    def draw_parameters(self, draw_number, rng):
        return {
            'Malaria': {
                'testing_adj_malaria': [0.35, 0.5][draw_number],
            }
        }
