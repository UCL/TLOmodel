...
total_staff_count_by_cadre = staff_count_by_cadre_and_level.groupby('Cadre')['0_0'].sum()

# Staff count as per the resourcefile
actual_staff_count = pd.read_csv(resourcefilepath / 'healthsystem' / 'human_resources' / 'actual' /
