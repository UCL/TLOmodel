...
for label, service_avail in scenarios.items():
    ...
    sim.register(
        ...
        healthsystem.HealthSystem(
            resourcefilepath=resourcefilepath, disable=_disable, disable_and_reject_all=_disable_and_reject_all
        ),
...
for label, file in output_files.items():
    inc_by_pathogen[label], deaths[label] = get_incidence_rate_and_death_numbers_from_logfile(file)
