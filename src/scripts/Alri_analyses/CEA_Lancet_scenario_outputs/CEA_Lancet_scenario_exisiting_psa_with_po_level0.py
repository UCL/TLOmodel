""" This script will output the scenario outcomes for existing psa with pulse oximetry implemented at level 0 """
...
sa_name = 'po_cost_double'  # change the name if sensitivity analysis
...
if __name__ == "__main__":
    ...
    # PULSE OXIMETRY COST ----------
    po_cost_by_usage_rate = {'perfect': [0.167*2, 0.096*2, 0.063*2], 'imperfect': [0.167*2, 0.096*2, 0.063*2]}
