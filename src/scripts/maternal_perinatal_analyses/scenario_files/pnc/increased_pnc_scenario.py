...
class IncreasedPNCScenario(BaseScenario):
    ...
    def log_configuration(self):
        return {
            "filename": "increased_pnc_cov_250k",
            "directory": "./outputs",
            "custom_levels": {
                "*": logging.WARNING,
    ...
    def modules(self):
        return [
            ...
            healthsystem.HealthSystem(
                resourcefilepath=self.resources, mode_appt_constraints=1, cons_availability="default"
            ),
    ...
    def draw_parameters(self, draw_number, rng):
        return {
            "Labour": {"alternative_pnc_coverage": True, "pnc_availability_odds": 15.0, "analysis_year": 2023},
