"""
Produce plots to show the health impact (deaths, dalys) of the healthcare system (overall health impact) when
running under two different hcw scenarios results from
tlo batch-download --username mm2908@ic.ac.uk scenario_impact_of_policy-2023-06-20T105712Z:
"draws": [
    {
      "draw_number": 0,  # -> the actual hcw scenario/the "Actual HCW"
      "draw_seed": 209652396,
      "parameters": {
        "SymptomManager": {
    ...
    },
    {
      ...
      "parameters": {
        ...
        "HealthSystem": {
          ...
          "use_funded_or_actual_staffing": "funded_plus",  # -> the funded_plus hcw scenario/the "Establishment HCW"
          "mode_appt_constraints": 2,
          "cons_availability": "default",
          "beds_availability": "default",
          "Policy_Name": "Naive"
...
def apply(results_folder: Path, output_folder: Path, resourcefilepath: Path = None, ):
    ...
    def get_parameter_names_from_scenario_file() -> Tuple[str]:
        """define the scenario names for the two draws"""
        return ("Actual HCW", "Establishment HCW")
    ...
    name_of_plot = f'Additional Deaths Averted vs Actual HCW, {target_period()}'
    fig, ax = do_bar_plot_with_ci(
        (num_deaths_averted / 1e4).clip(lower=0.0),
        annotations=[
    ...
    name_of_plot = f'Additional DALYs Averted vs Actual HCW, {target_period()}'
    fig, ax = do_bar_plot_with_ci(
