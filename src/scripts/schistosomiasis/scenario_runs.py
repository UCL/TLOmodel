...
tlo parse-log /Users/tmangal/PycharmProjects/TLOmodel/outputs/schisto_scenarios-2025-08-23T102633Z/0/0
...
class SchistoScenarios(BaseScenario):
    ...
    def __init__(self):
        ...
        # todo reset
        self.end_date = Date(2051, 1, 1)  # todo 2051 = 25 years of projections
        self.pop_size = 96_000  # todo if equal_allocation_by_district, 96,000=3k per district
        self.runs_per_draw = 10  # todo update
