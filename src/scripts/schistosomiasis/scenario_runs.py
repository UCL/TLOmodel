...
tlo parse-log /Users/tmangal/PycharmProjects/TLOmodel/outputs/schisto_scenarios-2025-07-24T100052Z/0/0
...
class SchistoScenarios(BaseScenario):
    ...
    def __init__(self):
        ...
        # todo reset
        self.end_date = Date(2046, 1, 1)  # todo 2041 = 15 years of projections
