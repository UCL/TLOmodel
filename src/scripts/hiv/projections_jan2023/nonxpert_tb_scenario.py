...
It can be submitted on Azure Batch by running:
   ...
   tlo batch-submit src/scripts/hiv/projections_jan2023/nonxpert_tb_scenario.py
or locally using:
 tlo scenario-run src/scripts/hiv/projections_jan2023/nonxpert_tb_scenario.py
  execute a single run:
 tlo scenario-run src/scripts/hiv/projections_jan2023/nonxpert_tb_scenario.py --draw 1 0

 check the batch configuration gets generated without error:
tlo scenario-run --draw-only src/scripts/hiv/projections_jan2023/nonxpert_tb_scenario.py
Job ID: nonxpert_tb_scenario-2023-06-23T213147Z
