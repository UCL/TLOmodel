...
with open(outputpath / "default_run2x.pickle", "rb") as f:
    output = pickle.load(f)
...
cons_available .to_excel(outputpath / "cons_available_2x.xlsx")
#
...
TB_incidence.to_excel(outputpath / "new_TB_cases_2x.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_2x.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_2x.xlsx")
