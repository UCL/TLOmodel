...
with open(outputpath / "default_run_xpert1.pickle", "rb") as f:
    output = pickle.load(f)
...
cons_available .to_excel(outputpath / "cons_available_xpert1.xlsx")
#
...
TB_incidence.to_excel(outputpath / "new_TB_cases_xpert1.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_xpert1.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_xpert1.xlsx")
