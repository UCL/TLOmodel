...
with open(outputpath / "noxpert2.pickle", "rb") as f:
    output = pickle.load(f)
...
cons_available .to_excel(outputpath / "cons_available_noxpert2.xlsx")
...
TB_incidence.to_excel(outputpath / "new_TB_cases_noxpert2.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_noxpert2.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_noxpert2.xlsx")
