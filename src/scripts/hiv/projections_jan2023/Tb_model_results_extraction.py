...
cons_available .to_excel(outputpath / "cons_available_4x.xlsx")
#
...
TB_incidence.to_excel(outputpath / "new_TB_cases_4x.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_4x.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_4x.xlsx")
