...
cons_available .to_excel(outputpath / "cons_available_3x.xlsx")
#
...
TB_incidence.to_excel(outputpath / "new_TB_cases_3x.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_3x.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_3x.xlsx")
