...
with open(outputpath / "DAH_run4.pickle", "rb") as f:
    output = pickle.load(f)
...
cons_available .to_excel(outputpath / "cons_available_4.xlsx")
#
...
TB_incidence.to_excel(outputpath / "new_TB_cases_4.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_4.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_4.xlsx")
