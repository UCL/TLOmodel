...
cons_available .to_excel(outputpath / "cons_available_baseline2.xlsx")
...
TB_incidence.to_excel(outputpath / "new_TB_cases_baseline2.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_baseline2.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_baseline2.xlsx")
