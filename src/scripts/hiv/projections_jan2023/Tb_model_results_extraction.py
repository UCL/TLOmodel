...
with open(outputpath / "nocxr3.pickle", "rb") as f:
    output = pickle.load(f)
...
cons_available .to_excel(outputpath / "cons_available_nocxr3.xlsx")
...
TB_incidence.to_excel(outputpath / "new_TB_cases_nocxr3.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_nocxr3.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_nocxr3.xlsx")
