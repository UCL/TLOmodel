...
with open(outputpath / "default_run0x.pickle", "rb") as f:
    output = pickle.load(f)
...
cons_available .to_excel(outputpath / "cons_available_0x.xlsx")
#
...
TB_incidence.to_excel(outputpath / "new_TB_cases_0x.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_0x.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_0x.xlsx")
