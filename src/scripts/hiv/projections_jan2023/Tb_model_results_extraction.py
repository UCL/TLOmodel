...
with open(outputpath / "DAH_run3.pickle", "rb") as f:
    output = pickle.load(f)
...
cons_available .to_excel(outputpath / "cons_available_3.xlsx")
#
...
TB_incidence.to_excel(outputpath / "new_TB_cases_3.xlsx")
...
sample_dalys.to_excel(outputpath / "dalys_3.xlsx")
...
sample_deaths.to_excel(outputpath / "mortality_3.xlsx")
