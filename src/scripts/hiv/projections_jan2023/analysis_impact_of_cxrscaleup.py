...
# python src/scripts/hiv/projections_jan2023/analysis_impact_of_cxrscaleup.py --scenario-outputs-folder outputs\nic503@york.ac.uk
import argparse
import datetime
...
results_folder = get_scenario_outputs("cxr_tb_scaleup_scenario-2023-06-23T213616Z", outputspath) [-1]
...
tb_pyears.to_excel(outputspath / "pyears_cxrscaleup.xlsx")
...
combined_tb_table.to_excel(outputspath / "combined_tb_table_cxrscaleup.xlsx")
...
def tb_mortality_rate(results_folder, pyears):
    ...
    tb_deaths2.to_excel(outputspath / "raw_mortality_cxrscaleup.xlsx")
...
mortality_rates_summary.to_excel(outputspath / "mortality_rates_cxrscaleup.xlsx",index=False)
...
print(dalys_summary)
dalys_summary.to_excel(outputspath / "summarised_tb_dalys_cxrscaleup.xlsx")
...
tb_hiv_prop.to_excel(outputspath / "PLHIV_tb_cxrscaleup.xlsx")
...
mdr_tb.to_excel(outputspath / "mdr_tb_cxrscaleup.xlsx")
...
tb_treatment_cov.to_excel(outputspath / "tb_treatment_coverage_cxrscaleup.xlsx")
...
tb_incidence.to_excel(outputspath / "tb_incidence_cxrscaleup.xlsx")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        "Analyse scenario results for No CXR TB diagnosis"
    )
    parser.add_argument(
