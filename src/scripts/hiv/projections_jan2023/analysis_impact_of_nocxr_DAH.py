...
# python src/scripts/hiv/projections_jan2023/analysis_impact_of_nocxr_DAH.py --scenario-outputs-folder outputs\nic503@york.ac.uk
import argparse
import datetime
...
results_folder = get_scenario_outputs("noncxr_tb_scenario-2023-07-03T212220Z", outputspath) [-1]
...
tb_pyears.to_excel(outputspath / "pyears_nocxr.xlsx")
...
combined_tb_table.to_excel(outputspath / "combined_tb_table_nocxr.xlsx")
...
def tb_mortality_rate(results_folder, pyears):
    ...
    tb_deaths2.to_excel(outputspath / "raw_mortality_nocxr.xlsx")
...
mortality_rates_summary.to_excel(outputspath / "mortality_rates_nocxr.xlsx",index=False)
...
print(dalys_summary)
dalys_summary.to_excel(outputspath / "summarised_tb_dalys_nocxr.xlsx")
...
tb_treatment_cov.to_excel(outputspath / "tb_treatment_coverage_nocxr.xlsx")
...
tb_incidence.to_excel(outputspath / "tb_incidence_nocxr.xlsx")
