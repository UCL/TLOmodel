...
with open(outputpath / "default_run2.pickle", "rb") as f:
...
sample_dalys.to_excel(outputpath / "sample_dalys_nocxr.xlsx")
...
sample_deaths.to_excel(outputpath / "expected_mortality_nocxr.xlsx")
