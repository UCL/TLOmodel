...
with open(outputpath / "default_runcxr.pickle", "rb") as f:
...
cons_available .to_excel(outputpath / "cons_available_cxr.xlsx")
...
TB_incidence.to_excel(outputpath / "new_TB_cases_cxr.xlsx")
#
...
sample_dalys.to_excel(outputpath / "sample_dalys_cxr.xlsx")
...
sample_deaths.to_excel(outputpath / "expected_mortality_cxr.xlsx")
