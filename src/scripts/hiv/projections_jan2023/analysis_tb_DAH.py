...
results_folder = get_scenario_outputs("Tb_DAH_impactx39-2023-11-25T154211Z", outputspath)[-1]
...
CXR_upscale_lower = dalys_summary.loc[:, ('CXR upscale', 'lower')].sum()
CXR_upscale_upper = dalys_summary.loc[:, ('CXR upscale', 'upper')].sum()
...
CXR_upscale = tb_mortality.loc[:, ('CXR upscale', 'mean')].sum()
...
CXR_upscale_lower = tb_mortality.loc[:, ('CXR upscale', 'lower')].sum()
CXR_upscale_upper = tb_mortality.loc[:, ('CXR upscale', 'upper')].sum()
