...
results_folder = get_scenario_outputs("Tb_DAH_impactx36-2023-11-24T141428Z", outputspath)[-1]
...
ax.set_xticks(x)
ax.set_xticklabels(['Baseline', 'No Xpert', 'No CXR', 'CXR Scaleup10','CXR_outreach'])
ax.legend()
