...
# python src/scripts/hiv/projections_jan2023/analysis_impact_of_outreach.py --scenario-outputs-folder outputs\nic503@york.ac.uk
import argparse
import datetime
...
results_folder = get_scenario_outputs("outreach_services_scenario-2023-07-04T140807Z", outputspath) [-1]
...
tb_pyears.to_excel(outputspath / "pyears_outreach2.xlsx")
...
combined_tb_table.to_excel(outputspath / "combined_tb_table_outreach2.xlsx")
...
def tb_mortality_rate(results_folder, pyears):
    ...
    tb_deaths2.to_excel(outputspath / "raw_mortality_outreach2.xlsx")
...
mortality_rates_summary.to_excel(outputspath / "mortality_rates_outreach2.xlsx",index=False)
...
print(dalys_summary)
dalys_summary.to_excel(outputspath / "summarised_tb_dalys_outreach2.xlsx")
...
tb_hiv_prop.to_excel(outputspath / "PLHIV_tb_outreach2.xlsx")
...
mdr_tb.to_excel(outputspath / "mdr_tb_outreach2.xlsx")
...
tb_treatment_cov.to_excel(outputspath / "tb_treatment_coverage_outreach2.xlsx")
...
tb_incidence.to_excel(outputspath / "tb_incidence_outreach2.xlsx")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        "Analyse scenario results for outreach services for TB screening"
    )
    parser.add_argument(
