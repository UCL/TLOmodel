...
results_folder = get_scenario_outputs("outreach_tb_services_scenario-2023-06-23T213902Z", outputspath) [-1]
...
tb_pyears.to_excel(outputspath / "pyears_outreach.xlsx")
...
combined_tb_table.to_excel(outputspath / "combined_tb_table_outreach.xlsx")
...
def tb_mortality_rate(results_folder, pyears):
    ...
    tb_deaths2.to_excel(outputspath / "raw_mortality_outreach.xlsx")
...
mortality_rates_summary.to_excel(outputspath / "mortality_rates_outreach.xlsx",index=False)
...
print(dalys_summary)
dalys_summary.to_excel(outputspath / "summarised_tb_dalys_outreach.xlsx")
...
tb_hiv_prop.to_excel(outputspath / "PLHIV_tb_outreach.xlsx")
...
mdr_tb.to_excel(outputspath / "mdr_tb_outreach.xlsx")
...
tb_treatment_cov.to_excel(outputspath / "tb_treatment_coverage_outreach.xlsx")
...
tb_incidence.to_excel(outputspath / "tb_incidence_outreach.xlsx")
