...
results_folder = get_scenario_outputs("nonxpert_tb_scenario-2023-06-22T143034Z", outputspath)[-1]
...
active_tb_cases = "tb_inc_activeTB_inc_rate.xlsx"
with pd.ExcelWriter(active_tb_cases) as writer:
    tb_inc.to_excel(writer, sheet_name="tb_inc")
    activeTB_inc_rate_df.to_excel(writer, sheet_name="activeTB_inc_rate")
...
summary_dalys.to_excel(outputspath / "summary_tb_dalys.xlsx")
