...
tlo scenario-run --draw-only src/scripts/hiv/PaperProjectionsNov2022/scenario9.py
Run on the batch system using:
tlo batch-submit src/scripts/hiv/projections_jan2023/scenario9.py
    ...
    def draw_parameters(self, draw_number, rng):
        return {
            'Tb': {
                ...
                'tb_healthseekingbehaviour_cap': 0
            },
            'Hiv': {
                'beta': [0.143785163, 0.137641638, 0.130761192, 0.141134768, 0.11937769][draw_number],
                'hiv_healthseekingbehaviour_cap': 0,
                'probability_of_seeking_further_art_appointment_if_drug_not_available': 0,
                'probability_of_seeking_further_art_appointment_if_appointment_not_available': 0
            },
        }
