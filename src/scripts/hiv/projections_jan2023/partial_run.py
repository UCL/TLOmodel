...
class ImpactOfTbDaHx(BaseScenario):
    ...
    def log_configuration(self):
        return {
            'filename': 'Tb_DAH_scenarios_test_run43_partial',
    ...
    def _get_scenarios(self) -> Dict[str, Dict]:
        ...
        # overrides availability of Xpert
            "No Xpert Available": {
                'Tb': {
                    'scenario': 1,
                   'scaling_factor_WHO': 2.1,   #previously 1.95
                },
            },
        # overrides availability of CXR
            ...
            "CXR scale_up": {
                 'Tb': {
                     'scenario': 3,
                     'scaling_factor_WHO': 1.2, # previously was 1.0
                 }
            },
            "CXR scale_up20": {
                'Tb': {
                    'scenario': 4,
                    'scaling_factor_WHO': 0.9,  # /previously was 1.0
                }
            },
            "Outreach services": {
                'Tb': {
