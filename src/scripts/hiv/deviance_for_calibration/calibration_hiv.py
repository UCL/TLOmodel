...
tlo scenario-run --draw-only src/scripts/hiv/deviance_for_calibration/calibration_hiv.py
...
tlo batch-submit src/scripts/hiv/deviance_for_calibration/calibration_hiv.py

20th May 2022 runs:
Job ID: calibration_hiv-2022-05-20T201400Z

Display information about a job:
tlo batch-job calibration_hiv-2022-05-20T201400Z --tasks
...
class TestScenario(BaseScenario):
    ...
    def draw_parameters(self, draw_number, rng):
        ...
        return {
            'Hiv': {
                'beta': np.linspace(0.08, 0.175, num=self.number_of_draws)[draw_number]
            },
        }
