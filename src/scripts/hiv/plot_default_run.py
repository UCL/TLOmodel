...
# adults:
adult_prev_and_inc_over_time = output['tlo.methods.hiv'][
    'summary_inc_and_prev_for_adults_and_children_and_fsw'][
    ['date', 'hiv_prev_adult', 'hiv_adult_inc']
]
...
# children:
child_prev_and_inc_over_time = output['tlo.methods.hiv'][
    'summary_inc_and_prev_for_adults_and_children_and_fsw'][['date', 'hiv_prev_child', 'hiv_child_inc']]
...
# female sex workers:
fsw_prev_over_time = output['tlo.methods.hiv'][
    'summary_inc_and_prev_for_adults_and_children_and_fsw'][['date', 'hiv_prev_fsw']]
