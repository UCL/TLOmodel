...
tlo scenario-run --draw-only src/scripts/hiv/hiv_tb_projections_may2022/scenario3.py

Run on the batch system using:
tlo batch-submit src/scripts/hiv/hiv_tb_projections_may2022/scenario3.py
