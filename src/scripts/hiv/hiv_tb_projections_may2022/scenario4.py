...
tlo scenario-run --draw-only src/scripts/hiv/hiv_tb_projections_may2022/scenario4.py

Run on the batch system using:
tlo batch-submit src/scripts/hiv/hiv_tb_projections_may2022/scenario4.py
...
9th June
Job ID: scenario4-2022-06-09T170415Z
