...
or locally using:
 tlo scenario-run src/scripts/hiv/DAH/tb_DAH_scenarios11x.py
  execute a single run:
 tlo scenario-run src/scripts/hi/DAH/tb_DAH_scenarios11x.py --draw 1 0
 check the batch configuration gets generated without error:
tlo scenario-run --draw-only src/scripts/hiv/DAH/tb_DAH_scenarios11x.py
