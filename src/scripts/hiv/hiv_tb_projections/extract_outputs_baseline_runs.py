...
write_to_excel("summary_inc_and_prev_for_adults_and_children_and_fsw", "n_new_infections_male_1549")
write_to_excel("summary_inc_and_prev_for_adults_and_children_and_fsw", "n_new_infections_female_1524")
write_to_excel("summary_inc_and_prev_for_adults_and_children_and_fsw", "n_new_infections_female_2549")
...
for draw in info["number_of_draws"]:
    ...
    aids_deaths[name]["aids_deaths_rate_100kpy"] = (
                                                       aids_deaths[name]["median"].values / py_summary[
                                                       "mean"].values) * 100000

    aids_deaths[name]["aids_deaths_rate_100kpy_lower"] = (
                                                             aids_deaths[name]["lower"].values / py_summary[
                                                             "mean"].values) * 100000

    aids_deaths[name]["aids_deaths_rate_100kpy_upper"] = (
                                                             aids_deaths[name]["upper"].values / py_summary[
                                                             "mean"].values) * 100000
...
for draw in info["number_of_draws"]:
    ...
    aids_tb_deaths[name]["aids_TB_deaths_rate_100kpy"] = (
                                                             aids_tb_deaths[name]["median"].values / py_summary[
                                                             "mean"].values) * 100000

    aids_tb_deaths[name]["aids_TB_deaths_rate_100kpy_lower"] = (
                                                                   aids_tb_deaths[name]["lower"].values / py_summary[
                                                                   "mean"].values) * 100000

    aids_tb_deaths[name]["aids_TB_deaths_rate_100kpy_upper"] = (
                                                                   aids_tb_deaths[name]["upper"].values / py_summary[
                                                                   "mean"].values) * 100000
