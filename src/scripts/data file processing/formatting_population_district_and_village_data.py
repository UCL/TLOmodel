...
num_ppl_in_Lilongwe_total = district_wb_trimmed.loc[district_wb_trimmed[
                                                        'District'] == 'Lilongwe', 'District Total'].values + \
                            district_wb_trimmed.loc[district_wb_trimmed[
                                                        'District'] == 'Lilongwe City', 'District Total'].values
district_wb_trimmed = district_wb_trimmed.drop(
    district_wb_trimmed.index[district_wb_trimmed['District'] == 'Lilongwe City'])
...
num_ppl_in_Mzuzu = district_wb_trimmed.loc[
    district_wb_trimmed['District'] == 'Mzuzu City', 'District Total'].values
district_wb_trimmed.loc[district_wb_trimmed[
                            'District'] == 'Lilongwe', 'District Total'] = num_ppl_in_Lilongwe_total + num_ppl_in_Mzuzu
district_wb_trimmed = district_wb_trimmed.drop(
    district_wb_trimmed.index[district_wb_trimmed['District'] == 'Mzuzu City'])
...
num_villages_per_district = num_villages_per_district.rename(
    columns={'Village': 'NumVillagesPerDistrict'})
