...
print("F. STERIL. USE:")
co_use_f_steril_2010_2020_df = co_use_df.loc[
...
co_use_f_steril_2010_2020_SUM_df = pd.DataFrame(
    [co_use_f_steril_2010_2020_df.sum(), Model_total],
    columns=list(co_use_f_steril_2010_2020_df.columns),
    index=["Total with f. steril.: 15-49", "Total all women: 15-49"],
)
co_use_f_steril_2010_2020_df = pd.concat(
    [co_use_f_steril_2010_2020_df, co_use_f_steril_2010_2020_SUM_df]
)
