...
avail_data = pd.read_csv(Path("resources/healthsystem/consumables/" + avail_data_filename))

items_pkgs = pd.read_csv(Path("resources/healthsystem/consumables/" + RF_of_interest_filename))
