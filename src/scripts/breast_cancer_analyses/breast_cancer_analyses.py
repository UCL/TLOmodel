...
counts.plot(y=["total_stage1", "total_stage2", "total_stage3", "total_stage4"])
...
results_no_healthsystem["dalys"].plot.bar(
    y=["YLD_BreastCancer_0", "YLL_BreastCancer_BreastCancer"], stacked=True
)
...
counts = results_with_healthsystem["total_counts_by_stage_over_time"][
    ["total_stage1", "total_stage2", "total_stage3", "total_stage4"]
].iloc[-1]

totpopsize = (
    results_with_healthsystem["total_counts_by_stage_over_time"][
        ["total_none", "total_stage1", "total_stage2", "total_stage3", "total_stage4"]
    ]
    .iloc[-1]
    .sum()
)
