...
```tlo batch-submit src/scripts/overview_paper/A_big_run_for_calibration_plots/scenario_big_run.py```

or locally using:
    ```tlo scenario-run src/scripts/overview_paper/A_big_run_for_calibration_plots/scenario_big_run.py```
