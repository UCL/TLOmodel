...
sf = shp.Reader(
    shp=open(resourcefilepath / "ResourceFile_mwi_admbnda_adm2_nso_20181016.shp", "rb"),
...
paracetamol_df = pd.read_csv(
    resourcefilepath / "ResourceFile_Example_Paracetamol_DataFrame.csv"
)
...
# save the figure
plt.savefig(
    outputfilepath / "Map_Paracetamol_Stock_Out_Days_Example.png",
    bbox_inches="tight",
    dpi=600,
)
