...
counts["age_grp"] = (
    counts["age_years"]
    .map({0: "0y", 1: "1y", 2: "2-4y", 3: "2-4y", 4: "2-4y"})
    .fillna("5+y")
)
...
for ax_num, pathogen in enumerate(calibration_incidence_rate_0_year_olds.keys()):
    ...
    ax.hlines(
        y=calibration_incidence_rate_0_year_olds[pathogen],
...
plt.tight_layout()
plt.savefig(
    outputpath / ("Diarrhoea_inc_rate_calibration_0_year_olds" + datestamp + ".png"),
    format="png",
)
plt.show()
...
plt.tight_layout()
plt.savefig(
    outputpath / ("Diarrhoea_inc_rate_calibration_1_year_olds" + datestamp + ".png"),
    format="png",
)
plt.show()
...
plt.tight_layout()
plt.savefig(
    outputpath / ("Diarrhoea_inc_rate_calibration_2-4_year_olds" + datestamp + ".png"),
    format="png",
)
plt.show()
...
all_deaths["age_grp"] = all_deaths["age"].map(
    {0: "0y", 1: "1y", 2: "2-4y", 3: "2-4y", 4: "2-4y"}
)
...
plt.tight_layout()
plt.savefig(
    outputpath / ("Diarrhoea_death_rate_0-5_year_olds" + datestamp + ".png"),
    format="png",
)
plt.show()
...
comparison.loc[
    ("2015-2019", slice(None), "0-4", "Childhood Diarrhoea")
].sum().plot.bar()
plt.title("Deaths per year due to Childhood Diarrhoea, 2015-2019")
plt.tight_layout()
plt.savefig(
    outputpath
    / ("Diarrhoea_death_rate-calibration_0-4_year_olds" + datestamp + ".png"),
    format="png",
)
plt.show()
