...
1 - (len(cohort_treated.loc[cohort_treated["days_treatment_to_death"] < (5 * 365.25)]) / len(cohort_treated))  # 0.77
print(1 - (len(cohort_treated.loc[cohort_treated["days_treatment_to_death"] < (5 * 365.25)]) / len(cohort_treated)))
