    ...
    * `on_birth(mother, child)`
    ...
    PARAMETERS = {
        "pregnancy_probability": Parameter(
            Types.REAL,
            "Fixed probability of pregnancy each month (if not already pregnant)",
        ),
    }
    ...
    PROPERTIES = {
        ...
        "date_of_birth": Property(Types.DATE, "When the individual was born"),
        "children": Property(
            Types.LIST, "The children born to this individual, in birth order"
        ),
    }
