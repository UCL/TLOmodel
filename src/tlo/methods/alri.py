...
class Alri(Module):
    ...
    pathogens = {
        ...
        "fungal/other": ["P.jirovecii", "other_pathogens_NoS"],
    }
    ...
    CAUSES_OF_DEATH = {
        f"ALRI_{path}": Cause(
            gbd_causes={"Lower respiratory infections"},
    ...
    disease_types = sorted({"pneumonia", "other_alri"})
    ...
    PARAMETERS = {
        ...
        "base_inc_rate_ALRI_by_Strep_pneumoniae_PCV13": Parameter(
            Types.LIST,
        ...
        "base_inc_rate_ALRI_by_Strep_pneumoniae_non_PCV13": Parameter(
            Types.LIST,
        ...
        "base_inc_rate_ALRI_by_Staph_aureus": Parameter(
            Types.LIST,
        ...
        "base_inc_rate_ALRI_by_P.jirovecii": Parameter(
            Types.LIST,
            "baseline incidence of Alri caused by P. jirovecii in age groups 0-11, "
            "12-23, 24-59 months, per child per year",
        ),
        "base_inc_rate_ALRI_by_other_viral_pathogens": Parameter(
            Types.LIST,
            "baseline incidence of Alri caused by other viral pathogens in age groups 0-11, 12-23, "
            "24-59 months, per child per year",
        ),
        "base_inc_rate_ALRI_by_other_bacterial_pathogens": Parameter(
            Types.LIST,
            "baseline incidence of Alri caused by other viral pathogens in age groups 0-11, 12-23, "
            "24-59 months, per child per year",
        ),
        "base_inc_rate_ALRI_by_other_pathogens_NoS": Parameter(
            Types.LIST,
        ...
        "max_alri_duration_in_days_without_treatment": Parameter(
            Types.REAL,
            "maximum duration in days of untreated ALRI episode, assuming an average of 7 days",
        ),
        # Probability of complications -----
        "overall_progression_to_severe_ALRI": Parameter(
            Types.REAL, "probability of progression to severe ALRI"
        ),
        "prob_pulmonary_complications_in_pneumonia": Parameter(
            Types.REAL, "probability of pulmonary complications in (CXR+) pneumonia"
        ),
        "prob_pleural_effusion_in_pulmonary_complicated_pneumonia": Parameter(
            Types.REAL,
            "probability of pleural effusion in pneumonia with pulmonary complications",
        ),
        "prob_empyema_in_pulmonary_complicated_pneumonia": Parameter(
            Types.REAL,
            "probability of empyema in pneumonia with pulmonary complications",
        ),
        "prob_lung_abscess_in_pulmonary_complicated_pneumonia": Parameter(
            Types.REAL,
            "probability of lung abscess in pneumonia with pulmonary complications",
        ),
        "prob_pneumothorax_in_pulmonary_complicated_pneumonia": Parameter(
            Types.REAL,
            "probability of pneumothorax in pneumonia with pulmonary complications",
        ),
        "prob_hypoxaemia_in_pneumonia": Parameter(
            Types.REAL, "probability of hypoxaemia in pneumonia cases"
        ),
        "prob_hypoxaemia_in_other_alri": Parameter(
            Types.REAL,
            "probability of hypoxaemia in bronchiolitis and other alri cases",
        ),
        "prob_bacteraemia_in_pneumonia": Parameter(
            Types.REAL, "probability of bacteraemia in pneumonia"
        ),
        "prob_progression_to_sepsis_with_bacteraemia": Parameter(
            Types.REAL, "probability of progression to sepsis from bactereamia"
        ),
        "proportion_hypoxaemia_with_SpO2<90%": Parameter(
            Types.REAL, "proportion of hypoxaemic children with SpO2 <90%"
        ),
        # Risk of death parameters -----
        "scaler_on_risk_of_death": Parameter(
            Types.REAL,
            "Multiplicative scaler on the overall risk of death, for the purpose of calibration.",
        ),
        "base_odds_death_ALRI_age<2mo": Parameter(
            Types.REAL,
            "baseline odds of death from ALRI for young infants aged 0 month and severe pneumonia "
            "(base group)",
        ),
        "or_death_ALRI_age<2mo_very_severe_pneumonia": Parameter(
            Types.REAL,
            "odds ratio of death from ALRI for young infants with very severe pneumonia",
        ),
        "or_death_ALRI_age<2mo_P.jirovecii": Parameter(
            Types.REAL,
            "odds ratio of death from ALRI for young infants with P. jirovecii infection",
        ),
        "or_death_ALRI_age<2mo_by_month_increase_in_age": Parameter(
            Types.REAL,
            "odds ratio of death from ALRI for young infants by 1 month increase in age (1 month olds)",
        ),
        "base_odds_death_ALRI_age2_59mo": Parameter(
            Types.REAL,
        ...
        "prob_cough_in_pneumonia": Parameter(
            Types.REAL, "probability of cough in pneumonia"
        ),
        "prob_difficult_breathing_in_pneumonia": Parameter(
            Types.REAL, "probability of difficulty breathing in pneumonia"
        ),
        "prob_fever_in_pneumonia": Parameter(
            Types.REAL, "probability of fever in pneumonia"
        ),
        "prob_chest_indrawing_in_pneumonia": Parameter(
            Types.REAL, "probability of chest indrawing in pneumonia"
        ),
        "prob_tachypnoea_in_pneumonia": Parameter(
            Types.REAL, "probability of tachypnoea in pneumonia"
        ),
        "prob_danger_signs_in_pneumonia": Parameter(
            Types.REAL,
        ...
        "prob_cough_in_other_alri": Parameter(
            Types.REAL, "probability of cough in bronchiolitis or other alri"
        ),
        "prob_difficult_breathing_in_other_alri": Parameter(
            Types.REAL,
            "probability of difficulty breathing in bronchiolitis or other alri",
        ),
        "prob_fever_in_other_alri": Parameter(
            Types.REAL, "probability of fever in bronchiolitis or other alri"
        ),
        "prob_tachypnoea_in_other_alri": Parameter(
            Types.REAL, "probability of tachypnoea in bronchiolitis or other alri"
        ),
        "prob_chest_indrawing_in_other_alri": Parameter(
            Types.REAL,
            "probability of chest wall indrawing in bronchiolitis or other alri",
        ),
        "prob_danger_signs_in_other_alri": Parameter(
            Types.REAL, "probability of any danger signs in bronchiolitis or other alri"
        ),
        "prob_danger_signs_in_sepsis": Parameter(
            Types.REAL, "probability of any danger signs in ALRI complicated by sepsis"
        ),
        "prob_danger_signs_in_SpO2<90%": Parameter(
            Types.REAL, "probability of any danger signs in children with SpO2 <90%"
        ),
        "prob_danger_signs_in_SpO2_90-92%": Parameter(
            Types.REAL,
            "probability of any danger signs in children with SpO2 between 90-92%",
        ),
        "prob_chest_indrawing_in_SpO2<90%": Parameter(
            Types.REAL, "probability of chest indrawing in children with SpO2 <90%"
        ),
        "prob_chest_indrawing_in_SpO2_90-92%": Parameter(
            Types.REAL,
            "probability of chest indrawing in children with SpO2 between 90-92%",
        ),
        "prob_cyanosis_in_other_alri": Parameter(
            Types.REAL, "probability of cyanosis in bronchiolitis or other alri"
        ),  # N.B. This is not used
        "prob_cyanosis_in_pneumonia": Parameter(
            Types.REAL, "probability of cyanosis in pneumonia"
        ),  # N.B. This is not used
        "prob_cyanosis_in_SpO2<90%": Parameter(
            Types.REAL, "probability of cyanosis when SpO2 < 90%"
        ),
        # Parameters governing the effects of vaccine ----------------
        "rr_Strep_pneum_VT_ALRI_with_PCV13_age<2y": Parameter(
            Types.REAL,
            "relative rate of acquiring S. pneumoniae vaccine-type Alri "
            "for children under 2 years of age immunised wth PCV13",
        ),
        "rr_Strep_pneum_VT_ALRI_with_PCV13_age2to5y": Parameter(
            Types.REAL,
            "relative rate of acquiring S. pneumoniae vaccine-type Alri "
            "for children aged 2 to 5 immunised wth PCV13",
        ),
        "rr_all_strains_Strep_pneum_ALRI_with_PCV13": Parameter(
            Types.REAL,
            "relative rate of acquiring S. pneumoniae all types Alri "
            "for children immunised wth PCV13",
        ),
        "effectiveness_Hib_vaccine_on_Hib_strains": Parameter(
            Types.REAL, "effectiveness of Hib vaccine against H. influenzae typ-b ALRI"
        ),
        "rr_Hib_ALRI_with_Hib_vaccine": Parameter(
            Types.REAL,
        ...
        "tf_3day_amoxicillin_for_fast_breathing_with_SpO2>=90%": Parameter(
            Types.REAL,
        ...
        "tf_3day_amoxicillin_for_chest_indrawing_with_SpO2>=90%": Parameter(
            Types.REAL,
            "probability of treatment failure by day 6 or relapse by day 14 of 3-day course amoxicillin for "
            "treating chest-indrawing pneumonia without hypoxaemia (SpO2>=90%)",
        ),
        "tf_5day_amoxicillin_for_chest_indrawing_with_SpO2>=90%": Parameter(
            Types.REAL,
            "probability of treatment failure by day 6 or relapse by day 14 of 5-day course amoxicillin for "
            "treating chest-indrawing pneumonia without hypoxaemia (SpO2>=90%)",
        ),
        "tf_7day_amoxicillin_for_fast_breathing_pneumonia_in_young_infants": Parameter(
            Types.REAL,
            "probability of treatment failure by day 6 or relapse by day 14 of 5-day course amoxicillin for "
            "treating chest-indrawing pneumonia without hypoxaemia (SpO2>=90%)",
        ),
        "tf_oral_amoxicillin_only_for_severe_pneumonia_with_SpO2>=90%": Parameter(
            Types.REAL,
        ...
        "tf_oral_amoxicillin_only_for_non_severe_pneumonia_with_SpO2<90%": Parameter(
            Types.REAL,
        ...
        "tf_2nd_line_antibiotic_for_severe_pneumonia": Parameter(
            Types.REAL,
        ...
        "sensitivity_of_classification_of_fast_breathing_pneumonia_facility_level0": Parameter(
            Types.REAL,
        ...
        "sensitivity_of_classification_of_danger_signs_pneumonia_facility_level0": Parameter(
            Types.REAL,
        ...
        "sensitivity_of_classification_of_non_severe_pneumonia_facility_level1": Parameter(
            Types.REAL,
            "sensitivity of correct classification and treatment decision for non-severe pneumonia "
            "at facility level 1a and 1b",
        ),
        "sensitivity_of_classification_of_severe_pneumonia_facility_level1": Parameter(
            Types.REAL,
            "sensitivity of correct classification and referral decision for severe pneumonia "
            "at facility level 1a and 1b",
        ),
        "sensitivity_of_classification_of_non_severe_pneumonia_facility_level2": Parameter(
            Types.REAL,
            "sensitivity of correct classification and treatment decision for non-severe pneumonia "
            "at facility level 2",
        ),
        "sensitivity_of_classification_of_severe_pneumonia_facility_level2": Parameter(
            Types.REAL,
            "sensitivity of correct classification and treatment decision for severe pneumonia "
            "at facility level 2",
        ),
        "prob_iCCM_severe_pneumonia_treated_as_fast_breathing_pneumonia": Parameter(
            Types.REAL,
        ...
        "prob_IMCI_severe_pneumonia_treated_as_non_severe_pneumonia": Parameter(
            Types.REAL,
        ...
        "or_care_seeking_perceived_severe_illness": Parameter(
            Types.REAL,
            "The Odds Ratio for healthcare seeking for the symptom of chest-indrawing",
        ),
        "pulse_oximeter_and_oxygen_is_available": Parameter(
            Types.CATEGORICAL,
        ...
        "prob_for_followup_if_treatment_failure": Parameter(
            Types.REAL,
    ...
    def __init__(
        self, name=None, resourcefilepath=None, log_indivdual=None, do_checks=False
    ):
        super().__init__(name)
        ...
        assert (log_indivdual is None or isinstance(log_indivdual, int)) and (
            not isinstance(log_indivdual, bool)
        )
    ...
    def read_parameters(self, data_folder):
        ...
        * Define symptoms
        ...
        self.load_parameters_from_dataframe(
            pd.read_excel(
                Path(self.resourcefilepath) / "ResourceFile_Alri.xlsx",
    ...
    def check_params_read_in_ok(self):
        ...
        for param_name, param_type in self.PARAMETERS.items():
            ...
            ), f'Parameter "{param_name}" is not read in correctly from the resourcefile.'
            assert isinstance(self.parameters[param_name], param_type.python_type), (
                f'Parameter "{param_name}" '
                f"is not read in correctly from the resourcefile."
            )
    ...
    def initialise_simulation(self, sim):
        ...
        * Establishes the linear models and other data structures using the parameters that have been read-in
        ...
        if "HealthBurden" in self.sim.modules.keys():
            self.daly_wts["daly_non_severe_ALRI"] = self.sim.modules[
                "HealthBurden"
            ].get_daly_weight(sequlae_code=47)
            self.daly_wts["daly_severe_ALRI"] = self.sim.modules[
                "HealthBurden"
            ].get_daly_weight(sequlae_code=46)
    ...
    def report_daly_values(self):
        ...
        has_danger_signs = set(
            self.sim.modules["SymptomManager"].who_has("danger_signs")
        ) & set(self.sim.modules["SymptomManager"].who_has("cough")).union(
        ...
        has_fast_breathing_or_chest_indrawing_but_not_danger_signs = (
            set(self.sim.modules["SymptomManager"].who_has("tachypnoea")).union(
        ...
        total_daly_values.loc[sorted(has_danger_signs)] = self.daly_wts[
            "daly_severe_ALRI"
        ]
        ...
        dummies_for_pathogen = pd.get_dummies(
            df.loc[total_daly_values.index, "ri_primary_pathogen"], dtype="float"
        )
    ...
    def over_ride_availability_of_certain_consumables(self):
        ...
        p = self.parameters
        item_code_pulse_oximeter = list(
            self.consumables_used_in_hsi["Pulse_oximetry"].keys()
        )
        ...
        if p["pulse_oximeter_and_oxygen_is_available"] in ("Yes", "No"):
            over_ride = {
                _item: (
                    1.0 if p["pulse_oximeter_and_oxygen_is_available"] == "Yes" else 0.0
                )
    ...
    def look_up_consumables(self):
        ...
        def get_dosage_for_age_in_months(
            age_in_whole_months: float, doses_by_age_in_months: Dict[int, float]
        ):
            ...
            for upper_age_bound_in_months, _dose in sorted(
                doses_by_age_in_months.items()
            ):
        ...
        self.consumables_used_in_hsi["Amoxicillin_tablet_or_suspension_5days"] = {
            get_item_code(
                item="Amoxycillin 250mg_1000_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {2: 0, 12: 0.006, 36: 0.012, np.inf: 0.018}
            ),
            get_item_code(
                item="Amoxycillin 125mg/5ml suspension, PFR_0.025_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {2: 0, 12: 1, 36: 2, np.inf: 3}
            ),
        }
        ...
        self.consumables_used_in_hsi["Amoxicillin_tablet_or_suspension_3days"] = {
            get_item_code(
                ...
                int(_age * 12.0), {2: 0, 12: 0.01, 36: 0.02, np.inf: 0.03}
            ),
            get_item_code(
                item="Amoxycillin 125mg/5ml suspension, PFR_0.025_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
        ...
        self.consumables_used_in_hsi["Amoxicillin_tablet_or_suspension_7days"] = {
            get_item_code(
                ...
                int(_age * 12.0), {1: 0.004, 2: 0.006, np.inf: 0.01}
            ),
            get_item_code(
                item="Amoxycillin 125mg/5ml suspension, PFR_0.025_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {1: 0.4, 2: 0.5, np.inf: 1}
            ),
        }
        ...
        self.consumables_used_in_hsi["1st_line_IV_antibiotics"] = {
            get_item_code(
                item="Ampicillin injection 500mg, PFR_each_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {1: 3.73, 2: 5.6, 4: 8, 12: 16, 36: 24, np.inf: 40}
            ),
            get_item_code(
                item="Gentamicin Sulphate 40mg/ml, 2ml_each_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0),
                {1: 0.7, 2: 1.4, 4: 2.81, 12: 4.69, 36: 7.03, np.inf: 9.37},
            ),
            get_item_code(
                item="Cannula iv  (winged with injection pot) 16_each_CMST"
            ): 1,
        ...
        self.consumables_used_in_hsi[
            "Benzylpenicillin_gentamicin_therapy_for_severe_pneumonia"
        ] = {
            get_item_code(
                item="Benzylpenicillin 3g (5MU), PFR_each_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {1: 2, 2: 5, 4: 8, 12: 15, 36: 24, np.inf: 34}
            ),
            get_item_code(
                item="Gentamicin Sulphate 40mg/ml, 2ml_each_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
        ...
        self.consumables_used_in_hsi["Ceftriaxone_therapy_for_severe_pneumonia"] = {
            get_item_code(
                item="Ceftriaxone 1g, PFR_each_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {4: 1.5, 12: 3, 36: 5, np.inf: 7}
            ),
            get_item_code(
                item="Cannula iv  (winged with injection pot) 16_each_CMST"
            ): 1,
        ...
        self.consumables_used_in_hsi[
            ...
            get_item_code(
                item="Flucloxacillin 250mg, vial, PFR_each_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0),
            ...
            get_item_code(
                ...
                int(_age * 12.0), {4: 2.81, 12: 4.69, 36: 7.03, 60: 9.37, np.inf: 13.6}
            ),
            get_item_code(
                item="Cannula iv  (winged with injection pot) 16_each_CMST"
            ): 1,
            get_item_code(item="Syringe, Autodisable SoloShot IX "): 1,
            get_item_code(
                item="Flucloxacillin 250mg_100_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {4: 0.42, 36: 0.84, 60: 1.68, np.inf: 1.68}
            ),
        }
        ...
        self.consumables_used_in_hsi["First_dose_oral_amoxicillin_for_referral"] = {
            get_item_code(
                ...
                int(_age * 12.0), {12: 0.001, 36: 0.002, np.inf: 0.003}
            ),
        }
        ...
        self.consumables_used_in_hsi["First_dose_IM_antibiotics_for_referral"] = {
            get_item_code(
                ...
                int(_age * 12.0), {4: 0.4, 12: 0.8, 36: 1.4, np.inf: 2}
            ),
            get_item_code(
                item="Gentamicin Sulphate 40mg/ml, 2ml_each_CMST"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {4: 0.56, 12: 0.94, 36: 1.41, np.inf: 1.87}
            ),
            get_item_code(
                item="Cannula iv  (winged with injection pot) 16_each_CMST"
            ): 1,
        ...
        self.consumables_used_in_hsi["Oxygen_Therapy"] = {
            get_item_code(
                item="Oxygen, 1000 liters, primarily with oxygen cylinders"
            ): 1,
        }
        ...
        # X-ray scan
        self.consumables_used_in_hsi["X_ray_scan"] = {get_item_code(item="X-ray"): 1}

        # Optional consumables -------------------
        # Paracetamol
        self.consumables_used_in_hsi["Paracetamol_tablet"] = {
            get_item_code(
                item="Paracetamol, tablet, 100 mg"
            ): lambda _age: get_dosage_for_age_in_months(
                int(_age * 12.0), {36: 12, np.inf: 18}
            ),
        }
    ...
    def cancel_death_and_schedule_cure(self, person_id):
        ...
        cure_date = self.sim.date + DateOffset(
    ...
    def check_properties(self):
        ...
        assert (
            not df.loc[curr_inf, ["ri_primary_pathogen", "ri_disease_type"]]
            .isna()
            .any()
            .any()
        )
        ...
        assert (
            (~df.loc[curr_inf, "ri_scheduled_recovery_date"].isna())
            | (~df.loc[curr_inf, "ri_scheduled_death_date"].isna())
        ).all()
        assert (
            df.loc[curr_inf, "ri_scheduled_recovery_date"].isna()
            != df.loc[curr_inf, "ri_scheduled_death_date"].isna()
        ...
        assert (
            df.loc[
                curr_inf & df["ri_primary_pathogen"].isin(self.pathogens["bacterial"]),
                "ri_secondary_bacterial_pathogen",
            ]
            .isna()
            .all()
        ...
        # hypoxaemia
        assert (
            df.loc[df.is_alive & df["ri_complication_hypoxaemia"], "ri_SpO2_level"]
            != ">=93%"
        ).all()
        assert (
            df.loc[df.is_alive & ~df["ri_complication_hypoxaemia"], "ri_SpO2_level"]
    ...
    def do_effects_of_treatment_and_return_outcome(
        self, person_id, antibiotic_provided: str, oxygen_provided: bool
    ):
        ...
        * Returns 'success' if the treatment is successful and 'failure' is it is not successful.
        ...
        hiv_infected_and_not_on_art = person.hv_inf and (
            person.hv_art != "on_VL_suppressed"
        )
        un_clinical_acute_malnutrition = person.un_clinical_acute_malnutrition
        complications = [
            _c for _c in self.complications if person[f"ri_complication_{_c}"]
        ]
    ...
    def on_presentation(
        self, person_id: int, person_details: NamedTuple, symptoms: List[str], hsi_event
    ) -> HSI_Event:
        ...
        if not (("cough" in symptoms) or ("difficult_breathing" in symptoms)):
            ...
            event = HSI_Alri_Treatment(
                person_id=person_id,
                person_age=person_details.age_exact_years,
                module=self,
    ...
    @staticmethod
    def get_imci_classification_based_on_symptoms(
        child_is_younger_than_2_months: bool, symptoms: list
    ) -> str:
    ...
    @staticmethod
    def _ultimate_treatment_indicated_for_patient(
        classification_for_treatment_decision, age_exact_years
    ) -> Dict:
        ...
        if classification_for_treatment_decision == "fast_breathing_pneumonia":
            ...
            return {
                "antibiotic_indicated": ("",),  # <-- First choice antibiotic
                "oxygen_indicated": False,
            }

        else:
            raise ValueError(
                f"Classification not recognised: {classification_for_treatment_decision}"
            )
...
class Models:
    ...
    def make_model_for_acquisition_risk(self):
        ...
        def make_scaled_linear_model_for_incidence(target_prob_by_age):
            ...
            def make_linear_model(age_effects=None):
                ...
                return LinearModel(
                    ...
                    .when(">= 5", 0.0),
                    Predictor("li_wood_burn_stove").when(
                        False, p["rr_ALRI_indoor_air_pollution"]
                    ),
                    Predictor().when(
                        "(va_measles_all_doses == False) & (age_years >= 1)",
                        p["rr_ALRI_incomplete_measles_immunisation"],
                    ),
                    Predictor().when(
                        '(hv_inf == True) & (hv_art!= "on_VL_suppressed")',
                        p["rr_ALRI_HIV/AIDS"],
                    ),
                    Predictor().when(
                        '(nb_breastfeeding_status != "exclusive") & (age_exact_years < 1/6)',
            ...
            _age_effect = (
                (
                    pd.Series(_target)
                    / unscaled_lm.predict(df.loc[df.is_alive & (df.age_years < 5)])
                    .groupby(by=df.age_years)
                    .mean()
                )
                .fillna(1.0)
                .to_dict()
        ...
        for patho in self.module.all_pathogens:
            self.incidence_equations_by_pathogen[patho] = (
                make_scaled_linear_model_for_incidence(
                    target_prob_by_age=self.p[f"base_inc_rate_ALRI_by_{patho}"]
                )
            )
    ...
    def compute_risk_of_acquisition(self, pathogen, df):
        ...
        if pathogen == "Strep_pneumoniae_PCV13":
            baseline.loc[df["va_pneumo_all_doses"] & (df["age_years"] < 2)] *= p[
                "rr_Strep_pneum_VT_ALRI_with_PCV13_age<2y"
            ]
            baseline.loc[
                df["va_pneumo_all_doses"] & (df["age_years"].between(2, 5))
    ...
    def determine_disease_type_and_secondary_bacterial_coinfection(
        self, pathogen, age_exact_years, va_hib_all_doses, va_pneumo_all_doses
    ):
        """Determines:
    ...
    def secondary_bacterial_infection(self, va_hib_all_doses, va_pneumo_all_doses):
        ...
        if va_pneumo_all_doses:
            probs["Strep_pneumoniae_PCV13"] *= p[
    ...
    def get_complications_that_onset(
        self, disease_type, primary_path_is_bacterial, has_secondary_bacterial_inf
    ):
        ...
        if disease_type == "pneumonia":
            ...
            if primary_path_is_bacterial or has_secondary_bacterial_inf:
                probs["sepsis"] += (
                    p["prob_bacteraemia_in_pneumonia"]
    ...
    def symptoms_for_complication(self, complication, oxygen_saturation):
        ...
        if complication == "hypoxaemia":
            ...
            probs = {"danger_signs": p["prob_danger_signs_in_sepsis"]}
    ...
    def prob_die_of_alri(
        ...
        def get_odds_of_death(age_in_whole_months):
            ...
            def get_odds_of_death_for_over_two_month_old(age_in_whole_months):
                return p[f"base_odds_death_ALRI_{_age_}"] * (
                    p[f"or_death_ALRI_{_age_}_by_month_increase_in_age"]
                    ** (age_in_whole_months - 2)
                )

            return (
                get_odds_of_death_for_under_two_month_old(
                    age_in_whole_months=age_in_whole_months
                )
                if age_in_whole_months < 2
                else get_odds_of_death_for_over_two_month_old(
                    age_in_whole_months=age_in_whole_months
                )
            )
        ...
        return min(
            1.0, p["scaler_on_risk_of_death"] * to_prob(odds_death)
    ...
    def _prob_treatment_fails(
        ...
        assert antibiotic_provided in self.module.antibiotics + [
            ""
        ...
        def modify_failure_risk_when_does_not_get_oxygen_but_needs_oxygen(_risk):
            ...
            or_if_does_not_get_oxygen_but_needs_oxygen = (
                1.0 / p["or_mortality_improved_oxygen_systems"]
            )
        ...
        def _prob_treatment_fails_when_danger_signs_pneumonia():
            ...
            if antibiotic_provided == "":
                ...
                risk_tf_1st_line_antibiotics = p[
                ...
                if needs_oxygen and not oxygen_provided:
                    ...
                    risk_tf_1st_line_antibiotics = (
                        modify_failure_risk_when_does_not_get_oxygen_but_needs_oxygen(
                            risk_tf_1st_line_antibiotics
                        )
                    )
...
class AlriPollingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def fraction_of_year_between_polling_event(self):
        ...
        infection"""
        return (self.sim.date + self.frequency - self.sim.date) / pd.Timedelta(
            days=DAYS_IN_YEAR
        )
    ...
    def get_probs_of_acquiring_pathogen(self, interval_as_fraction_of_a_year: float):
        ...
        mask_could_get_new_alri_event = (
            ...
            & (
                (df.ri_end_of_current_episode < self.sim.date)
                | pd.isnull(df.ri_end_of_current_episode)
            )
        )

        # Compute the incidence rate for each person acquiring Alri
        inc_of_acquiring_alri = pd.DataFrame(
            index=df.loc[mask_could_get_new_alri_event].index
        )
        for pathogen in m.all_pathogens:
            inc_of_acquiring_alri[pathogen] = models.compute_risk_of_acquisition(
                pathogen=pathogen, df=df.loc[mask_could_get_new_alri_event]
            )

        return 1 - np.exp(-inc_of_acquiring_alri * interval_as_fraction_of_a_year)
...
class AlriIncidentCase(Event, IndividualScopeEventMixin):
    ...
    def determine_nature_of_the_case(
        self,
        age_exact_years,
        sex,
        pathogen,
        ...
        * will_die,
        ...
        duration_in_days_of_alri = rng.randint(
            1, params["max_alri_duration_in_days_without_treatment"]
        )
        ...
        episode_end = date_of_outcome + DateOffset(
            days=params["days_between_treatment_and_cure"]
        )

        # ----------------------------------- Clinical Symptoms -----------------------------------
        symptoms_for_uncomplicated_disease = models.symptoms_for_disease(
            disease_type=disease_type
        )
        ...
        def get_symptoms_for_complications(
            complications: set, oxygen_saturation: str
        ) -> set:
        ...
        symptoms_for_complications = get_symptoms_for_complications(
            complications=complications, oxygen_saturation=oxygen_saturation
        )

        all_symptoms = sorted(
            symptoms_for_uncomplicated_disease.union(symptoms_for_complications)
        )
    ...
    def apply_characteristics_of_the_case(self, person_id, chars):
        ...
        df.loc[
            person_id,
            [
                f"ri_complication_{_complication}"
                for _complication in chars["complications"]
            ],
        ] = True
        ...
        if chars["will_die"]:
            self.sim.schedule_event(
                AlriDeathEvent(self.module, person_id), chars["date_of_outcome"]
            )
            df.loc[
                person_id, ["ri_scheduled_death_date", "ri_scheduled_recovery_date"]
            ] = [chars["date_of_outcome"], pd.NaT]
        else:
            self.sim.schedule_event(
                AlriNaturalRecoveryEvent(self.module, person_id),
                chars["date_of_outcome"],
            )
            df.loc[
                person_id, ["ri_scheduled_recovery_date", "ri_scheduled_death_date"]
            ] = [chars["date_of_outcome"], pd.NaT]

        # Log the incident case:
        self.module.logging_event.new_case(
            age=df.at[person_id, "age_years"], pathogen=self.pathogen
        )

        # Log the complications to the tracker
        if set(chars["complications"]).intersection(
...
class AlriNaturalRecoveryEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        if (
            ...
            and (person.ri_scheduled_recovery_date == self.sim.date)
            and pd.isnull(person.ri_scheduled_death_date)
        ):
            # Log the recovery
            self.module.logging_event.new_recovered_case(
                age=person.age_years, pathogen=person.ri_primary_pathogen
            )
    ...
    def apply(self, person_id):
        ...
        if person.ri_current_infection_status:
            ...
            self.module.logging_event.new_cured_case(
                age=person.age_years, pathogen=pathogen
            )
...
class AlriDeathEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        if (
            person.ri_current_infection_status
            and (person.ri_scheduled_death_date == self.sim.date)
            and pd.isnull(person.ri_scheduled_recovery_date)
        ):
            # Do the death:
            pathogen = person.ri_primary_pathogen
            ...
            self.module.logging_event.new_death(
                age=person.age_years, pathogen=pathogen, sp02_level=person.ri_SpO2_level
            )
...
class HSI_Alri_Treatment(HSI_Event, IndividualScopeEventMixin):
    ...
    def __init__(
        ...
        module: Module,
        person_id: int,
        person_age_exact: float,
        facility_level: str = "0",
        ...
        self._facility_levels = (
            ...
            "1b",
            "2",
        )  # Health facility levels at which care may be provided
        assert facility_level in self._facility_levels
        self.is_followup_following_treatment_failure = (
            is_followup_following_treatment_failure
        )
        ...
        if person_id is not None:
            self._age_exact_years = person_age_exact
    ...
    def _as_out_patient(self, facility_level):
        ...
        assert (
            not self.is_followup_following_treatment_failure
        ), "Follow-up appointment cannot be an outpatient appt."

    def _as_in_patient(self, facility_level):
        """Cast this HSI as an in-patient appointment."""
        self.TREATMENT_ID = f'{self._treatment_id_stub}_Inpatient{"_Followup" if self.is_followup_following_treatment_failure else ""}'
        self.EXPECTED_APPT_FOOTPRINT = self.make_appt_footprint({})
        self.ACCEPTED_FACILITY_LEVEL = facility_level
    ...
    def _refer_to_next_level_up(self):
        ...
        _next_level_up = _next_in_sequence(
            self._facility_levels, self.ACCEPTED_FACILITY_LEVEL
        )
    ...
    def _refer_to_become_inpatient(self):
        ...
        the_higher_level_between_this_level_and_1b = (
            "1b" if self.ACCEPTED_FACILITY_LEVEL in ("0", "1a", "1b") else "2"
        )
    ...
    def _get_cons_group(self, item_group_str: str) -> bool:
        ...
        if item_group_str is not None:
            return self.get_consumables(
                item_codes={
                    k: (
                        v(self._age_exact_years)
                        if isinstance(v, types.LambdaType)
                        else v
                    )
                    for k, v in self.module.consumables_used_in_hsi[
                        item_group_str
                    ].items()
                }
            )
    ...
    def _assess_and_treat(self, age_exact_years, oxygen_saturation, symptoms):
        ...
        if not self._is_as_in_patient:
            ...
            classification_for_treatment_decision = (
                self._get_disease_classification_for_treatment_decision(
                    age_exact_years=age_exact_years,
                    symptoms=symptoms,
                    oxygen_saturation=oxygen_saturation,
    ...
    def _get_imci_classification_based_on_symptoms(
        self, child_is_younger_than_2_months: bool, symptoms: list
    ) -> str:
        """Based on age and symptoms, classify WHO-pneumonia severity. This is regarded as the *TRUE* classification
         based on symptoms. It will return one of: {
             'fast_breathing_pneumonia',
    ...
    def _get_classification_given_by_health_worker(
        self, imci_classification_based_on_symptoms: str, facility_level: str
    ) -> str:
        ...
        def _classification_at_facility_level_0(imci_classification_based_on_symptoms):
            ...
            if imci_classification_based_on_symptoms in (
                "chest_indrawing_pneumonia",
                "danger_signs_pneumonia",
            ):
                if (
                ...
                raise ValueError(
                    f"Classification not recognised: {imci_classification_based_on_symptoms}"
                )
        ...
        def _classification_at_facility_level_1(imci_classification_based_on_symptoms):
            ...
            elif imci_classification_based_on_symptoms in (
                "fast_breathing_pneumonia",
                "chest_indrawing_pneumonia",
            ):
                if (
        ...
        if facility_level == "0":
            classification = _classification_at_facility_level_0(
                imci_classification_based_on_symptoms
            )
        elif facility_level in ("1a", "1b"):
            classification = _classification_at_facility_level_1(
                imci_classification_based_on_symptoms
            )
        elif facility_level == "2":
            classification = _classification_at_facility_level_2(
                imci_classification_based_on_symptoms
            )
        else:
    ...
    def _get_disease_classification_for_treatment_decision(
        self,
        age_exact_years,
        symptoms,
        oxygen_saturation,
        ...
        imci_classification_based_on_symptoms = (
            self._get_imci_classification_based_on_symptoms(
                child_is_younger_than_2_months=child_is_younger_than_2_months,
                symptoms=symptoms,
            )
        )

        imci_classification_by_SpO2_measure = (
            self._get_imci_classification_by_SpO2_measure(
                oxygen_saturation=oxygen_saturation
            )
        )
        ...
        _classification = (
            imci_classification_by_SpO2_measure
            if (use_oximeter and (imci_classification_by_SpO2_measure != ""))
            else hw_assigned_classification
        )
    ...
    def _do_action_given_classification(
        self,
        classification_for_treatment_decision,
        age_exact_years,
        facility_level,
        ...
        def _try_treatment(
            antibiotic_indicated: Tuple[str], oxygen_indicated: bool
        ) -> None:
            """Try to provide a `treatment_indicated` and refer to next level if the consumables are not available."""

            assert [
                _antibiotic in self.module.antibiotics + [""]
                for _antibiotic in antibiotic_indicated
            ]

            if antibiotic_indicated[0] != "":
                antibiotic_available = self._get_cons(antibiotic_indicated)
                antibiotic_provided = (
                    antibiotic_indicated[0] if antibiotic_available else ""
                )
            ...
            if (not all_things_needed_available) and (facility_level != "2"):
                ...
                if treatment_outcome == "failure":
                    if (
                        ...
                        < p["prob_for_followup_if_treatment_failure"]
                    ):
        ...
        def _do_if_chest_indrawing_pneumonia():
            ...
            if facility_level == "0":
                _provide_consumable_and_refer(
                    "First_dose_oral_amoxicillin_for_referral"
                )
            else:
                _try_treatment(
                    **self.module._ultimate_treatment_indicated_for_patient(
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        if not self.is_followup_following_treatment_failure:
            ...
            if (self.ACCEPTED_FACILITY_LEVEL == "0") and (
                person.age_exact_years < 2.0 / 12.0
            ):
                self._refer_to_next_level_up()

            # Attempt treatment:
            self._assess_and_treat(
                age_exact_years=person.age_exact_years,
                symptoms=symptoms,
...
class AlriLoggingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def __init__(self, module):
        ...
        age_grps = {
            **{0: "0", 1: "1", 2: "2-4", 3: "2-4", 4: "2-4"},
            **{x: "5+" for x in range(5, 100)},
        }

        self.trackers = {
            "incident_cases": Tracker(
                age_grps=age_grps, pathogens=self.module.all_pathogens
            ),
            "recovered_cases": Tracker(
                age_grps=age_grps, pathogens=self.module.all_pathogens
            ),
            "cured_cases": Tracker(
                age_grps=age_grps, pathogens=self.module.all_pathogens
...
class Tracker:
    ...
    def reset(self):
        ...
        if self.unique_age_grps and self.pathogens:
            self.tracker = {
                age: dict(zip(self.pathogens, [0] * len(self.pathogens)))
                for age in self.unique_age_grps
            }
        else:
            self.tracker = 0
...
class AlriIndividualLoggingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def __init__(self, module):
        ...
        assert (
            self.person_id in module.sim.population.props.index
        ), "The person identified to be logged does not exist."
    ...
    def apply(self, person_id):
        ...
        self.apply_characteristics_of_the_case(
            ...
            chars={
                ...
                "episode_end": self.module.sim.date
                + DateOffset(days=10 + params["days_between_treatment_and_cure"]),
        ...
        assert (
            ...
            == self.module.get_imci_classification_based_on_symptoms(
                child_is_younger_than_2_months=df.at[person_id, "age_exact_years"]
                < (2.0 / 12.0),
                symptoms=self.sim.modules["SymptomManager"].has_what(person_id),
            )
        )
