...
class Alri(Module, GenericFirstAppointmentsMixin):
    ...
    classifications = sorted(
        {"danger_signs_pneumonia", "fast_breathing_pneumonia", "chest_indrawing_pneumonia", "cough_or_cold"}
    )
    ...
    complications = sorted({"pneumothorax", "pleural_effusion", "empyema", "lung_abscess", "sepsis", "hypoxaemia"})
    ...
    PARAMETERS = {
        ...
        "rr_ALRI_HIV/AIDS": Parameter(Types.REAL, "relative rate of acquiring Alri for children with HIV+/AIDS "),
        "rr_ALRI_incomplete_measles_immunisation": Parameter(
            Types.REAL, "relative rate of acquiring Alri for children with incomplete measles immunisation"
        ),
        "rr_ALRI_low_birth_weight": Parameter(
            Types.REAL, "relative rate of acquiring Alri for infants with low birth weight"
        ),
        "rr_ALRI_non_exclusive_breastfeeding": Parameter(
            Types.REAL, "relative rate of acquiring Alri for not exclusive breastfeeding upto 6 months"
        ),
        ...
        "prob_viral_pneumonia_bacterial_coinfection": Parameter(
            Types.REAL, "probability of primary viral pneumonia having a bacterial co-infection"
        ),
        ...
        "max_alri_duration_in_days_without_treatment": Parameter(
            Types.REAL, "maximum duration in days of untreated ALRI episode, assuming an average of 7 days"
        ),
        # Probability of complications -----
        "overall_progression_to_severe_ALRI": Parameter(Types.REAL, "probability of progression to severe ALRI"),
        ...
        "prob_pleural_effusion_in_pulmonary_complicated_pneumonia": Parameter(
            Types.REAL, "probability of pleural effusion in pneumonia with pulmonary complications"
        ),
        "prob_empyema_in_pulmonary_complicated_pneumonia": Parameter(
            Types.REAL, "probability of empyema in pneumonia with pulmonary complications"
        ),
        "prob_lung_abscess_in_pulmonary_complicated_pneumonia": Parameter(
            Types.REAL, "probability of lung abscess in pneumonia with pulmonary complications"
        ),
        "prob_pneumothorax_in_pulmonary_complicated_pneumonia": Parameter(
            Types.REAL, "probability of pneumothorax in pneumonia with pulmonary complications"
        ),
        "prob_hypoxaemia_in_pneumonia": Parameter(Types.REAL, "probability of hypoxaemia in pneumonia cases"),
        "prob_hypoxaemia_in_other_alri": Parameter(
            Types.REAL, "probability of hypoxaemia in bronchiolitis and other alri cases"
        ),
        "prob_bacteraemia_in_pneumonia": Parameter(Types.REAL, "probability of bacteraemia in pneumonia"),
        ...
        "scaler_on_risk_of_death": Parameter(
            Types.REAL, "Multiplicative scaler on the overall risk of death, for the purpose of calibration."
        ),
        ...
        "or_death_ALRI_age<2mo_very_severe_pneumonia": Parameter(
            Types.REAL, "odds ratio of death from ALRI for young infants with very severe pneumonia"
        ),
        "or_death_ALRI_age<2mo_P.jirovecii": Parameter(
            Types.REAL, "odds ratio of death from ALRI for young infants with P. jirovecii infection"
        ),
        "or_death_ALRI_age<2mo_by_month_increase_in_age": Parameter(
            Types.REAL, "odds ratio of death from ALRI for young infants by 1 month increase in age (1 month olds)"
        ),
        ...
        "or_death_ALRI_age2_59mo_very_severe_pneumonia": Parameter(
            Types.REAL, "odds ratio of death from ALRI for children with very severe pneumonia"
        ),
        "or_death_ALRI_age2_59mo_P.jirovecii": Parameter(
            Types.REAL, "odds ratio of death from ALRI for children with P. jirovecii infection"
        ),
        "or_death_ALRI_age2_59mo_by_month_increase_in_age": Parameter(
            Types.REAL, "odds ratio of death from ALRI by 1 month increase in age for 2 to 59 months olds"
        ),
        "or_death_ALRI_age2_59mo_SAM": Parameter(
            Types.REAL, "odds ratio of death from ALRI for children with severe acute malnutrition"
        ),
        ...
        "or_death_ALRI_sepsis": Parameter(
            Types.REAL, "odds ratio of death from ALRI for children with complication of sepsis (compared to if not)"
        ),
        ...
        "prob_cough_in_pneumonia": Parameter(Types.REAL, "probability of cough in pneumonia"),
        "prob_difficult_breathing_in_pneumonia": Parameter(
            Types.REAL, "probability of difficulty breathing in pneumonia"
        ),
        "prob_fever_in_pneumonia": Parameter(Types.REAL, "probability of fever in pneumonia"),
        "prob_chest_indrawing_in_pneumonia": Parameter(Types.REAL, "probability of chest indrawing in pneumonia"),
        "prob_tachypnoea_in_pneumonia": Parameter(Types.REAL, "probability of tachypnoea in pneumonia"),
        ...
        "prob_cough_in_other_alri": Parameter(Types.REAL, "probability of cough in bronchiolitis or other alri"),
        "prob_difficult_breathing_in_other_alri": Parameter(
            Types.REAL, "probability of difficulty breathing in bronchiolitis or other alri"
        ),
        "prob_fever_in_other_alri": Parameter(Types.REAL, "probability of fever in bronchiolitis or other alri"),
        ...
        "prob_chest_indrawing_in_other_alri": Parameter(
            Types.REAL, "probability of chest wall indrawing in bronchiolitis or other alri"
        ),
        ...
        "prob_danger_signs_in_SpO2_90-92%": Parameter(
            Types.REAL, "probability of any danger signs in children with SpO2 between 90-92%"
        ),
        ...
        "prob_chest_indrawing_in_SpO2_90-92%": Parameter(
            Types.REAL, "probability of chest indrawing in children with SpO2 between 90-92%"
        ),
        ...
        "prob_cyanosis_in_SpO2<90%": Parameter(Types.REAL, "probability of cyanosis when SpO2 < 90%"),
        ...
        "rr_all_strains_Strep_pneum_ALRI_with_PCV13": Parameter(
            Types.REAL, "relative rate of acquiring S. pneumoniae all types Alri " "for children immunised wth PCV13"
        ),
        ...
        "rr_Hib_ALRI_with_Hib_vaccine": Parameter(
            Types.REAL, "relative rate of acquiring H. influenzae type-b Alri " "for children immunised wth Hib vaccine"
        ),
        # Parameters governing treatment effectiveness and associated behaviours ----------------
        "days_between_treatment_and_cure": Parameter(
            Types.INT, "number of days between any treatment being given in an HSI and the cure occurring."
        ),
        ...
        "or_care_seeking_perceived_severe_illness": Parameter(
            Types.REAL, "The Odds Ratio for healthcare seeking for the symptom of chest-indrawing"
        ),
        ...
        "prob_for_followup_if_treatment_failure": Parameter(
            Types.REAL, "The probability for scheduling a follow-up appointment following treatment failure"
        ),
    }
    ...
    PROPERTIES = {
        ...
        "ri_current_infection_status": Property(
            Types.BOOL, "Does the person currently have an infection with a pathogen that can cause Alri."
        ),
    ...
    def check_params_read_in_ok(self):
        ...
        for param_name, param_type in self.PARAMETERS.items():
            assert param_name in self.parameters, (
                f'Parameter "{param_name}" ' f"is not read in correctly from the resourcefile."
            )
        ...
        for symptom_name in sorted(self.all_symptoms):
            if symptom_name not in self.sim.modules["SymptomManager"].generic_symptoms:
                if symptom_name == "danger_signs":
                    ...
                    self.sim.modules["SymptomManager"].register_symptom(Symptom(name=symptom_name))
    ...
    def on_birth(self, mother_id, child_id):
        ...
        df.loc[child_id, ["ri_primary_pathogen", "ri_secondary_bacterial_pathogen", "ri_disease_type"]] = np.nan
    ...
    def report_daly_values(self):
        ...
        has_danger_signs = set(self.sim.modules["SymptomManager"].who_has("danger_signs")) & set(
            self.sim.modules["SymptomManager"].who_has("cough")
        ).union(self.sim.modules["SymptomManager"].who_has("difficult_breathing"))
        ...
        total_daly_values.loc[sorted(has_danger_signs)] = self.daly_wts["daly_severe_ALRI"]
        total_daly_values.loc[sorted(has_fast_breathing_or_chest_indrawing_but_not_danger_signs)] = self.daly_wts[
            "daly_non_severe_ALRI"
        ]
    ...
    def look_up_consumables(self):
        ...
        self.consumables_used_in_hsi["Amoxicillin_tablet_or_suspension_5days"] = {
            ...
            get_item_code(item="Amoxycillin 125mg/5ml suspension, PFR_0.025_CMST"): 192,
        }  # 25mg/ml - 4800/25
        ...
        self.consumables_used_in_hsi["Amoxicillin_tablet_or_suspension_3days"] = {
            ...
            get_item_code(item="Amoxycillin 125mg/5ml suspension, PFR_0.025_CMST"): 115,
        }  # 25mg/ml - 2880/25
        ...
        self.consumables_used_in_hsi["Amoxicillin_tablet_or_suspension_7days"] = {
            ...
            get_item_code(item="Amoxycillin 125mg/5ml suspension, PFR_0.025_CMST"): 269,
        }  # 25mg/ml - 6720/25
        ...
        self.consumables_used_in_hsi["Fluid_Maintenance"] = {get_item_code(item="Tube, nasogastric CH 8_each_CMST"): 1}
    ...
    def check_properties(self):
        ...
        assert not df.loc[not_curr_inf, [f"ri_complication_{c}" for c in self.complications]].any().any()

        # For those with current infection, variables about the current infection should not be null
        assert not df.loc[curr_inf, ["ri_primary_pathogen", "ri_disease_type"]].isna().any().any()
        ...
        assert (
            df.loc[curr_inf, "ri_scheduled_recovery_date"].isna() != df.loc[curr_inf, "ri_scheduled_death_date"].isna()
        ).all()
    ...
    def do_at_generic_first_appt(
        ...
        **kwargs,
        ...
        if individual_properties["age_years"] <= 5 and (("cough" in symptoms) or ("difficult_breathing" in symptoms)):
            self.record_sought_care_for_alri()

            # All persons have an initial out-patient appointment at the current facility level.
            event = HSI_Alri_Treatment(person_id=person_id, module=self, facility_level=facility_level)
            schedule_hsi_event(
                event,
                topen=self.sim.date,
...
class Models:
    ...
    def make_model_for_acquisition_risk(self):
        ...
        for patho in self.module.all_pathogens:
            self.incidence_equations_by_pathogen[patho] = make_scaled_linear_model_for_incidence(
    ...
    def compute_risk_of_acquisition(self, pathogen, df):
        ...
        if pathogen == "Strep_pneumoniae_PCV13":
            ...
            baseline.loc[df["va_pneumo_all_doses"] & (df["age_years"].between(2, 5))] *= p[
            ...
            if disease_type == "pneumonia":
                if p["prob_viral_pneumonia_bacterial_coinfection"] > self.rng.random_sample():
                    bacterial_coinfection = self.secondary_bacterial_infection(
                        va_hib_all_doses=va_hib_all_doses, va_pneumo_all_doses=va_pneumo_all_doses
                    )
                else:
    ...
    def secondary_bacterial_infection(self, va_hib_all_doses, va_pneumo_all_doses):
        ...
        probs = dict(zip(self.module.pathogens["bacterial"], p["proportion_bacterial_coinfection_pathogen"]))
    ...
    def prob_die_of_alri(
        ...
        def get_odds_of_death(age_in_whole_months):
            ...
            return (
                get_odds_of_death_for_under_two_month_old(age_in_whole_months=age_in_whole_months)
        ...
        def _prob_treatment_fails_when_danger_signs_pneumonia():
            ...
            if antibiotic_provided == "":
                ...
                if needs_oxygen and not oxygen_provided:
                    ...
                    risk_tf_1st_line_antibiotics = modify_failure_risk_when_does_not_get_oxygen_but_needs_oxygen(
    ...
    def apply(self, population):
        ...
        for person_id, pathogen in new_alri.items():
            ...
            self.sim.schedule_event(
                ...
                date=random_date(
                    self.sim.date, self.sim.date + self.frequency - pd.DateOffset(days=1), self.module.rng
                ),
            )
...
class AlriNaturalRecoveryEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        if (
            ...
            # Log the recovery
            self.module.logging_event.new_recovered_case(age=person.age_years, pathogen=person.ri_primary_pathogen)
...
class AlriCureEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        if person.ri_current_infection_status:
            ...
            self.module.logging_event.new_cured_case(age=person.age_years, pathogen=pathogen)
    ...
    def apply(self, person_id):
        ...
        if (
            ...
            self.module.sim.modules["Demography"].do_death(
                individual_id=person_id, cause="ALRI_" + pathogen, originating_module=self.module
            )
...
class HSI_Alri_Treatment(HSI_Event, IndividualScopeEventMixin):
    ...
    def _get_disease_classification_for_treatment_decision(
        ...
        hw_assigned_classification = self._get_classification_given_by_health_worker(
            imci_classification_based_on_symptoms=imci_classification_based_on_symptoms, facility_level=facility_level
        )
        ...
        def _try_treatment(antibiotic_indicated: Tuple[str], oxygen_indicated: bool) -> None:
            ...
            if (not all_things_needed_available) and (facility_level != "2"):
                ...
                treatment_outcome = self.module.do_effects_of_treatment_and_return_outcome(
                    person_id=self.target, antibiotic_provided=antibiotic_provided, oxygen_provided=oxygen_provided
                )
...
class Tracker:
    ...
    def reset(self):
        ...
        if self.unique_age_grps and self.pathogens:
            self.tracker = {age: dict(zip(self.pathogens, [0] * len(self.pathogens))) for age in self.unique_age_grps}
        else:
            self.tracker = 0
...
class AlriPropertiesOfOtherModules(Module):
    ...
    PROPERTIES = {
        ...
        "hv_art": Property(
            Types.CATEGORICAL, "temporary property", categories=["not", "on_VL_suppressed", "on_not_VL_suppressed"]
        ),
        ...
        "nb_breastfeeding_status": Property(
            Types.CATEGORICAL, "temporary property", categories=["none", "non_exclusive", "exclusive"]
        ),
...
class AlriIncidentCase_NonLethal_Fast_Breathing_Pneumonia(AlriIncidentCase):
    ...
    def apply(self, person_id):
        ...
        assert "fast_breathing_pneumonia" == self.module.get_imci_classification_based_on_symptoms(
