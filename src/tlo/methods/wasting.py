...
class Wasting(Module):
    ...
    def __init__(self, name=None, resourcefilepath=None):
        ...
        self.age_grps_dict: dict = {_agrp: 1.0 for _agrp in
                                    ['0_5mo', '6_11mo', '12_23mo', '24_35mo', '36_47mo', '48_59mo']}
    ...
    def initialise_population(self, population):
        ...
        for agegp in [(0, 5), (6, 11), (12, 23), (24, 35), (36, 47), (48, 59)]:  # in months
            ...
            lm_ext_var = f'{agegp[0]}_{agegp[1]}mo'  # linear model external variables
            mask = (df.is_alive &
                    df.age_exact_years.between(low_bound_age_in_years, high_bound_age_in_years, inclusive='left')
                    )
    ...
    def do_when_am_treatment(self, person_id, intervention):
        ...
        if intervention == 'SFP':
            mam_recovery = \
                self.wasting_models.get_moderate_acute_malnutrition_recovery().predict(df.loc[[person_id]], self.rng)
...
class WastingPollingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        get_incidence_of_wasting = self.module.wasting_models.get_wasting_incidence(inc_wasting)
        ...
        progression_severe_wasting = \
            self.module.wasting_models.get_wasting_progression().predict(progression_sev_wasting, rng)
...
class WastingModels:
    ...
    def __init__(self, module):
        ...
        self.__SAM_Death = LinearModel.multiplicative(
            ...
            Predictor('un_sam_with_complications').when(True,
                                                        self.params['rr_SAM_death_with_complications']),
    ...
    def get_age_grps_odds(self):
        ...
        for agegp in self.module.age_grps_dict.keys():
            ...
            # convert probability to odds and update odds by age group dictionary
            ...
            self.module.age_grps_sev_wasting_probs[
                agegp] = probability_less_than_minus3sd * probability_less_than_minus2sd
