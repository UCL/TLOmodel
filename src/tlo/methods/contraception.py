...
class HSI_Contraception_FamilyPlanningAppt(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        if co_administrated:
            ...
            # Do logging of consumables for the `Consumables` module. Although this is duplicative of the detailed logging of consumables in the `HealthSystem` module, it is done here too as the file generated by the `HealthSystem` module is extremely large and not usable for the very long runs that are needed for the analyses using the `Contraception` module.
