...
class RespInfectionEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        ri_current_none_idx = df.index[df.is_alive & (df.ri_pneumonia_status == 'none')
                                       & (df.age_years < 5)]
        ...
        eff_prob_ri_pneumonia = pd.Series(m.r_pneumonia_none,
                                          index=df.index[
                                              df.is_alive & (df.resp_infection_stat == 'pneumonia') & (
                                                  df.age_years < 5)])
        ...
        ri_current_pneumonia_malnutrition_idx = df.index[df.is_alive & (df.ri_resp_infection_stat == 'pneumonia') &
                                                         (df.malnutrition) & (df.age_years < 5)]
        ri_current_pneumonia_indoor_air_pollution_idx = df.index[
            df.is_alive & (df.ri_resp_infection_stat == 'pneumonia') &
            (df.indoor_air_pollution) & (df.age_years < 5)]
        ...
        eff_prob_prog_severe_pneumonia.loc[
            ri_current_pneumonia_age12to23mo_idx] *= m.rr_progress_severe_pneumonia_age_12to23mo
        eff_prob_prog_severe_pneumonia.loc[
            ri_current_pneumonia_age24to59mo_idx] *= m.rr_progress_severe_pneumonia_age_24to59mo
        ...
        eff_prob_prog_severe_pneumonia.loc[
            ri_current_pneumonia_malnutrition_idx] *= m.rr_progress_severe_pneumonia_malnutrition
        eff_prob_prog_severe_pneumonia.loc[
            ri_current_pneumonia_indoor_air_pollution_idx] *= m.rr_progress_severe_pneumonia_indoor_air_pollution
