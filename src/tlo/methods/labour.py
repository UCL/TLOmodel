...
class Labour(Module):
    ...
    def apply_risk_of_death(self, individual_id, timing, causes):
        ...
        for cause in causes:
            risk = {f'{cause}': self.la_linear_models[f'{cause}_death'].predict(
                ...
                mode_of_delivery=mni[individual_id]['mode_of_delivery'])[individual_id]}
    ...
    def apply_risk_of_early_postpartum_death(self, individual_id):
        ...
        if causes:
            ...
            if not self.apply_risk_of_death(individual_id, timing='postnatal', causes=causes):
            ...
            print('dev_dates', individual_id, df.at[individual_id, 'la_date_most_recent_delivery'])
...
class BirthAndPostnatalOutcomesEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, mother_id):
        ...
        if ~person.is_alive and ~person.la_intrapartum_still_birth and mni[mother_id]['death_in_labour']:
            logger.info(key='message',
                            data=f'A Birth is now occurring, to mother {mother_id} who died in childbirth '
        ...
        if person.is_alive:
            ...
            if pnc_check:
                ...
                if timing == '<48':
                    early_event = HSI_Labour_ReceivesEarlyPostnatalCheck(
                    ...
                    mni[mother_id]['future_pnc_check'] = True
...
class HSI_Labour_ReceivesEarlyPostnatalCheck(HSI_Event, IndividualScopeEventMixin):
    """
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        # And provide the pre-dicharge interventions
        self.module.interventions_delivered_pre_discharge(self)

        # ========================================== SCHEDULING CeMONC CARE ==========================================
        # If, during this event, it is deemed that a woman requires comprehensive treatment of a complication she is
        # referred for futher treatment here - this may include blood transfusion/surgery
