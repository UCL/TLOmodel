...
class Labour(Module):
    ...
    CAUSES_OF_DEATH = {
        "uterine_rupture": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "intrapartum_sepsis": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "antepartum_haemorrhage": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "postpartum_sepsis": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "postpartum_haemorrhage": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "secondary_postpartum_haemorrhage": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "severe_pre_eclampsia": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
    ...
    PARAMETERS = {
        ...
        "effect_age_parity_lr2010": Parameter(
            Types.LIST,
            "effect of an increase in age by 1 year in the linear regression equation predicating "
            "womens parity at 2010 baseline",
        ),
        "effect_mar_stat_2_parity_lr2010": Parameter(
            Types.LIST,
            "effect of a change in marriage status from comparison (level 1) in the linear "
        ...
        "effect_wealth_lev_4_parity_lr2010": Parameter(
            Types.LIST,
            "effect of an increase in wealth level in the linear regression equation predicating womans "
        ...
        "effect_edu_lev_2_parity_lr2010": Parameter(
            Types.LIST,
            "effect of an increase in education level in the linear regression equation predicating womans "
            "parity at 2010 base line",
        ),
        ...
        "effect_rural_parity_lr2010": Parameter(
            Types.LIST,
            "effect of rural living in the linear regression equation predicating womans parity at 2010 "
            "base line",
        ),
        ...
        "list_limits_for_defining_term_status": Parameter(
            Types.LIST,
            "List of number of days of gestation used to define term, early preterm, late preterm and "
            "post term delivery",
        ),
        ...
        "standard_deviation_birth_weights": Parameter(
            Types.LIST,
            "list of standard deviations associated with mean birth weights from gestational age at "
            "birth 24-41 weeks",
        ),
        "residual_prob_of_macrosomia": Parameter(
            Types.LIST,
            "probability that those allocated to be normal birth weight and above will be macrosomic "
            "(>4kg)",
        ),
        # OBSTRUCTED LABOUR....
        ...
        "rr_obstruction_foetal_macrosomia": Parameter(
            Types.LIST,
            "relative risk of obstruction secondary to CPD in mothers who are carrying a macrosomic "
            "foetus",
        ),
        ...
        "rr_ur_prev_cs": Parameter(
            Types.LIST,
            "relative risk of uterine rupture in women who have previously delivered via caesarean "
            "section",
        ),
        ...
        "prob_progression_gest_htn": Parameter(
            Types.LIST,
            "probability of gestational hypertension progressing to severe gestational hypertension"
            "during/after labour",
        ),
        "prob_progression_severe_gest_htn": Parameter(
            Types.LIST,
            "probability of severe gestational hypertension progressing to severe pre-eclampsia "
            "during/after labour",
        ),
        ...
        "prob_both_twins_ip_still_birth": Parameter(
            Types.LIST,
            "probability that if this mother will experience still birth, and she is pregnant with twins, "
        ...
        "rrr_hc_delivery_age_20_24": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 20-24 delivering in a health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_age_25_29": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 25-29 delivering in a health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_age_30_34": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 30-34 delivering in a health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_age_35_39": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 35-39 delivering in a health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_age_40_44": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 40-44 delivering in a health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_age_45_49": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 45-49 delivering in a health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_wealth_4": Parameter(
            Types.LIST,
            "relative risk ratio of a woman at wealth level 4 delivering at health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_wealth_3": Parameter(
            Types.LIST,
            "relative risk ratio of a woman at wealth level 3 delivering at health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_wealth_2": Parameter(
            Types.LIST,
            "relative risk ratio of a woman at wealth level 2 delivering at health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_wealth_1": Parameter(
            Types.LIST,
            "relative risk ratio of a woman at wealth level 1 delivering at health centre compared to a "
            "hospital",
        ),
        "rrr_hc_delivery_parity_3_to_4": Parameter(
            Types.LIST,
            "relative risk ratio for a woman with a parity of 3-4 delivering in a health centre compared to"
            "a hospital",
        ),
        "rrr_hc_delivery_parity_>4": Parameter(
            Types.LIST,
            "relative risk ratio of a woman with a parity >4 delivering in health centre compared to a "
            "hospital",
        ),
        ...
        "rrr_hb_delivery_age_20_24": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 20-24 delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_age_25_29": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 25-29 delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_age_30_34": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 30-34 delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_age_35_39": Parameter(
            Types.LIST,
            "relative risk ratio for a woman aged 35-39 delivering at home compared to a "
            "hospital",
        ),
        ...
        "rrr_hb_delivery_primary_education": Parameter(
            Types.LIST,
            "relative risk ratio of a woman with a primary education delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_secondary_education": Parameter(
            Types.LIST,
            "relative risk ratio of a woman with a secondary education delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_wealth_4": Parameter(
            Types.LIST,
            "relative risk ratio of a woman at wealth level 4 delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_wealth_3": Parameter(
            Types.LIST,
            "relative risk ratio of a woman at wealth level 3 delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_wealth_2": Parameter(
            Types.LIST,
            "relative risk ratio of a woman at wealth level 2 delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_wealth_1": Parameter(
            Types.LIST,
            "relative risk ratio of a woman at wealth level 1 delivering at home compared to a "
            "hospital",
        ),
        "rrr_hb_delivery_parity_3_to_4": Parameter(
            Types.LIST,
            "relative risk ratio for a woman with a parity of 3-4 delivering at home compared to"
            "a hospital",
        ),
        "rrr_hb_delivery_parity_>4": Parameter(
            Types.LIST,
            "relative risk ratio of a woman with a parity >4 delivering at home compared to a "
            "hospital",
        ),
        ...
        "prob_delay_one_two_fd": Parameter(
            Types.LIST,
            "probability a woman seeking care during pregnancy will experience a type 1 or 2 delay when "
            "choosing to seek care (i.e. she is delayed in reaching the facility",
        ),
        "squeeze_threshold_for_delay_three_bemonc": Parameter(
            Types.LIST,
            "squeeze factor value over which an individual within a EMoNC HSI is said to experience type 3"
            " delay i.e. delay in receiving appropriate care",
        ),
        "squeeze_threshold_for_delay_three_cemonc": Parameter(
            Types.LIST,
            "squeeze factor value over which an individual within a CEMoNC HSI is said to experience type 3"
            " delay i.e. delay in receiving appropriate car1e",
        ),
        "squeeze_threshold_for_delay_three_pn": Parameter(
            Types.LIST,
            "squeeze factor value over which an individual within a postnatal HSI is said to experience "
            "type 3 delay i.e. delay in receiving appropriate care",
        ),
        # PNC CHECK...
        "prob_timings_pnc": Parameter(
            Types.LIST,
            "probabilities that a woman who will receive a PNC check will receive care <48hrs post birth "
            "or > 48hrs post birth",
        ),
        ...
        "probs_of_attending_pn_event_by_day": Parameter(
            Types.LIST,
            "probabilities used in a weighted random draw to determine when a woman will attend the "
            "postnatal event",
        ),
        # EMERGENCY CARE SEEKING...
        "prob_careseeking_for_complication": Parameter(
            Types.LIST,
            "probability of a woman seeking skilled assistance after developing a complication at a "
            "home birth",
        ),
        "prob_careseeking_for_complication_pn": Parameter(
            Types.LIST,
            "probability of a woman seeking skilled assistance after developing a postnatal complication "
        ...
        "prob_delivery_modes_ec": Parameter(
            Types.LIST,
            "probabilities that a woman admitted with eclampsia will deliver normally, via caesarean or "
            "via assisted vaginal delivery",
        ),
        "prob_delivery_modes_spe": Parameter(
            Types.LIST,
            "probabilities that a woman admitted with severe pre-eclampsia will deliver normally, via "
            "caesarean or via assisted vaginal delivery",
        ),
        "residual_prob_avd": Parameter(
            Types.LIST,
            "probabilities that a woman will deliver via assisted vaginal delivery for an indication not "
            "explicitly modelled",
        ),
        "residual_prob_caesarean": Parameter(
            Types.LIST,
            "probabilities that a woman will deliver via caesarean section for an indication not "
            "explicitly modelled",
        ),
        ...
        "treatment_effect_maternal_chorio_abx_prom": Parameter(
            Types.LIST,
            "Relative effect of antibiotics for premature rupture of membranes on maternal risk of "
            "chorioamnionitis prior to birth",
        ),
        "treatment_effect_amtsl": Parameter(
            Types.LIST,
            "relative risk of severe postpartum haemorrhage following active management of the third "
            "stage of labour",
        ),
        ...
        "anti_htns_treatment_effect_md": Parameter(
            Types.LIST,
            "effect of IV anti hypertensive treatment on risk of death secondary to severe pre-eclampsia/"
        ...
        "prob_hcw_avail_iv_abx": Parameter(
            Types.LIST,
            "average probability that a health facility providing EmONC care has a HCW available that can"
        ...
        "mean_hcw_competence_hc": Parameter(
            Types.LIST,
            "mean competence of HCW at delivering EmONC care at a health centre. A draw below this level "
            "prevents intervention delivery",
        ),
        "mean_hcw_competence_hp": Parameter(
            Types.LIST,
            "mean competence of HCW at delivering EmONC care at a hospital. A draw below this level "
            "prevents intervention delivery",
        ),
        # EFFECT OF DELAYS...
        "treatment_effect_modifier_all_delays": Parameter(
            Types.LIST,
            "factor by which treatment effectiveness is reduced in the presences of multiple delays",
        ),
        ...
        "prob_intervention_delivered_anaemia_assessment_pnc": Parameter(
            Types.LIST,
            "probability a woman will have their Hb levels checked during PNC given that the HSI has ran "
            "and the consumables are available (proxy for clinical quality)",
        ),
        # ANALYSIS PARAMETERS
        "analysis_year": Parameter(
            Types.INT,
            "Year on which changes in parameters as part of analysis should be enacted (1st day, "
            "1st month)",
        ),
        "la_analysis_in_progress": Parameter(
            Types.BOOL,
            "Used within the pregnancy_helper_function to signify that labour/postnatal "
        ...
        "alternative_pnc_coverage": Parameter(
            Types.BOOL,
            "Signals within the analysis event that an alternative level of PNC coverage has been "
            "determined following the events run",
        ),
        "alternative_pnc_quality": Parameter(
            Types.BOOL,
            "Signals within the analysis event that an alternative level of PNC quality has been "
            "determined following the events run",
        ),
        "pnc_availability_odds": Parameter(
            Types.REAL,
            "Target odds of maternal PNC coverage when analysis is being conducted - only applied if"
            "alternative_pnc_coverage is true",
        ),
        "pnc_availability_probability": Parameter(
            Types.REAL,
            "Target probability of quality/consumables when analysis is being conducted - only applied if "
            "alternative_pnc_coverage is true",
        ),
    }
    ...
    PROPERTIES = {
        ...
        "la_has_previously_delivered_preterm": Property(
            Types.BOOL,
            "whether the woman has had a previous preterm "
        ...
        "la_antepartum_haem_treatment": Property(
            Types.BOOL, "whether this womans antepartum haemorrhage has been " "treated"
        ),
        ...
        "la_postpartum_haem_cause": Property(
            Types.INT, "bitset column holding causes of postpartum haemorrhage"
        ),
        "la_postpartum_haem_treatment": Property(
            Types.INT, " Treatment for received for postpartum haemorrhage " "(bitset)"
        ),
    ...
    def read_parameters(self, data_folder):
        parameter_dataframe = pd.read_excel(
            Path(self.resourcefilepath) / "ResourceFile_LabourSkilledBirth"
            "Attendance.xlsx",
    ...
    def initialise_population(self, population):
        ...
        self.pph_treatment = BitsetHandler(
            self.sim.population,
        ...
        parity_equation = LinearModel.custom(
            labour_lm.predict_parity, parameters=params
        )

        # We assign parity to all women of reproductive age at baseline
        df.loc[df.is_alive & (df.sex == "F") & (df.age_years > 14), "la_parity"] = (
            parity_equation.predict(
                df.loc[df.is_alive & (df.sex == "F") & (df.age_years > 14)]
            )
        )
        ...
        if (
            ...
            logger.info(
                key="error", data="Parity was calculated incorrectly at initialisation"
            )
        ...
        reproductive_age_women = (
            df.is_alive & (df.sex == "F") & (df.age_years > 14) & (df.age_years < 50)
        )

        previous_cs = pd.Series(
            self.rng.random_sample(
                len(reproductive_age_women.loc[reproductive_age_women])
            )
    ...
    def get_and_store_labour_item_codes(self):
        ...
        """
        get_item_code_from_pkg = self.sim.modules[
            "HealthSystem"
        ...
        self.item_codes_lab_consumables["iv_drug_equipment"] = get_list_of_items(
            self,
            [
        ...
        self.item_codes_lab_consumables["blood_test_equipment"] = get_list_of_items(
            self, ["Disposables gloves, powder free, 100 pieces per box"]
        )

        # -------------------------------------------- DELIVERY ------------------------------------------------------
        # assuming CDK has blade, soap, cord tie
        self.item_codes_lab_consumables["delivery_core"] = get_list_of_items(
            self, ["Clean delivery kit", "Chlorhexidine 1.5% solution_5_CMST"]
        )

        self.item_codes_lab_consumables["delivery_optional"] = get_list_of_items(
            self,
            [
                "Cannula iv  (winged with injection pot) 18_each_CMST",
                "Disposables gloves, powder free, 100 pieces per box",
        ...
        # -------------------------------------------- CAESAREAN DELIVERY ------------------------------------------
        self.item_codes_lab_consumables["caesarean_delivery_core"] = get_list_of_items(
            self,
            [
        ...
        # -------------------------------------------- OBSTETRIC SURGERY ----------------------------------------------
        self.item_codes_lab_consumables["obstetric_surgery_core"] = get_list_of_items(
            self,
            [
                "Halothane (fluothane)_250ml_CMST",
                "Ceftriaxone 1g, PFR_each_CMST",
        ...
        # -------------------------------------------- ABX FOR PROM -------------------------------------------------
        self.item_codes_lab_consumables["abx_for_prom"] = get_list_of_items(
            self, ["Benzathine benzylpenicillin, powder for injection, 2.4 million IU"]
        )

        # -------------------------------------------- ANTENATAL STEROIDS ---------------------------------------------
        self.item_codes_lab_consumables["antenatal_steroids"] = get_list_of_items(
            self, ["Dexamethasone 5mg/ml, 5ml_each_CMST"]
        )

        # -------------------------------------  INTRAVENOUS ANTIHYPERTENSIVES ---------------------------------------
        self.item_codes_lab_consumables["iv_antihypertensives"] = get_list_of_items(
            self, ["Hydralazine, powder for injection, 20 mg ampoule"]
        )

        # --------------------------------------- ORAL ANTIHYPERTENSIVES ---------------------------------------------
        self.item_codes_lab_consumables["oral_antihypertensives"] = get_list_of_items(
            self, ["Methyldopa 250mg_1000_CMST"]
        )

        # ----------------------------------  SEVERE PRE-ECLAMPSIA/ECLAMPSIA  -----------------------------------------
        self.item_codes_lab_consumables["magnesium_sulfate"] = get_list_of_items(
        ...
        # -------------------------------------  OBSTRUCTED LABOUR  ---------------------------------------------------
        self.item_codes_lab_consumables["obstructed_labour"] = get_list_of_items(
            self,
            [
        ...
        # -------------------------------------  OBSTETRIC VACUUM   ---------------------------------------------------
        self.item_codes_lab_consumables["vacuum"] = get_list_of_items(
            self, ["Vacuum, obstetric"]
        )

        # -------------------------------------  MATERNAL SEPSIS  -----------------------------------------------------
        # todo: helen allott recommended clindamycin but not available as IV
        self.item_codes_lab_consumables["maternal_sepsis_core"] = get_list_of_items(
            self,
            [
                "Benzylpenicillin 3g (5MU), PFR_each_CMST",
                "Gentamycin, injection, 40 mg/ml in 2 ml vial",
        ...
        self.item_codes_lab_consumables["maternal_sepsis_optional"] = get_list_of_items(
            self,
            [
                "Cannula iv  (winged with injection pot) 18_each_CMST",
                "Oxygen, 1000 liters, primarily with oxygen cylinders",
        ...
        self.item_codes_lab_consumables["amtsl"] = get_list_of_items(
            self, ["Oxytocin, injection, 10 IU in 1 ml ampoule"]
        )

        # -------------------------------------  POSTPARTUM HAEMORRHAGE  ---------------------------------------
        # TODO: helen allott recommended tranexamic acid - not availble
        self.item_codes_lab_consumables["pph_core"] = get_list_of_items(
            self, ["Oxytocin, injection, 10 IU in 1 ml ampoule"]
        )

        self.item_codes_lab_consumables["pph_optional"] = get_list_of_items(
            self,
            [
                "Misoprostol, tablet, 200 mcg",
                "Pethidine, 50 mg/ml, 2 ml ampoule",
        ...
        # -------------------------------------  BLOOD TRANSFUSION  ---------------------------------------
        self.item_codes_lab_consumables["blood_transfusion"] = get_list_of_items(
            self, ["Blood, one unit"]
        )

        # ------------------------------------------ FULL BLOOD COUNT -------------------------------------------------
        self.item_codes_lab_consumables["full_blood_count"] = get_list_of_items(
            self, ["Complete blood count"]
        )

        # ---------------------------------- IRON AND FOLIC ACID ------------------------------------------------------
        self.item_codes_lab_consumables["iron_folic_acid"] = get_item_code_from_pkg(
            "Ferrous Salt + Folic Acid, tablet, 200 + 0.25 mg"
        )

        # -------------------------------------------- RESUSCITATION ------------------------------------------
        self.item_codes_lab_consumables["resuscitation"] = get_list_of_items(
            self, ["Infant resuscitator, clear plastic + mask + bag_each_CMST"]
        )
    ...
    def initialise_simulation(self, sim):
        ...
        sim.schedule_event(
            LabourAndPostnatalCareAnalysisEvent(self),
        ...
        self.possible_intrapartum_complications = [
            "obstruction_cpd",
            "obstruction_malpos_malpres",
            "obstruction_other",
            "placental_abruption",
            "antepartum_haem",
            "sepsis",
            "sepsis_chorioamnionitis",
            "uterine_rupture",
            "severe_pre_eclamp",
            "eclampsia",
        ]

        self.possible_postpartum_complications = [
            "sepsis_endometritis",
            "sepsis_skin_soft_tissue",
            "sepsis_urinary_tract",
            "pph_uterine_atony",
        ...
        self.la_linear_models = {
            ...
            "obstruction_cpd_ip": LinearModel.custom(
                labour_lm.predict_obstruction_cpd_ip, module=self
            ),
            ...
            "sepsis_chorioamnionitis_ip": LinearModel.custom(
                labour_lm.predict_sepsis_chorioamnionitis_ip, parameters=params
            ),
            ...
            "sepsis_endometritis_pp": LinearModel.custom(
                labour_lm.predict_sepsis_endometritis_pp, parameters=params
            ),
            ...
            "sepsis_skin_soft_tissue_pp": LinearModel.custom(
                labour_lm.predict_sepsis_skin_soft_tissue_pp, parameters=params
            ),
            # This equation is used to calculate a womans risk of developing a urinary tract infection during the
            # postpartum phase of labour and is mitigated by clean delivery
            "sepsis_urinary_tract_pp": LinearModel.custom(
                labour_lm.predict_sepsis_urinary_tract_pp, parameters=params
            ),
            # This equation is used to calculate a womans risk of death following sepsis during labour and is mitigated
            # by treatment
            "intrapartum_sepsis_death": LinearModel.custom(
                labour_lm.predict_sepsis_death, parameters=params
            ),
            "postpartum_sepsis_death": LinearModel.custom(
                labour_lm.predict_sepsis_death, parameters=params
            ),
            ...
            "eclampsia_death": LinearModel.custom(
                labour_lm.predict_eclampsia_death, parameters=params
            ),
            # This equation is used to calculate a womans risk of death following eclampsia and is mitigated
            # by treatment delivered either immediately prior to admission for delivery or during labour
            "severe_pre_eclampsia_death": LinearModel.custom(
                labour_lm.predict_severe_pre_eclamp_death, parameters=params
            ),
            # This equation is used to calculate a womans risk of placental abruption in labour
            "placental_abruption_ip": LinearModel.custom(
                labour_lm.predict_placental_abruption_ip, parameters=params
            ),
            ...
            "antepartum_haem_ip": LinearModel.custom(
                labour_lm.predict_antepartum_haem_ip, parameters=params
            ),
            # This equation is used to calculate a womans risk of death following antepartum haemorrhage. Risk is
            # mitigated by treatment
            "antepartum_haemorrhage_death": LinearModel.custom(
                labour_lm.predict_antepartum_haem_death, parameters=params
            ),
            # This equation is used to calculate a womans risk of postpartum haemorrhage due to uterine atony
            "pph_uterine_atony_pp": LinearModel.custom(
                labour_lm.predict_pph_uterine_atony_pp, module=self
            ),
            # This equation is used to calculate a womans risk of postpartum haemorrhage due to retained placenta
            "pph_retained_placenta_pp": LinearModel.custom(
                labour_lm.predict_pph_retained_placenta_pp, parameters=params
            ),
            # This equation is used to calculate a womans risk of death following postpartum haemorrhage. Risk is
            # mitigated by treatment
            "postpartum_haemorrhage_death": LinearModel.custom(
                labour_lm.predict_postpartum_haem_pp_death, module=self
            ),
            # This equation is used to calculate a womans risk of uterine rupture
            "uterine_rupture_ip": LinearModel.custom(
                labour_lm.predict_uterine_rupture_ip, parameters=params
            ),
            # This equation is used to calculate a womans risk of death following uterine rupture. Risk if reduced by
            # treatment
            "uterine_rupture_death": LinearModel.custom(
                labour_lm.predict_uterine_rupture_death, parameters=params
            ),
            ...
            "intrapartum_still_birth": LinearModel.custom(
                labour_lm.predict_intrapartum_still_birth, parameters=params
            ),
    ...
    def on_hsi_alert(self, person_id, treatment_id):
        ...
        logger.debug(
            key="message",
            data=f"This is Labour, being alerted about a health system interaction "
    ...
    def set_date_of_labour(self, individual_id):
        ...
        logger.debug(
            key="message",
            data=f"person {individual_id} is having their labour scheduled on date "
            f"{self.sim.date}",
        )

        # Check only alive newly pregnant women are scheduled to this function
        if (
            not df.at[individual_id, "is_alive"]
            and not df.at[individual_id, "is_pregnant"]
            and (not df.at[individual_id, "date_of_last_pregnancy"] == self.sim.date)
        ):
            logger.info(
                key="error",
                data=f"Attempt to schedule labour for woman {individual_id} inappropriately",
            )
            return
        ...
        if self.rng.random_sample() < params["risk_post_term_labour"]:
            df.at[individual_id, "la_due_date_current_pregnancy"] = df.at[
                individual_id, "date_of_last_pregnancy"
            ] + pd.DateOffset(days=(7 * 39) + self.rng.randint(0, 7 * 4))

        else:
            df.at[individual_id, "la_due_date_current_pregnancy"] = df.at[
                individual_id, "date_of_last_pregnancy"
            ] + pd.DateOffset(days=(7 * 35) + self.rng.randint(0, 7 * 4))

        self.sim.schedule_event(
            LabourOnsetEvent(self, individual_id),
        ...
        if not days_until_labour >= pd.Timedelta(245, unit="d"):
            logger.info(
                key="error",
                data=f"Labour scheduled for woman {individual_id} beyond the maximum estimated "
    ...
    def check_labour_can_proceed(self, individual_id):
        ...
        if (
            not person.is_alive
            or not person.is_pregnant
            or person.la_currently_in_labour
        ):
            logger.debug(
                key="message",
                data=f"person {individual_id} has just reached LabourOnsetEvent on "
        ...
        if (
            ...
            and (person.la_due_date_current_pregnancy == self.sim.date)
            ...
            # was admitted for
                ...
                logger.debug(
                    key="message",
                    data=f"person {individual_id}, who is currently admitted and awaiting "
        ...
        if (
            ...
            and not person.la_currently_in_labour
            and (person.la_due_date_current_pregnancy != self.sim.date)
            and (person.ac_admitted_for_immediate_delivery != "none")
        ):
            logger.debug(
                key="message",
                data=f"person {individual_id} has just reached LabourOnsetEvent on "
    ...
    def set_intrapartum_complications(self, individual_id, complication):
        ...
        if mni[individual_id]["delivery_setting"] == "none":
            logger.info(
                key="error",
                data=f"Mother {individual_id} is having risk of complications applied but has no "
                f"delivery setting",
            )
            return
        ...
        if complication not in self.possible_intrapartum_complications:
            logger.info(
                key="error",
                data=f'A complication ("{complication}") was passed to '
        ...
        if (
            ...
            and (df.at[individual_id, "ps_antepartum_haemorrhage"] != "none")
            or (
                (complication == "placental_abruption")
                and df.at[individual_id, "ps_placental_abruption"]
            )
            or (
                (complication == "sepsis_chorioamnionitis")
                and df.at[individual_id, "ps_chorioamnionitis"]
            )
        ):
            return
        ...
        # Otherwise we use the linear model to predict likelihood of a complication
            ...
            result = self.predict(
                self.la_linear_models[f"{complication}_ip"], individual_id
            )
        ...
        if result:
            logger.debug(
                key="message",
                data=f"person {individual_id} has developed {complication} during birth on date"
                f"{self.sim.date}",
            )
            ...
            # to labour)
                ...
                if random_choice != "severe":
                    pregnancy_helper_functions.store_dalys_in_mni(
                        individual_id, mni, "mild_mod_aph_onset", self.sim.date
                    )
                    logger.info(
                        key="maternal_complication",
                        data={
                    ...
                    pregnancy_helper_functions.store_dalys_in_mni(
                        individual_id, mni, "severe_aph_onset", self.sim.date
                    )
                    logger.info(
                        key="maternal_complication",
                        data={
                ...
                pregnancy_helper_functions.store_dalys_in_mni(
                    individual_id, mni, "sepsis_onset", self.sim.date
                )
                logger.info(
                    key="maternal_complication",
                    data={
                ...
                pregnancy_helper_functions.store_dalys_in_mni(
                    individual_id, mni, f"{complication}_onset", self.sim.date
                )
                logger.info(
                    key="maternal_complication",
                    data={
    ...
    def set_postpartum_complications(self, individual_id, complication):
        ...
        # risk and compare that to a random draw
            ...
            result = self.predict(
                self.la_linear_models[f"{complication}_pp"], individual_id
            )
        ...
        if result:
            ...
            if complication in (
                ...
                if pd.isnull(mni[individual_id]["mild_mod_pph_onset"]) and pd.isnull(
                    mni[individual_id]["severe_pph_" "onset"]
                ):
                    ...
                    if random_choice == "non_severe":
                        pregnancy_helper_functions.store_dalys_in_mni(
                            individual_id, mni, "mild_mod_pph_onset", self.sim.date
                        )
                    else:
                        pregnancy_helper_functions.store_dalys_in_mni(
                            individual_id, mni, "severe_pph_onset", self.sim.date
                        )
    ...
    def progression_of_hypertensive_disorders(self, individual_id, property_prefix):
        ...
        if (
            df.at[individual_id, f"{property_prefix}_htn_disorders"]
            == "severe_pre_eclamp"
        ):
            ...
            if df.at[individual_id, "la_severe_pre_eclampsia_treatment"] or (
                df.at[individual_id, "ac_mag_sulph_treatment"]
                and (
                    df.at[individual_id, "ac_admitted_for_immediate_delivery"] != "none"
                )
            ):
                risk_progression_spe_ec = (
                    risk_ec * params["eclampsia_treatment_effect_severe_pe"]
                )
            else:
            ...
            if risk_progression_spe_ec > self.rng.random_sample():
                ...
                pregnancy_helper_functions.store_dalys_in_mni(
                    individual_id, mni, "eclampsia_onset", self.sim.date
                )
        ...
        if df.at[individual_id, f"{property_prefix}_htn_disorders"] == "gest_htn":
            if df.at[individual_id, "la_maternal_hypertension_treatment"]:
                risk_prog_gh_sgh = (
                    ...
                    * params["anti_htns_treatment_effect_progression"]
                )
            else:
    ...
    def apply_risk_of_early_postpartum_death(self, individual_id):
        ...
        potential_cause_of_death = (
            pregnancy_helper_functions.check_for_risk_of_death_from_cause_maternal(
        ...
        if potential_cause_of_death:
            ...
            self.sim.modules["Demography"].do_death(
                ...
                cause=potential_cause_of_death,
        ...
        # has been applied
            ...
            if (df.at[individual_id, "pn_htn_disorders"] == "severe_pre_eclamp") and (
                mni[individual_id]["new_onset" "_spe"]
            ):
            ...
            if not mni[individual_id]["passed_through_week_one"]:
                ...
                days_post_birth_td = (
                    self.sim.date - df.at[individual_id, "la_date_most_recent_delivery"]
                )
                ...
                if not days_post_birth_int < 6:
                    logger.info(
                        key="error",
                        data=f"Mother {individual_id} scheduled to PN week one at >1 "
                        f"week postnatal",
                    )

                day_for_event = int(
                    self.rng.choice(
                        [2, 3, 4, 5, 6], p=params["probs_of_attending_pn_event_by_day"]
                    )
                )
                ...
                if individual_id in self.women_in_labour:
                    logger.info(
                        key="error",
                        data=f"Mother {individual_id} is still stored in self.women_in_labour",
                    )

                if df.at[individual_id, "la_currently_in_labour"]:
                    logger.info(
                        key="error",
                        data=f"Mother {individual_id} is currently in labour within "
    ...
    def labour_characteristics_checker(self, individual_id):
        ...
        if (
            individual_id not in self.women_in_labour
            or mother.sex != "F"
            or mother.age_years < 14
            or mother.age_years > 51
            or not mother.la_currently_in_labour
            or mother.ps_gestational_age_in_weeks < 22
            or pd.isnull(mother.la_due_date_current_pregnancy)
        ):
            logger.info(
                key="error",
                data=f"Person {individual_id} has characteristics that mean they should"
                f" not be in labour ",
            )
    ...
    def postpartum_characteristics_checker(self, individual_id):
        ...
        if (
            individual_id not in mni
            or mother.sex != "F"
            or mother.age_years < 14
            or mother.age_years > 51
            or not mother.la_is_postpartum
            or (
                not mni[individual_id]["passed_through_week_one"]
                and individual_id not in self.women_in_labour
            )
        ):
            logger.info(
                key="error",
    ...
    def prophylactic_labour_interventions(self, hsi_event):
        ...
        if df.at[person_id, "ps_premature_rupture_of_membranes"]:
            ...
            if df.at[person_id, "ac_received_abx_for_prom"]:
                ...
                # Run HCW check
                sf_check = (
                    pregnancy_helper_functions.check_emonc_signal_function_will_run(
                        self, sf="iv_abx", hsi_event=hsi_event
                    )
                )
                ...
                avail = pregnancy_helper_functions.return_cons_avail(
                    self,
                    hsi_event,
                    self.item_codes_lab_consumables,
                    core="abx_for_prom",
        ...
        if (
            mni[person_id]["labour_state"] == "early_preterm_labour"
            or mni[person_id]["labour_state"] == "late_preterm_labour"
        ):
    ...
    def determine_delivery_mode_in_spe_or_ec(self, person_id, hsi_event, complication):
        ...
        mode = self.rng.choice(
            delivery_modes, p=params[f"prob_delivery_modes_{complication}"]
        )

        if mode == "avd":
            self.assessment_for_assisted_vaginal_delivery(
                hsi_event, indication="spe_ec"
            )
    ...
    def assessment_and_treatment_of_severe_pre_eclampsia_mgso4(
        ...
        if (
            ...
            not in params["allowed_interventions"]
        ) or (
            (df.at[person_id, "ac_admitted_for_immediate_delivery"] != "none")
            and df.at[person_id, "ac_mag_sulph_treatment"]
            and (labour_stage == "ip")
        ):
            return
        ...
        if (df.at[person_id, "ps_htn_disorders"] == "severe_pre_eclamp") or (
            ...
            sf_check = pregnancy_helper_functions.check_emonc_signal_function_will_run(
                self, sf="anticonvulsant", hsi_event=hsi_event
            )
    ...
    def assessment_and_treatment_of_hypertension(self, hsi_event, labour_stage):
        ...
        if (
            ...
            not in params["allowed_interventions"]
        ) or (df.at[person_id, "ac_iv_anti_htn_treatment"] and (labour_stage == "ip")):
            return

        if (df.at[person_id, "ps_htn_disorders"] != "none") or (
            df.at[person_id, "pn_htn_disorders"] != "none"
        ):
    ...
    def assessment_for_assisted_vaginal_delivery(self, hsi_event, indication):
        ...
        if (
            ...
            or (
                df.at[person_id, "ac_admitted_for_immediate_delivery"]
                == "caesarean_now"
            )
            or (
                df.at[person_id, "ac_admitted_for_immediate_delivery"]
        ...
        if df.at[person_id, "la_obstructed_labour"] or (
            indication in ("spe_ec", "other")
        ):
            ...
            if not mni[person_id]["cpd"]:
                ...
                sf_check = (
                    pregnancy_helper_functions.check_emonc_signal_function_will_run(
                        self, sf="avd", hsi_event=hsi_event
                    )
                )

                if avail and sf_check:
                    pregnancy_helper_functions.log_met_need(
                        self, f"avd_{indication}", hsi_event
                    )
                    ...
                    if (
                        params["prob_successful_assisted_vaginal_delivery"]
                        > self.rng.random_sample()
                    ):
    ...
    def assessment_and_treatment_of_maternal_sepsis(self, hsi_event, labour_stage):
        ...
        if (
            ...
            or df.at[person_id, "la_sepsis_pp"]
            or (
                (labour_stage == "ip")
                and df.at[person_id, "ps_chorioamnionitis"]
                and (df.at[person_id, "ac_admitted_for_immediate_delivery"] != "none")
            )
            or (labour_stage == "pp" and df.at[person_id, "pn_sepsis_late_postpartum"])
        ):
    ...
    def assessment_and_plan_for_antepartum_haemorrhage(self, hsi_event):
        ...
        if (df.at[person_id, "ps_antepartum_haemorrhage"] != "none") and (
            df.at[person_id, "ac_admitted_for_immediate_" "delivery"] != "none"
        ):
    ...
    def active_management_of_the_third_stage_of_labour(self, hsi_event):
        ...
        # run HCW check
        sf_check = pregnancy_helper_functions.check_emonc_signal_function_will_run(
            self, sf="uterotonic", hsi_event=hsi_event
        )
    ...
    def assessment_and_treatment_of_pph_uterine_atony(self, hsi_event):
        ...
        if (
            df.at[person_id, "la_postpartum_haem"]
            and not mni[person_id]["retained_placenta"]
        ):
    ...
    def assessment_and_treatment_of_pph_retained_placenta(self, hsi_event):
        ...
        if (
            df.at[person_id, "la_postpartum_haem"]
            and mni[person_id]["retained_placenta"]
        ) or df.at[person_id, "pn_postpartum_haem_secondary"]:
            ...
            hsi_event.get_consumables(
                item_codes=self.item_codes_lab_consumables["pph_optional"]
            )

            # run HCW check
            sf_check = pregnancy_helper_functions.check_emonc_signal_function_will_run(
                self, sf="man_r_placenta", hsi_event=hsi_event
            )
            ...
            if sf_check:
                pregnancy_helper_functions.log_met_need(
                    self, "man_r_placenta", hsi_event
                )

                if (
                    params["prob_successful_manual_removal_placenta"]
                    > self.rng.random_sample()
                ):
    ...
    def surgical_management_of_pph(self, hsi_event):
        ...
        avail = pregnancy_helper_functions.return_cons_avail(
            ...
            hsi_event,
            self.item_codes_lab_consumables,
            core="obstetric_surgery_core",
            optional="obstetric_surgery_optional",
        )

        # run HCW check
        sf_check = pregnancy_helper_functions.check_emonc_signal_function_will_run(
            self, sf="surg", hsi_event=hsi_event
        )
        ...
        if (
            self.pph_treatment.has_all(person_id, "surgery")
            or df.at[person_id, "la_has_had_hysterectomy"]
        ):
    ...
    def blood_transfusion(self, hsi_event):
        ...
        avail = pregnancy_helper_functions.return_cons_avail(
            ...
            hsi_event,
            self.item_codes_lab_consumables,
            core="blood_transfusion",
            optional="iv_drug_equipment",
        )

        # check HCW
        sf_check = pregnancy_helper_functions.check_emonc_signal_function_will_run(
            self, sf="blood_tran", hsi_event=hsi_event
        )
        ...
        if avail and sf_check:
            ...
            if df.at[person_id, "pn_anaemia_following_pregnancy"] != "none":
                if (
                    params["treatment_effect_blood_transfusion_anaemia"]
                    > self.rng.random_sample()
                ):
                    pregnancy_helper_functions.store_dalys_in_mni(
                        person_id, mni, "severe_anaemia_resolution", self.sim.date
                    )
    ...
    def assessment_and_treatment_of_anaemia(self, hsi_event):
        ...
        hsi_event.get_consumables(
            item_codes=self.item_codes_lab_consumables["blood_test_equipment"]
        )
        ...
        if test_result:
            ...
            if not mother.la_iron_folic_acid_postnatal:
                ...
                cons = {
                    _i: days
                    for _i in self.item_codes_lab_consumables["iron_folic_acid"]
                }
                ...
                if avail:
                    ...
                    if (
                        self.rng.random_sample()
                        < params["effect_of_ifa_for_resolving_anaemia"]
                    ):
                        # Store date of resolution for daly calculations
                        pregnancy_helper_functions.store_dalys_in_mni(
                            person_id,
                            mni,
                            f'{df.at[person_id, "pn_anaemia_following_pregnancy"]}_anaemia_resolution',
                            self.sim.date,
                        )
    ...
    def assessment_for_depression(self, hsi_event):
        ...
        if "Depression" in self.sim.modules.keys():
            self.sim.modules["Depression"].do_on_presentation_to_care(
    ...
    def interventions_delivered_pre_discharge(self, hsi_event):
        ...
        if "Hiv" in self.sim.modules:
            self.sim.modules["Hiv"].decide_whether_hiv_test_for_mother(
                person_id, referred_from="labour"
            )

        # ------------------------------- Postnatal iron and folic acid ---------------------------------------------
        cons = {
            _i: params["number_ifa_tablets_required_postnatally"]
            for _i in self.item_codes_lab_consumables["iron_folic_acid"]
        }
        avail = hsi_event.get_consumables(item_codes=cons)
    ...
    def run_if_receives_skilled_birth_attendance_cant_run(self, hsi_event):
        ...
        logger.debug(
            key="message",
            data=f"HSI_Labour_ReceivesSkilledBirthAttendanceDuringLabour will not run for "
            f"{person_id}",
        )
    ...
    def run_if_receives_postnatal_check_cant_run(self, hsi_event):
        ...
        logger.debug(
            key="message",
            data=f"HSI_Labour_ReceivesPostnatalCheck will not run for {person_id}",
        )
        self.apply_risk_of_early_postpartum_death(person_id)

    def run_if_receives_comprehensive_emergency_obstetric_care_cant_run(
        self, hsi_event
    ):
        """
        ...
        logger.debug(
            key="message",
            data=f"HSI_Labour_ReceivesComprehensiveEmergencyObstetricCare will not run for"
            f" {person_id}",
        )
...
class LabourOnsetEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if self.module.check_labour_can_proceed(individual_id):
            ...
            # gestational age
            foetal_age_in_days = (
                self.sim.date - df.at[individual_id, "date_of_last_pregnancy"]
            ).days
            ...
            if (
                params["list_limits_for_defining_term_status"][0]
            ...
            # account for PregnancySupervisor only updating weekly
                ...
                params["list_limits_for_" "defining_term_status"][2]
                <= gestational_age_in_days
                <= params["list_limits_for_" "defining_term_status"][3]
            ):
                ...
                params["list_limits_for_defining_term_status"][4]
                <= gestational_age_in_days
                <= params["list_limits" "_for_defining" "_term_" "status"][5]
            ):
                ...
                gestational_age_in_days
                >= params["list_limits_for_defining_term_status"][6]
            ):
            ...
            if labour_state is None:
                logger.info(
                    key="error",
                    data=f"Mother {individual_id} has not had their labour state stored in "
                    f"the mni",
                )

            logger.debug(
                key="message",
                data=f"This is LabourOnsetEvent, person {individual_id} has now gone into "
            ...
            if df.at[individual_id, "ps_gestational_age_in_weeks"] < 24:
                ...
                mean_birth_weight_list_location = int(
                    min(41, df.at[individual_id, "ps_gestational_age_in_weeks"]) - 24
                )

            standard_deviation = params["standard_deviation_birth_weights"][
                mean_birth_weight_list_location
            ]

            # We randomly draw this newborns weight from a normal distribution around the mean for their gestation
            birth_weight = self.module.rng.normal(
                loc=params["mean_birth_weights"][mean_birth_weight_list_location],
            ...
            if birth_weight >= 4000:
                ...
                if (
                    ...
                    < params["residual_prob_of_macrosomia"]
                ):
                    mni[individual_id]["birth_weight"] = "macrosomia"
                else:
            ...
            if df.at[individual_id, "ac_admitted_for_immediate_delivery"] == "none":
                ...
                pred_hb_delivery = self.module.la_linear_models[
                    "probability_delivery_at_home"
                ].predict(df.loc[[individual_id]])[individual_id]
                pred_hc_delivery = self.module.la_linear_models[
                    "probability_delivery_health_centre"
                ].predict(df.loc[[individual_id]])[individual_id]
                ...
                mni[individual_id]["delivery_setting"] = self.module.rng.choice(
                    facility_types, p=probabilities
                )
            ...
            if mni[individual_id]["delivery_setting"] is None:
                logger.info(
                    key="error",
                    data=f"Mother {individual_id} did not have their delivery setting stored in "
                    f"the mni",
                )
            ...
            if mni[individual_id]["delivery_setting"] == "home_birth":
                self.sim.schedule_event(
                    LabourAtHomeEvent(self.module, individual_id), self.sim.date
                )
            ...
            pregnancy_helper_functions.check_if_delayed_careseeking(
                self.module, individual_id
            )
            ...
            self.sim.schedule_event(
                LabourDeathAndStillBirthEvent(self.module, individual_id),
            ...
            # in the simulation
            self.sim.schedule_event(
                BirthAndPostnatalOutcomesEvent(self.module, individual_id),
                self.sim.date + DateOffset(days=5),
            )
...
class LabourAtHomeEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if not mni[individual_id]["delivery_setting"] == "home_birth":
            logger.info(
                key="error",
                data=f"Mother {individual_id} arrived at home birth event incorrectly",
            )
            return
        ...
        self.module.progression_of_hypertensive_disorders(
            individual_id, property_prefix="ps"
        )
        ...
        if not mni[individual_id]["hsi_cant_run"]:
            ...
            if (
                ...
                or (df.at[individual_id, "la_antepartum_haem"] != "none")
                ...
                or (
                    ...
                    and mni[individual_id]["new_onset_spe"]
                )
                ...
                if (
                    self.module.rng.random_sample()
                    < params["prob_careseeking_for_complication"]
                ):
...
class LabourDeathAndStillBirthEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if not (
            self.sim.date - df.at[individual_id, "la_due_date_current_pregnancy"]
        ) == pd.to_timedelta(4, unit="D"):
            logger.info(
                key="error",
                data=f"Mother {individual_id} arrived at LabourDeathAndStillBirthEvent at the "
                f"wrong date",
            )
        ...
        # If a cause is returned death is scheduled
        if potential_cause_of_death:
            pregnancy_helper_functions.log_mni_for_maternal_death(
                self.module, individual_id
            )
            self.sim.modules["Demography"].do_death(
                individual_id=individual_id,
        ...
        outcome_of_still_birth_equation = self.module.predict(
            self.module.la_linear_models["intrapartum_still_birth"], individual_id
        )
        ...
        if (
            df.at[individual_id, "ps_gestational_age_in_weeks"] < 24
        ) or outcome_of_still_birth_equation:
            logger.debug(
                key="message",
                data=f"person {individual_id} has experienced an intrapartum still birth",
            )
            ...
            if not df.at[individual_id, "ps_multiple_pregnancy"] or (
                df.at[individual_id, "ps_multiple_pregnancy"]
                and (random_draw < params["prob_both_twins_ip_still_" "birth"])
            ):
            ...
            elif df.at[individual_id, "ps_multiple_pregnancy"] and (
                random_draw > params["prob_both_twins_ip_still_" "birth"]
            ):
                df.at[individual_id, "ps_prev_stillbirth"] = True
                mni[individual_id]["single_twin_still_birth"] = True
                logger.debug(
                    key="message", data=f"single twin stillbirth for {individual_id}"
                )

        if (
            mni[individual_id]["death_in_labour"]
            and df.at[individual_id, "la_intrapartum_still_birth"]
        ):
        ...
        if (
            df.at[individual_id, "la_intrapartum_still_birth"]
            or mni[individual_id]["single_twin_still_birth"]
        ):
            logger.info(
...
class BirthAndPostnatalOutcomesEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, mother_id):
        ...
        if not (
            self.sim.date - df.at[mother_id, "la_due_date_current_pregnancy"]
        ) == pd.to_timedelta(5, unit="D"):
            logger.info(
                key="error",
                data=f"Mother {mother_id} arrived at BirthAndPostnatalOutcomesEvent at the "
                f"wrong date",
            )
        ...
        if (
            person.is_alive
            and person.is_pregnant
            and not person.la_intrapartum_still_birth
        ) or (
            not person.is_alive
            and mni[mother_id]["death_in_labour"]
            and not person.la_intrapartum_still_birth
        ):
            logger.info(
                key="message", data=f"A Birth is now occurring, to mother {mother_id}"
            )
            ...
            if person.ps_multiple_pregnancy:
                ...
                if not mni[mother_id]["single_twin_still_birth"]:
                    ...
                    logger.debug(
                        key="message",
                        data=f"Mother {mother_id} will now deliver twins {child_one} & "
                        f"{child_two}",
                    )
                    self.sim.modules["NewbornOutcomes"].link_twins(
                        child_one, child_two, mother_id
                    )
            else:
        ...
        if (
            df.at[mother_id, "is_alive"]
            and df.at[mother_id, "la_intrapartum_still_birth"]
        ):
        ...
        if df.at[mother_id, "is_alive"]:
            ...
            for complication in [
                ...
                self.module.set_postpartum_complications(
                    mother_id, complication=complication
                )
            ...
            self.module.progression_of_hypertensive_disorders(
                mother_id, property_prefix="pn"
            )

            # Following this we determine if this woman will receive/seek care for postnatal care after delivery
            if (
                df.at[mother_id, "la_sepsis_pp"]
                or df.at[mother_id, "la_postpartum_haem"]
                or (
                    (df.at[mother_id, "pn_htn_disorders"] == "severe_pre_eclamp")
                    and mni[mother_id]["new_onset_spe"]
                )
                or (df.at[mother_id, "pn_htn_disorders"] == "eclampsia")
            ):
                ...
                prob_pnc = self.module.la_linear_models["postnatal_check"].predict(
                    df.loc[[mother_id]],
                    mode_of_delivery=pd.Series(
                        mni[mother_id]["mode_of_delivery"],
                        index=df.loc[[mother_id]].index,
                    ),
                    delivery_setting=pd.Series(
                        mni[mother_id]["delivery_setting"],
                        index=df.loc[[mother_id]].index,
                    ),
                )[mother_id]
                has_comps = False
            ...
            if self.module.rng.random_sample() < prob_pnc:
                timing = self.module.rng.choice(
                    ["<48", ">48"], p=params["prob_timings_pnc"]
                )
...
class HSI_Labour_ReceivesSkilledBirthAttendanceDuringLabour(
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        if (
            mni[person_id]["delivery_setting"] == "home_birth"
            and mni[person_id]["sought_care_for_complication"]
        ):
        ...
        if mni[person_id]["delivery_setting"] == "home_birth":
            logger.info(
                key="error",
                data=f"Mother {person_id} is receiving SBA with delivery setting as home birth",
            )
        ...
        if (
            ...
            self.module.assessment_for_assisted_vaginal_delivery(
                self, indication="spe_ec"
            )
        ...
        pregnancy_helper_functions.check_if_delayed_care_delivery(
            self.module, squeeze_factor, person_id, hsi_type="bemonc"
        )
        ...
        avail = pregnancy_helper_functions.return_cons_avail(
            self.module,
            self,
            self.module.item_codes_lab_consumables,
            core="delivery_core",
        ...
        if not mni[person_id]["sought_care_for_complication"]:
            for complication in [
                ...
                self.module.set_intrapartum_complications(
                    person_id, complication=complication
                )
            self.module.progression_of_hypertensive_disorders(
                person_id, property_prefix="ps"
            )
        ...
        if not mni[person_id]["referred_for_cs"] and (
            not mni[person_id]["mode_of_delivery"] == "instrumental"
        ):
        ...
        if not mni[person_id]["sought_care_for_complication"]:
            ...
            # Run HCW check
            sf_check = pregnancy_helper_functions.check_emonc_signal_function_will_run(
                self.module, sf="neo_resus", hsi_event=self
            )
...
class HSI_Labour_ReceivesPostnatalCheck(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        if not df.at[person_id, "is_alive"] or pd.isnull(
            df.at[person_id, "la_date_most_recent_delivery"]
        ):
            return None
        ...
        if (mni[person_id]["will_receive_pnc"] == "early") and not mni[person_id][
            "passed_through_week_one"
        ]:
            if not self.sim.date <= (
                df.at[person_id, "la_date_most_recent_delivery"] + pd.DateOffset(days=2)
            ):
                logger.info(
                    key="error", data=f"Mother {person_id} attended early PNC too late"
                )

            if not df.at[person_id, "la_pn_checks_maternal"] == 0:
                logger.info(
                    key="error", data=f"Mother {person_id} attended early PNC twice"
                )

        elif (
            mni[person_id]["will_receive_pnc"] == "late"
            and not mni[person_id]["passed_through_week_one"]
        ):
            if not self.sim.date >= (
                df.at[person_id, "la_date_most_recent_delivery"] + pd.DateOffset(days=2)
            ):
                logger.info(
                    key="error", data=f"Mother {person_id} attended late PNC too early"
                )

            if not df.at[person_id, "la_pn_checks_maternal"] == 0:
                logger.info(
                    key="error", data=f"Mother {person_id} attended late PNC twice"
                )
        ...
        # of death if complications occur)
        pregnancy_helper_functions.check_if_delayed_care_delivery(
            self.module, squeeze_factor, person_id, hsi_type="pn"
        )
        ...
        if (
            self.module.rng.random_sample()
            < params["prob_intervention_delivered_anaemia_assessment_pnc"]
        ):
        ...
        if (
            mni[person_id]["referred_for_surgery"]
            or mni[person_id]["referred_for_blood"]
        ):
            surgical_management = (
                HSI_Labour_ReceivesComprehensiveEmergencyObstetricCare(
        ...
        # days
            ...
            mother.la_sepsis_treatment
            or mother.la_eclampsia_treatment
            or mother.la_severe_pre_eclampsia_treatment
            or mother.la_maternal_hypertension_treatment
            or self.module.pph_treatment.has_all(person_id, "manual_removal_placenta")
        ):
        ...
        # ====================================== APPLY RISK OF DEATH===================================================
        if (
            not mni[person_id]["referred_for_surgery"]
            and not mni[person_id]["referred_for_blood"]
        ):
    ...
    def _get_facility_level_for_pnc(self, person_id):
        ...
        if (
            (person_id in mni)
            and (mni[person_id]["will_receive_pnc"] == "early")
            and (mni[person_id]["delivery_setting"] == "hospital")
        ):
...
class HSI_Labour_ReceivesComprehensiveEmergencyObstetricCare(
    HSI_Event, IndividualScopeEventMixin
):
    """
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        # of death if complications occur)
        pregnancy_helper_functions.check_if_delayed_care_delivery(
            self.module, squeeze_factor, person_id, hsi_type="cemonc"
        )
        ...
        if (
            mni[person_id]["referred_for_surgery"]
            and self.timing == "intrapartum"
            and df.at[person_id, "la_uterine_rupture"]
        ):
            ...
            if mni[person_id]["mode_of_delivery"] == "caesarean_section":
                ...
                treatment_success_ur = (
                    params["success_rate_uterine_repair"]
                    > self.module.rng.random_sample()
                )
        ...
        # And those who didnt have surgery had the expected footprint overwritten
            ...
            not df.at[person_id, "la_uterine_rupture_treatment"]
            and not df.at[person_id, "la_has_had_hysterectomy"]
            and not self.module.pph_treatment.has_all(person_id, "surgery")
        ):
            return self.make_appt_footprint({"InpatientDays": 1})

    def never_ran(self):
        self.module.run_if_receives_comprehensive_emergency_obstetric_care_cant_run(
            self
        )
...
class HSI_Labour_PostnatalWardInpatientCare(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        logger.debug(
            key="message",
            data="HSI_Labour_PostnatalWardInpatientCare now running to capture "
            "inpatient time for an unwell postnatal woman",
        )

    def did_not_run(self):
        logger.debug(
            key="message", data="HSI_Labour_PostnatalWardInpatientCare: did not run"
        )
        return False
    ...
    def not_available(self):
        logger.debug(
            key="message",
            data="HSI_Labour_PostnatalWardInpatientCare: cannot not run with "
            "this configuration",
        )
...
class LabourAndPostnatalCareAnalysisEvent(Event, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        if (
            params["alternative_bemonc_availability"]
            ...
            if params["alternative_pnc_coverage"]:
                ...
                if "mode_of_delivery" in mni_df.columns:
                    mode_of_delivery = pd.Series(
                        mni_df["mode_of_delivery"], index=women.index
                    )
                if "delivery_setting" in mni_df.columns:
                    delivery_setting = pd.Series(
                        mni_df["delivery_setting"], index=women.index
                    )

                mean = (
                    self.module.la_linear_models["postnatal_check"]
                    .predict(
                        df.loc[
                            df.is_alive
                            & (df.sex == "F")
                ...
                scaled_intercept = (
                    1.0 * (target / mean)
                    if (target != 0 and mean != 0 and not np.isnan(mean))
                    else 1.0
                )
                ...
                nb_params["prob_pnc_check_newborn"] = params[
                    "pnc_availability_probability"
                ]
                nb_params["prob_care_seeking_for_complication"] = params[
                    "pnc_availability_probability"
                ]
                nb_params["prob_timings_pnc_newborns"] = [1.0, 0]

                pn_params["prob_care_seeking_postnatal_emergency"] = params[
                    "pnc_availability_probability"
                ]
                pn_params["prob_care_seeking_postnatal_emergency_neonate"] = params[
                    "pnc_availability_probability"
                ]

            if params["alternative_pnc_quality"]:
                params["squeeze_threshold_for_delay_three_pn"] = 10_000
                params["prob_intervention_delivered_anaemia_assessment_pnc"] = params[
                    "pnc_availability_probability"
                ]
...
class LabourLoggingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        prop_hyst = (
            len(hysterectomy.loc[hysterectomy]) / len(repro_women.loc[repro_women])
        ) * 100
        prop_in_labour = (
            len(labour.loc[labour]) / len(repro_women.loc[repro_women])
        ) * 100
        prop_pn = (
            len(postnatal.loc[postnatal]) / len(repro_women.loc[repro_women])
        ) * 100
        prop_ip = (
            len(inpatient.loc[inpatient]) / len(repro_women.loc[repro_women])
        ) * 100
