...
class Labour(Module):
    ...
    def report_daly_values(self):
        ...
        p = self.parameters['la_daly_wts']
        mni = self.sim.modules['PregnancySupervisor'].mother_and_newborn_info

        monthly_daly = dict()

        # todo: HTN disorders?
        # todo should we only cycle through women in labour?
    ...
    def prophylactic_labour_interventions(self, hsi_event):
        ...
        # todo split these up into seperate interventions
    ...
    def interventions_delivered_pre_discharge(self, hsi_event):
        ...
        # TODO: review this once I have more detailed PNC guidlines. I also need to link up with
...
class HSI_Labour_ReceivesComprehensiveEmergencyObstetricCare(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        if mni[person_id]['referred_for_cs'] and self.timing == 'intrapartum':
            ...
            # todo this is firing before the birth actually happens which doesnt make sense
