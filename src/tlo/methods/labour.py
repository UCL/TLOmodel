...
class Labour(Module, GenericFirstAppointmentsMixin):
    ...
    CAUSES_OF_DISABILITY = {"maternal": Cause(gbd_causes="Maternal disorders", label="Maternal Disorders")}
    ...
    PARAMETERS = {
        ...
        # POSTTERM RATE
        "risk_post_term_labour": Parameter(Types.LIST, "risk of remaining pregnant past 42 weeks"),
        ...
        "allowed_interventions": Parameter(Types.LIST, "list of interventions allowed to run, used in analysis"),
        # BIRTH WEIGHT...
        ...
        "cfr_aph": Parameter(Types.LIST, "case fatality rate for antepartum haemorrhage during labour"),
        # MATERNAL INFECTION...
        "prob_sepsis_chorioamnionitis": Parameter(Types.LIST, "risk of sepsis following chorioamnionitis infection"),
        "rr_sepsis_chorio_prom": Parameter(Types.LIST, "relative risk of chorioamnionitis following PROM"),
        "prob_sepsis_endometritis": Parameter(Types.LIST, "risk of sepsis following endometritis"),
        "rr_sepsis_endometritis_post_cs": Parameter(
            Types.LIST, "relative risk of endometritis following caesarean delivery"
        ),
        "prob_sepsis_urinary_tract": Parameter(Types.LIST, "risk of sepsis following urinary tract infection"),
        "prob_sepsis_skin_soft_tissue": Parameter(Types.LIST, "risk of sepsis following skin or soft tissue infection"),
        "rr_sepsis_sst_post_cs": Parameter(
            Types.LIST, "relative risk of skin/soft tissue sepsis following caesarean delivery"
        ),
        "cfr_sepsis": Parameter(Types.LIST, "case fatality rate for sepsis during labour"),
        "cfr_pp_sepsis": Parameter(Types.LIST, "case fatality rate for sepsis following delivery"),
        # UTERINE RUPTURE...
        "prob_uterine_rupture": Parameter(Types.LIST, "probability of a uterine rupture during labour"),
        ...
        "rr_ur_obstructed_labour": Parameter(
            Types.LIST, "relative risk of uterine rupture in women who have been in obstructed labour"
        ),
        "cfr_uterine_rupture": Parameter(Types.LIST, "case fatality rate for uterine rupture in labour"),
        ...
        "cfr_eclampsia": Parameter(Types.LIST, "case fatality rate for eclampsia during labours"),
        "cfr_severe_pre_eclamp": Parameter(Types.LIST, "case fatality rate for severe pre eclampsia during labour"),
        "cfr_pp_eclampsia": Parameter(Types.LIST, "case fatality rate for eclampsia following delivery"),
        # INTRAPARTUM STILLBIRTH...
        "prob_ip_still_birth": Parameter(Types.LIST, "baseline probability of intrapartum still birth"),
        ...
        "prob_pph_uterine_atony": Parameter(Types.LIST, "risk of pph after experiencing uterine atony"),
        ...
        "rr_pph_ua_diabetes": Parameter(Types.LIST, "risk of pph after experiencing uterine atony"),
        "prob_pph_retained_placenta": Parameter(Types.LIST, "risk of pph after experiencing retained placenta"),
        "prob_pph_other_causes": Parameter(Types.LIST, "risk of pph after experiencing other pph causes"),
        "cfr_pp_pph": Parameter(Types.LIST, "case fatality rate for postpartum haemorrhage"),
        ...
        "odds_deliver_at_home": Parameter(Types.LIST, "odds of a woman delivering at home compared to a hospital"),
        "rrr_hb_delivery_age_20_24": Parameter(
            Types.LIST, "relative risk ratio for a woman aged 20-24 delivering at home compared to a " "hospital"
        ),
        "rrr_hb_delivery_age_25_29": Parameter(
            Types.LIST, "relative risk ratio for a woman aged 25-29 delivering at home compared to a " "hospital"
        ),
        "rrr_hb_delivery_age_30_34": Parameter(
            Types.LIST, "relative risk ratio for a woman aged 30-34 delivering at home compared to a " "hospital"
        ),
        "rrr_hb_delivery_age_35_39": Parameter(
            Types.LIST, "relative risk ratio for a woman aged 35-39 delivering at home compared to a " "hospital"
        ),
        ...
        "rrr_hb_delivery_wealth_4": Parameter(
            Types.LIST, "relative risk ratio of a woman at wealth level 4 delivering at home compared to a " "hospital"
        ),
        "rrr_hb_delivery_wealth_3": Parameter(
            Types.LIST, "relative risk ratio of a woman at wealth level 3 delivering at home compared to a " "hospital"
        ),
        "rrr_hb_delivery_wealth_2": Parameter(
            Types.LIST, "relative risk ratio of a woman at wealth level 2 delivering at home compared to a " "hospital"
        ),
        "rrr_hb_delivery_wealth_1": Parameter(
            Types.LIST, "relative risk ratio of a woman at wealth level 1 delivering at home compared to a " "hospital"
        ),
        "rrr_hb_delivery_parity_3_to_4": Parameter(
            Types.LIST,
            "relative risk ratio for a woman with a parity of 3-4 delivering at home compared to" "a hospital",
        ),
        "rrr_hb_delivery_parity_>4": Parameter(
            Types.LIST, "relative risk ratio of a woman with a parity >4 delivering at home compared to a " "hospital"
        ),
        ...
        "probability_delivery_hospital": Parameter(Types.LIST, "probability of delivering in a hospital"),
        # PNC CHECK...
        ...
        "or_pnc_age_30_35": Parameter(Types.LIST, "odds ratio for women aged 30-35 attending PNC"),
        "or_pnc_age_>35": Parameter(Types.LIST, "odds ratio for women aged > 35 attending PNC"),
        "or_pnc_rural": Parameter(Types.LIST, "odds ratio for women who live rurally attending PNC"),
        "or_pnc_wealth_level_1": Parameter(
            Types.LIST, "odds ratio for women from the highest wealth level attending PNC"
        ),
        "or_pnc_anc4+": Parameter(Types.LIST, "odds ratio for women who attended ANC4+ attending PNC"),
        ...
        "or_pnc_parity_>4": Parameter(Types.LIST, "odds ratio for women with a parity of >4 attending PNC"),
        ...
        "sepsis_treatment_effect_md": Parameter(Types.LIST, "effect of treatment for sepsis on risk of maternal death"),
        "success_rate_uterine_repair": Parameter(Types.LIST, "probability repairing a ruptured uterus surgically"),
        ...
        "bemonc_cons_availability": Parameter(Types.REAL, "set probability of BEmONC consumables being available"),
        "cemonc_cons_availability": Parameter(Types.REAL, "set probability of CEmONC consumables being available"),
    ...
    PROPERTIES = {
        "la_due_date_current_pregnancy": Property(
            Types.DATE, "The date on which a newly pregnant woman is scheduled to" " go into labour"
        ),
        "la_currently_in_labour": Property(Types.BOOL, "whether this woman is currently in labour"),
        "la_intrapartum_still_birth": Property(
            Types.BOOL, "whether this womans most recent pregnancy has ended " "in a stillbirth"
        ),
        ...
        "la_antepartum_haem": Property(
            Types.CATEGORICAL,
            "whether the woman has experienced an antepartum haemorrhage" " in this delivery and it severity",
            categories=["none", "mild_moderate", "severe"],
        ),
        "la_uterine_rupture": Property(
            Types.BOOL, "whether the woman has experienced uterine rupture in this " "delivery"
        ),
        ...
        "la_severe_pre_eclampsia_treatment": Property(
            Types.BOOL, "whether this woman has been treated for severe " "pre-eclampsia"
        ),
        "la_maternal_hypertension_treatment": Property(
            Types.BOOL, "whether this woman has been treated for maternal " "hypertension"
        ),
        "la_gest_htn_on_treatment": Property(
            Types.BOOL, "whether this woman has is receiving regular " "antihypertensives"
        ),
        "la_postpartum_haem": Property(
            Types.BOOL, "whether the woman has experienced an postpartum haemorrhage in this" "delivery"
        ),
        "la_postpartum_haem_treatment": Property(
            Types.BITSET, " Treatment for received for postpartum haemorrhage " "(bitset)"
        ),
        ...
        "la_is_postpartum": Property(
            Types.BOOL, "Whether a woman is in the postpartum period, from delivery until " "day +42 (6 weeks)"
        ),
        ...
        "la_iron_folic_acid_postnatal": Property(
            Types.BOOL, "Whether a woman is receiving iron and folic acid during " "the postnatal period"
        ),
    }

    def read_parameters(self, data_folder):
        parameter_dataframe = read_csv_files(
            Path(self.resourcefilepath) / "ResourceFile_LabourSkilledBirth" "Attendance", files="parameter_values"
        )
    ...
    def initialise_population(self, population):
        ...
        self.pph_treatment = BitsetHandler(
            self.sim.population, "la_postpartum_haem_treatment", ["manual_removal_placenta", "surgery", "hysterectomy"]
        )
        ...
        df.loc[df.is_alive & (df.sex == "F") & (df.age_years > 14), "la_parity"] = parity_equation.predict(
    ...
    def get_and_store_labour_item_codes(self):
        ...
        self.item_codes_lab_consumables["antenatal_steroids"] = {ic("Dexamethasone 5mg/ml, 5ml_each_CMST"): 12}
        ...
        self.item_codes_lab_consumables["oral_antihypertensives"] = {ic("Methyldopa 250mg_1000_CMST"): 1}
        ...
        # -------------------------------------  POSTPARTUM HAEMORRHAGE  ---------------------------------------
        self.item_codes_lab_consumables["pph_core"] = {ic("Oxytocin, injection, 10 IU in 1 ml ampoule"): 5}
        ...
        self.item_codes_lab_consumables["iron_folic_acid"] = {ic("Ferrous Salt + Folic Acid, tablet, 200 + 0.25 mg"): 1}
    ...
    def initialise_simulation(self, sim):
        ...
        sim.schedule_event(
            LabourAndPostnatalCareAnalysisEvent(self), Date(self.current_parameters["analysis_year"], 1, 1)
        )
        ...
        self.la_linear_models = {
            ...
            # postpartum phase of labour and is mitigated by clean delivery
            "sepsis_urinary_tract_pp": LinearModel.custom(labour_lm.predict_sepsis_urinary_tract_pp, parameters=params),
            ...
            "intrapartum_still_birth": LinearModel.custom(labour_lm.predict_intrapartum_still_birth, parameters=params),
    ...
    def set_date_of_labour(self, individual_id):
        ...
        logger.debug(
            key="message",
            data=f"person {individual_id} is having their labour scheduled on date " f"{self.sim.date}",
        )
        ...
        if (
            ...
            < self.la_linear_models["post_term_labour"].predict(df.loc[[individual_id]])[individual_id]
        ):
            df.at[individual_id, "la_due_date_current_pregnancy"] = df.at[
                individual_id, "date_of_last_pregnancy"
            ] + pd.DateOffset(days=(7 * 40) + self.rng.randint(0, 7 * 3))
        ...
        self.sim.schedule_event(
            LabourOnsetEvent(self, individual_id), df.at[individual_id, "la_due_date_current_pregnancy"]
        )
    ...
    def set_intrapartum_complications(self, individual_id, complication):
        ...
        if mni[individual_id]["delivery_setting"] == "none":
            logger.info(
                key="error",
                data=f"Mother {individual_id} is having risk of complications applied but has no " f"delivery setting",
            )
            return
        ...
        if complication not in self.possible_intrapartum_complications:
            logger.info(
                key="error", data=f'A complication ("{complication}") was passed to ' f"set_intrapartum_complications"
            )
            return
        ...
        if (
            ...
            or ((complication == "placental_abruption") and df.at[individual_id, "ps_placental_abruption"])
            or ((complication == "sepsis_chorioamnionitis") and df.at[individual_id, "ps_chorioamnionitis"])
        ):
            return
        ...
        if result:
            logger.debug(
                key="message",
                data=f"person {individual_id} has developed {complication} during birth on date" f"{self.sim.date}",
            )
            ...
            if complication in ("obstruction_cpd", "obstruction_malpos_malpres", "obstruction_other"):
                ...
                logger.info(
                    ...
                    data={"person": individual_id, "type": f"{complication}", "timing": "intrapartum"},
                )
            ...
            # to labour)
                ...
                logger.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": "placental_abruption", "timing": "intrapartum"},
                )

            elif complication == "antepartum_haem":
                random_choice = self.rng.choice(["mild_moderate", "severe"], p=params["severity_maternal_haemorrhage"])
                ...
                if random_choice != "severe":
                    ...
                    pregnancy_helper_functions.store_dalys_in_mni(individual_id, mni, "severe_aph_onset", self.sim.date)
                    logger.info(
                        key="maternal_complication",
                        data={
                            "person": individual_id,
                ...
                logger.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": "sepsis", "timing": "intrapartum"},
                )
                ...
                logger.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": "uterine_rupture", "timing": "intrapartum"},
                )
    ...
    def set_postpartum_complications(self, individual_id, complication):
        ...
        if complication not in self.possible_postpartum_complications:
            logger.info(
                key="error", data=f'A complication ("{complication}") was passed to ' f"set_postpartum_complications"
            )
            return
        ...
        if result:
            ...
            if complication in ("pph_uterine_atony", "pph_retained_placenta", "pph_other"):
                ...
                logger_pn.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": f"{complication}", "timing": "postnatal"},
                )
                ...
                if pd.isnull(mni[individual_id]["mild_mod_pph_onset"]) and pd.isnull(
                    ...
                    random_choice = self.rng.choice(
                        ["non_severe", "severe"], size=1, p=params["severity_maternal_haemorrhage"]
                    )
    ...
    def progression_of_hypertensive_disorders(self, individual_id, property_prefix):
        ...
        if df.at[individual_id, f"{property_prefix}_htn_disorders"] == "severe_pre_eclamp":
            ...
            if df.at[individual_id, "la_severe_pre_eclampsia_treatment"] or (
                ...
                and (df.at[individual_id, "ac_admitted_for_immediate_delivery"] != "none")
            ):
            ...
            if risk_progression_spe_ec > self.rng.random_sample():
                ...
                pregnancy_helper_functions.store_dalys_in_mni(individual_id, mni, "eclampsia_onset", self.sim.date)

                current_log.info(
                    key="maternal_complication", data={"person": individual_id, "type": "eclampsia", "timing": timing}
                )
        ...
        if df.at[individual_id, f"{property_prefix}_htn_disorders"] == "gest_htn":
            if df.at[individual_id, "la_maternal_hypertension_treatment"]:
                risk_prog_gh_sgh = (
                    params["prob_progression_gest_htn"] * params["anti_htns_treatment_effect_progression"]
                )
            else:
            ...
            if risk_prog_gh_sgh > self.rng.random_sample():
                ...
                current_log.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": "severe_gest_htn", "timing": timing},
                )
        ...
        if df.at[individual_id, f"{property_prefix}_htn_disorders"] == "severe_gest_htn":
            if params["prob_progression_severe_gest_htn"] > self.rng.random_sample():
                ...
                current_log.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": "severe_pre_eclamp", "timing": timing},
                )
    ...
    def apply_risk_of_early_postpartum_death(self, individual_id):
        ...
        # has been applied
            ...
            self.pph_treatment.unset([individual_id], "manual_removal_placenta", "surgery", "hysterectomy")
            ...
            if not mni[individual_id]["passed_through_week_one"]:
                ...
                if not days_post_birth_int < 6:
                    logger.info(
                        key="error", data=f"Mother {individual_id} scheduled to PN week one at >1 " f"week postnatal"
                    )
    ...
    def labour_characteristics_checker(self, individual_id):
        ...
        if (
            ...
            logger.info(
                key="error",
                data=f"Person {individual_id} has characteristics that mean they should" f" not be in labour ",
            )
    ...
    def postpartum_characteristics_checker(self, individual_id):
        ...
        if (
            ...
            or (not mni[individual_id]["passed_through_week_one"] and individual_id not in self.women_in_labour)
        ):
            logger.info(
                key="error",
    ...
    def assessment_for_assisted_vaginal_delivery(self, hsi_event, indication):
        ...
        if (
            ("assessment_and_treatment_of_obstructed_labour" not in params["allowed_interventions"])
            or (df.at[person_id, "ac_admitted_for_immediate_delivery"] == "caesarean_now")
            or (df.at[person_id, "ac_admitted_for_immediate_delivery"] == "caesarean_future")
        ):
            return
    ...
    def assessment_and_treatment_of_maternal_sepsis(self, hsi_event, labour_stage):
        ...
        if (
            ...
            or ((labour_stage == "ip") and df.at[person_id, "ps_chorioamnionitis"])
    ...
    def assessment_and_treatment_of_pph_retained_placenta(self, hsi_event):
        ...
        if (df.at[person_id, "la_postpartum_haem"] and mni[person_id]["retained_placenta"]) or df.at[
            person_id, "pn_postpartum_haem_secondary"
        ]:
    ...
    def surgical_management_of_pph(self, hsi_event):
        ...
        # run HCW check
        sf_check = pregnancy_helper_functions.check_emonc_signal_function_will_run(self, sf="surg", hsi_event=hsi_event)
    ...
    def assessment_for_depression(self, hsi_event):
        ...
        if "Depression" in self.sim.modules.keys():
            self.sim.modules["Depression"].do_on_presentation_to_care(person_id=person_id, hsi_event=hsi_event)
    ...
    def run_if_receives_skilled_birth_attendance_cant_run(self, hsi_event):
        ...
        logger.debug(
            key="message",
            data=f"HSI_Labour_ReceivesSkilledBirthAttendanceDuringLabour will not run for " f"{person_id}",
        )
    ...
    def run_if_receives_comprehensive_emergency_obstetric_care_cant_run(self, hsi_event):
        ...
        logger.debug(
            key="message",
            data=f"HSI_Labour_ReceivesComprehensiveEmergencyObstetricCare will not run for" f" {person_id}",
        )
    ...
    def apply(self, individual_id):
        ...
        if self.module.check_labour_can_proceed(individual_id):
            ...
            # account for PregnancySupervisor only updating weekly
                ...
                logger.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": "early_preterm_labour", "timing": "intrapartum"},
                )
                ...
                logger.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": "late_preterm_labour", "timing": "intrapartum"},
                )
                ...
                logger.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": "post_term_labour", "timing": "intrapartum"},
                )
            ...
            if labour_state is None:
                logger.info(
                    key="error", data=f"Mother {individual_id} has not had their labour state stored in " f"the mni"
                )
            ...
            birth_weight = self.module.rng.normal(
                loc=params["mean_birth_weights"][mean_birth_weight_list_location], scale=standard_deviation
            )
            ...
            if mni[individual_id]["delivery_setting"] is None:
                logger.info(
                    key="error",
                    data=f"Mother {individual_id} did not have their delivery setting stored in " f"the mni",
                )
            ...
            # Otherwise the appropriate HSI is scheduled
                ...
                self.sim.modules["HealthSystem"].schedule_hsi_event(
                    health_centre_delivery, priority=0, topen=self.sim.date, tclose=self.sim.date + DateOffset(days=2)
                )
                ...
                self.sim.modules["HealthSystem"].schedule_hsi_event(
                    hospital_delivery, priority=0, topen=self.sim.date, tclose=self.sim.date + DateOffset(days=2)
                )
            ...
            self.sim.schedule_event(
                LabourDeathAndStillBirthEvent(self.module, individual_id), self.sim.date + DateOffset(days=4)
            )

            # After the death event women move to the Birth Event where, for surviving women and foetus, birth occurs
            # in the simulation
            self.sim.schedule_event(
                BirthAndPostnatalOutcomesEvent(self.module, individual_id), self.sim.date + DateOffset(days=5)
            )
...
class LabourAtHomeEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if df.at[individual_id, "la_obstructed_labour"]:
            logger.info(
                key="maternal_complication",
                data={"person": individual_id, "type": "obstructed_labour", "timing": "intrapartum"},
            )
        ...
        if not mni[individual_id]["hsi_cant_run"]:
            if (
                ...
                if self.module.rng.random_sample() < params["prob_careseeking_for_complication"]:
                    ...
                    event = HSI_GenericEmergencyFirstAppt(module=self.module, person_id=individual_id)
...
class LabourDeathAndStillBirthEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if not (self.sim.date - df.at[individual_id, "la_due_date_current_pregnancy"]) == pd.to_timedelta(4, unit="D"):
            logger.info(
                key="error",
                data=f"Mother {individual_id} arrived at LabourDeathAndStillBirthEvent at the " f"wrong date",
            )
        ...
        if df.at[individual_id, "la_intrapartum_still_birth"] or mni[individual_id]["single_twin_still_birth"]:
            logger.info(
                key="intrapartum_stillbirth", data={"mother_id": individual_id, "date_of_ip_stillbirth": self.sim.date}
            )
...
class BirthAndPostnatalOutcomesEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, mother_id):
        ...
        if not (self.sim.date - df.at[mother_id, "la_due_date_current_pregnancy"]) == pd.to_timedelta(5, unit="D"):
            logger.info(
                key="error", data=f"Mother {mother_id} arrived at BirthAndPostnatalOutcomesEvent at the " f"wrong date"
            )
        ...
        if (person.is_alive and person.is_pregnant and not person.la_intrapartum_still_birth) or (
            ...
            if person.ps_multiple_pregnancy:
                ...
                if not mni[mother_id]["single_twin_still_birth"]:
                    ...
                    logger.debug(
                        key="message", data=f"Mother {mother_id} will now deliver twins {child_one} & " f"{child_two}"
                    )
        ...
        if df.at[mother_id, "is_alive"]:
            ...
            if df.at[mother_id, "la_sepsis_pp"]:
                logger_pn.info(
                    key="maternal_complication",
                    data={"person": mother_id, "type": "sepsis_postnatal", "timing": "postnatal"},
                )
            if df.at[mother_id, "la_postpartum_haem"]:
                logger_pn.info(
                    key="maternal_complication",
                    data={"person": mother_id, "type": "primary_postpartum_haemorrhage", "timing": "postnatal"},
                )
            ...
            if (
                ...
                or ((df.at[mother_id, "pn_htn_disorders"] == "severe_pre_eclamp") and mni[mother_id]["new_onset_spe"])
            ...
            if self.module.rng.random_sample() < prob_pnc:
                ...
                if timing == "<48" or has_comps:
                    ...
                    early_event = HSI_Labour_ReceivesPostnatalCheck(module=self.module, person_id=mother_id)

                    self.sim.modules["HealthSystem"].schedule_hsi_event(
                        early_event, priority=0, topen=self.sim.date, tclose=self.sim.date + DateOffset(days=2)
                    )
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        if not mni[person_id]["sought_care_for_complication"]:
            ...
            if df.at[person_id, "la_obstructed_labour"]:
                logger.info(
                    key="maternal_complication",
                    data={"person": person_id, "type": "obstructed_labour", "timing": "intrapartum"},
                )
        ...
        if (
            ...
            self.sim.modules["HealthSystem"].schedule_hsi_event(
                surgical_management, priority=0, topen=self.sim.date, tclose=self.sim.date + DateOffset(days=2)
            )
...
class HSI_Labour_ReceivesPostnatalCheck(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        if mni[person_id]["referred_for_surgery"] or mni[person_id]["referred_for_blood"]:
            ...
            self.sim.modules["HealthSystem"].schedule_hsi_event(
                surgical_management, priority=0, topen=self.sim.date, tclose=self.sim.date + DateOffset(days=1)
            )
        ...
        # days
            ...
            self.sim.modules["HealthSystem"].schedule_hsi_event(
                postnatal_inpatient, priority=0, topen=self.sim.date, tclose=self.sim.date + DateOffset(days=1)
            )
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        if mni[person_id]["referred_for_cs"] and self.timing == "intrapartum":
            ...
            if params["la_analysis_in_progress"] and (params["cemonc_availability"] == 0.0):
                ...
                logger.info(key="cs_indications", data={"id": person_id, "indication": mni[person_id]["cs_indication"]})
        ...
        if (
            ...
            and (df.at[person_id, "la_postpartum_haem"] or df.at[person_id, "pn_postpartum_haem_secondary"])
        ):
...
class HSI_Labour_PostnatalWardInpatientCare(HSI_Event, IndividualScopeEventMixin):
    ...
    def not_available(self):
        logger.debug(
            key="message", data="HSI_Labour_PostnatalWardInpatientCare: cannot not run with " "this configuration"
        )
...
class LabourAndPostnatalCareAnalysisEvent(Event, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        if (
            ...
            or params["sba_sens_analysis_max"]
            or params["pnc_sens_analysis_max"]
            or params["pnc_sens_analysis_min"]
        ):
            ...
            if params["pnc_sens_analysis_max"] or params["pnc_sens_analysis_min"]:
                self.module.la_linear_models["postnatal_check"] = LinearModel(
                    LinearModelType.MULTIPLICATIVE, params["pnc_availability_probability"]
                )
                params["prob_timings_pnc"] = [
...
class LabourLoggingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        hysterectomy = (
            df.is_alive & (df.sex == "F") & df.la_has_had_hysterectomy & (df.age_years > 14) & (df.age_years < 50)
        )
        labour = df.is_alive & (df.sex == "F") & df.la_currently_in_labour & (df.age_years > 14) & (df.age_years < 50)
        postnatal = df.is_alive & (df.sex == "F") & df.la_is_postpartum & (df.age_years > 14) & (df.age_years < 50)
        inpatient = df.is_alive & (df.sex == "F") & df.hs_is_inpatient & (df.age_years > 14) & (df.age_years < 50)
        ...
        logger.info(
            key="women_data_debug", data={"hyst": prop_hyst, "labour": prop_in_labour, "pn": prop_pn, "ip": prop_ip}
        )
