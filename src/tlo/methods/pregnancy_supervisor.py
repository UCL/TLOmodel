...
class PregnancySupervisor(Module, GenericFirstAppointmentsMixin):
    ...
    ADDITIONAL_DEPENDENCIES = {"Contraception", "HealthSystem", "Labour", "CareOfWomenDuringPregnancy", "Lifestyle"}
    ...
    PARAMETERS = {
        ...
        # ECTOPIC PREGNANCY...
        "prob_ectopic_pregnancy": Parameter(Types.LIST, "probability of ectopic pregnancy"),
        ...
        "prob_induced_abortion_per_month": Parameter(Types.LIST, "underlying risk of induced abortion per month"),
        "prob_complicated_ia": Parameter(
            Types.LIST, "probability that a woman who experiences induced abortion with experience any " "complications"
        ),
        "prob_haemorrhage_post_abortion": Parameter(Types.LIST, "probability of haemorrhage following an abortion"),
        "prob_sepsis_post_abortion": Parameter(Types.LIST, "probability of sepsis following an abortion"),
        "prob_injury_post_abortion": Parameter(Types.LIST, "probability of injury following an abortion"),
        "prob_induced_abortion_death": Parameter(Types.LIST, "underlying risk of death following an induced abortion"),
        ...
        "rr_anaemia_maternal_malaria": Parameter(Types.LIST, "relative risk of anaemia secondary to malaria infection"),
        "rr_anaemia_hiv_no_art": Parameter(Types.LIST, "relative risk of anaemia for a woman with HIV not on ART"),
        ...
        "rr_gest_diab_obesity": Parameter(Types.LIST, "Relative risk of gestational diabetes for women who are obese"),
        ...
        "rr_pre_eclampsia_obesity": Parameter(Types.LIST, "Relative risk of pre-eclampsia for women who are obese"),
        ...
        "probs_for_mgh_matrix": Parameter(
            Types.LIST,
            "probability of mild gestational hypertension moving between states: gestational "
            "hypertension, severe gestational hypertension, mild pre-eclampsia, severe pre-eclampsia, "
            "eclampsia",
        ),
        "probs_for_sgh_matrix": Parameter(
            Types.LIST,
            "probability of severe gestational hypertension moving between states: gestational "
            "hypertension, severe gestational hypertension, mild pre-eclampsia, severe pre-eclampsia, "
            "eclampsia",
        ),
        "probs_for_mpe_matrix": Parameter(
            Types.LIST,
            "probability of mild pre-eclampsia moving between states: gestational hypertension,"
            " severe gestational hypertension, mild pre-eclampsia, severe pre-eclampsia, eclampsia",
        ),
        "probs_for_spe_matrix": Parameter(
            Types.LIST,
            "probability of severe pre-eclampsia moving between states: gestational hypertension,"
            " severe gestational hypertension, mild pre-eclampsia, severe pre-eclampsia, eclampsia",
        ),
        "probs_for_ec_matrix": Parameter(
            Types.LIST,
            "probability of eclampsia moving between states: gestational hypertension,"
            " severe gestational hypertension, mild pre-eclampsia, severe pre-eclampsia, eclampsia",
        ),
        ...
        "prob_eclampsia_death": Parameter(Types.LIST, "probability of death for a woman experiencing eclampsia"),
        ...
        "prob_mod_sev_aph": Parameter(Types.LIST, "probabilities that APH is mild/moderate or severe"),
        ...
        # CHORIOAMNIONITIS...
        "prob_chorioamnionitis": Parameter(Types.LIST, "monthly probability of a women developing chorioamnionitis"),
        "prob_antenatal_sepsis_death": Parameter(Types.LIST, "case fatality rate for chorioamnionitis"),
        # PRETERM LABOUR...
        "baseline_prob_early_labour_onset": Parameter(
            Types.LIST, "monthly baseline risk of labour onsetting before term"
        ),
        "rr_preterm_labour_post_prom": Parameter(Types.LIST, "relative risk of early labour onset following PROM"),
        "rr_preterm_labour_anaemia": Parameter(Types.LIST, "relative risk of early labour onset in women with anaemia"),
        "rr_preterm_labour_malaria": Parameter(Types.LIST, "relative risk of early labour onset in women with malaria"),
        ...
        "rr_still_birth_maternal_malaria": Parameter(Types.LIST, "relative risk of still birth in women with malaria"),
        ...
        "rr_still_birth_eclampsia": Parameter(Types.LIST, "relative risk of still birth in women with eclampsia"),
        ...
        "rr_still_birth_chorio": Parameter(Types.LIST, "relative risk of still birth in women with chorioamnionitis"),
        ...
        "prob_anc1_months_2_to_4": Parameter(
            Types.LIST,
            "list of probabilities that a woman will attend her first ANC visit at either month 2, 3 or"
            " 4 of pregnancy",
        ),
        ...
        "odds_early_init_anc4": Parameter(
            Types.LIST,
            "probability of a woman undergoing 4 or more basic ANC visits with the first visit occurring "
            "prior or during month 4 of pregnancy (EANC4+)",
        ),
        "aor_early_anc4_20_24": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in women aged 20-24"),
        "aor_early_anc4_25_29": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in women aged 25-29"),
        "aor_early_anc4_30_34": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in women aged 30-34"),
        "aor_early_anc4_35_39": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in women aged 35-39"),
        "aor_early_anc4_40_44": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in women aged 40-44"),
        "aor_early_anc4_45_49": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in women aged 45-49"),
        "aor_early_anc4_2010": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in 2010"),
        "aor_early_anc4_2015": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in 2015"),
        ...
        "aor_early_anc4_parity_6+": Parameter(Types.LIST, "adjusted odds ratio of EANC4+ in women with a parity of 6+"),
        ...
        "prob_early_initiation_anc_below4": Parameter(
            Types.LIST,
            "probabilities a woman will attend fewer than 4 ANC visits but the first visit will occur "
            "before month 4",
        ),
        ...
        "treatment_effect_post_abortion_care": Parameter(Types.LIST, "Treatment effect of post abortion care"),
        ...
        "treatment_effect_anti_htns_progression": Parameter(
            Types.LIST,
            "Effect of anti hypertensive medication in reducing the risk of progression from mild to severe"
            " hypertension",
        ),
        ...
        "anc_service_structure": Parameter(
            Types.INT,
            "stores type of ANC service being delivered in the model (anc4 or anc8) and is used in analysis"
            "scripts to change ANC structure",
        ),
        "analysis_year": Parameter(
            Types.INT,
            "Year on which the pregnancy analysis event is scheduled to update any relevant parameters for "
        ...
        "alternative_anc_coverage": Parameter(
            Types.BOOL,
            "Signals within the analysis event that an alternative level of ANC coverage has been "
            "determined following the events run",
        ),
        "alternative_anc_quality": Parameter(
            Types.BOOL,
            "Signals within the analysis event that an alternative level of ANC quality has been "
            "determined following the events run",
        ),
        "anc_availability_odds": Parameter(
            Types.REAL,
            "Target odds of early initiation of ANC4+ when analysis is being conducted - only applied if"
        ...
        "alternative_ip_anc_quality": Parameter(
            Types.BOOL,
            "Signals within the analysis event that an alternative level of inpatient ANC quality has been "
            "determined following the events run",
        ),
        ...
        "sens_analysis_min": Parameter(
            Types.BOOL,
            "Signals within the analysis event and code that sensitivity analysis is being undertaken in "
    ...
    PROPERTIES = {
        "ps_gestational_age_in_weeks": Property(
            Types.REAL, "current gestational age, in weeks, of a woman " "pregnancy"
        ),
        "ps_date_of_anc1": Property(Types.DATE, "Date first ANC visit is scheduled for"),
        "ps_ectopic_pregnancy": Property(
            Types.CATEGORICAL,
            "Whether a woman is experiencing ectopic pregnancy and" " its current state",
        ...
        "ps_placenta_praevia": Property(
            Types.BOOL, "Whether a woman pregnancy will be complicated by placenta" "praevia"
        ),
        ...
        "ps_prev_spont_abortion": Property(
            Types.BOOL, "Whether this woman has had any previous pregnancies end in " "spontaneous abortion"
        ),
        "ps_prev_stillbirth": Property(
            Types.BOOL, "Whether this woman has had any previous pregnancies end in " "still birth"
        ),
        "ps_htn_disorders": Property(
            Types.CATEGORICAL,
            "if this woman suffers from a hypertensive disorder of " "pregnancy",
            categories=["none", "gest_htn", "severe_gest_htn", "mild_pre_eclamp", "severe_pre_eclamp", "eclampsia"],
        ),
        "ps_prev_pre_eclamp": Property(
            Types.BOOL, "whether this woman has experienced pre-eclampsia in a previous " "pregnancy"
        ),
        ...
        "ps_prev_gest_diab": Property(
            Types.BOOL, "whether this woman has ever suffered from gestational diabetes " "during a previous pregnancy"
        ),
    ...
    def read_parameters(self, data_folder):
        ...
        parameter_dataframe = read_csv_files(
            Path(self.resourcefilepath) / "ResourceFile_PregnancySupervisor", files="parameter_values"
        )
    ...
    def initialise_population(self, population):
        ...
        self.abortion_complications = BitsetHandler(
            self.sim.population, "ps_abortion_complications", ["sepsis", "haemorrhage", "injury", "other"]
        )
    ...
    def initialise_simulation(self, sim):
        ...
        sim.schedule_event(PregnancyLoggingEvent(self), sim.date + DateOffset(years=1))

        # ...and register and schedule the parameter update event
        sim.schedule_event(ParameterUpdateEvent(self), Date(2015, 1, 1))
        ...
        self.ps_linear_models = {
            ...
            "early_initiation_anc4": LinearModel.custom(
                pregnancy_supervisor_lm.early_initiation_anc4, parameters=params
            ),
            # This equation determines the probability of death following en ectopic pregnancy
            "ectopic_pregnancy_death": LinearModel.custom(
                pregnancy_supervisor_lm.ectopic_pregnancy_death, parameters=params
            ),
            ...
            "spontaneous_abortion_death": LinearModel.custom(
                pregnancy_supervisor_lm.spontaneous_abortion_death, parameters=params
            ),
            # This equation determines the probability of death following an induced abortion
            "induced_abortion_death": LinearModel.custom(
                pregnancy_supervisor_lm.induced_abortion_death, parameters=params
            ),
        ...
        models_to_be_scaled = [
            [mod["placenta_praevia"], "prob_placenta_praevia"],
        ...
        if df.at[mother_id, "is_alive"]:
            ...
            if df.at[mother_id, "ps_gest_diab"] != "none":
                ...
                if not pd.isnull(mni[mother_id]["gest_diab_onset"]):
                    pregnancy_helper_functions.store_dalys_in_mni(mother_id, mni, "gest_diab_resolution", self.sim.date)

    def on_hsi_alert(self, person_id, treatment_id):
        logger.debug(
            key="message",
            data="This is PregnancySupervisor, being alerted about a health system interaction "
        ...
        def chronic_daly_calculations(person, complication):
            ...
            if pd.isnull(mni[person][f"{complication}_resolution"]):
                ...
                # days she has experience the complication
                    ...
                    days_since_onset = pd.Timedelta((self.sim.date - mni[person][f"{complication}_onset"]), unit="d")
                ...
                if mni[person][f"{complication}_resolution"] < mni[person][f"{complication}_onset"]:
                    ...
                    if not mni[person][f"{complication}_resolution"] >= mni[person][f"{complication}_onset"]:
                        logger.info(
                            key="error", data=f"Complication resolution has occurred before onset in" f" {person}"
                        )
                        return
                    ...
                    days_free_of_comp_this_month = pd.Timedelta(
                        (self.sim.date - mni[person][f"{complication}_" f"resolution"]), unit="d"
                    )
        ...
        for person in list(mni):
            if df.at[person, "is_alive"]:
                ...
                # otherwise the entry can be deleted
                    ...
                    mni[person]["delete_mni"]
                    and not df.at[person, "is_pregnant"]
                    and not df.at[person, "la_is_postpartum"]
                    and (df.at[person, "ps_ectopic_pregnancy"] == "none")
                ):
                    del mni[person]
    ...
    def apply_linear_model(self, lm, df_slice):
        ...
        return self.rng.random_sample(len(df_slice)) < lm.predict(df_slice, year=self.sim.date.year)
    ...
    def apply_risk_of_induced_abortion(self, gestation_of_interest):
        ...
        abortion = pd.Series(
            self.rng.random_sample(len(at_risk.loc[at_risk])) < params["prob_induced_abortion_per_month"],
    ...
    def do_after_abortion(self, individual_id, type_abortion):
        ...
        logger.info(
            ...
            data={"person": individual_id, "type": f"{type_abortion}", "timing": "antenatal"},
        )
        ...
        if self.rng.random_sample() < risk_of_complications:
            logger.info(
                key="maternal_complication",
                data={"person": individual_id, "type": f"complicated_{type_abortion}", "timing": "antenatal"},
            )
    ...
    def apply_risk_of_abortion_complications(self, individual_id, cause):
        ...
        if cause == "induced_abortion":
            if self.rng.random_sample() < params["prob_injury_post_abortion"]:
                ...
                logger.info(
                    key="maternal_complication",
                    data={"person": individual_id, "type": f"{cause}_injury", "timing": "antenatal"},
                )

        if self.rng.random_sample() < params["prob_haemorrhage_post_abortion"]:
            self.abortion_complications.set([individual_id], "haemorrhage")
            pregnancy_helper_functions.store_dalys_in_mni(individual_id, mni, "abortion_haem_onset", self.sim.date)
            logger.info(
                key="maternal_complication",
                data={"person": individual_id, "type": f"{cause}_haemorrhage", "timing": "antenatal"},
            )

        if self.rng.random_sample() < params["prob_sepsis_post_abortion"]:
            self.abortion_complications.set([individual_id], "sepsis")
            pregnancy_helper_functions.store_dalys_in_mni(individual_id, mni, "abortion_sep_onset", self.sim.date)
            logger.info(
                key="maternal_complication",
                data={"person": individual_id, "type": f"{cause}_sepsis", "timing": "antenatal"},
            )
        ...
        if not self.abortion_complications.has_any([individual_id], "sepsis", "haemorrhage", "injury", first=True):
            ...
            logger.info(
                key="maternal_complication",
                data={"person": individual_id, "type": f"{cause}_other_comp", "timing": "antenatal"},
            )
        ...
        self.sim.schedule_event(
            EarlyPregnancyLossDeathEvent(self, individual_id, cause=f"{cause}"), self.sim.date + DateOffset(days=7)
        )
    ...
    def apply_risk_of_anaemia(self, gestation_of_interest):
        ...
        random_choice_severity = pd.Series(
            self.rng.choice(
                ["mild", "moderate", "severe"], p=params["prob_mild_mod_sev_anaemia"], size=len(anaemia.loc[anaemia])
            ),
    ...
    def apply_risk_of_gestational_diabetes(self, gestation_of_interest):
        ...
        gest_diab = self.apply_linear_model(
            self.ps_linear_models["gest_diab"],
            df.loc[
                df["is_alive"]
                & df["is_pregnant"]
                & (df["ps_gestational_age_in_weeks"] == gestation_of_interest)
        ...
        for person in gest_diab.loc[gest_diab].index:
            logger.info(
                key="maternal_complication", data={"person": person, "type": "gest_diab", "timing": "antenatal"}
            )
    ...
    def apply_risk_of_hypertensive_disorders(self, gestation_of_interest):
        ...
        for person in pre_eclampsia.loc[pre_eclampsia].index:
            logger.info(
                key="maternal_complication", data={"person": person, "type": "mild_pre_eclamp", "timing": "antenatal"}
            )
        ...
        for person in gest_hypertension.loc[gest_hypertension].index:
            logger.info(
                key="maternal_complication", data={"person": person, "type": "mild_gest_htn", "timing": "antenatal"}
            )
    ...
    def apply_risk_of_progression_of_hypertension(self, gestation_of_interest):
        ...
        def apply_risk(selected, risk_of_gest_htn_progression):
            ...
            prob_matrix["gest_htn"] = [
                risk_ghtn_remains_mild,
                risk_of_gest_htn_progression,
                params["probs_for_mgh_matrix"][2],
                0.0,
                0.0,
            ]
            ...
            def log_new_progressed_cases(disease):
                ...
                if not new_onset_disease.empty:
                    ...
                    for person in new_onset_disease.index:
                        logger.info(
                            key="maternal_complication", data={"person": person, "type": disease, "timing": "antenatal"}
                        )
                        if disease == "severe_pre_eclamp":
        ...
        for v in women_not_on_anti_htns.loc[women_not_on_anti_htns].index:
            if v in women_on_anti_htns.loc[women_on_anti_htns].index:
                logger.info(
                    key="error", data="Risk of progression of HTN disorder is being applied to some women " "twice"
                )
        ...
        apply_risk(
            women_on_anti_htns, (risk_progression_mild_to_severe_htn * params["treatment_effect_anti_htns_progression"])
        )
    ...
    def apply_risk_of_death_from_hypertension(self, gestation_of_interest):
        ...
        at_risk_of_death_htn = pd.Series(
            self.rng.random_sample(len(at_risk.loc[at_risk])) < params["prob_monthly_death_severe_htn"],
            index=at_risk.loc[at_risk].index,
        )
        ...
        if not at_risk_of_death_htn.loc[at_risk_of_death_htn].empty:
            ...
            for person in at_risk_of_death_htn.loc[at_risk_of_death_htn].index:
                self.sim.modules["Demography"].do_death(
                    ...
                    cause="severe_gestational_hypertension",
    ...
    def apply_risk_of_placental_abruption(self, gestation_of_interest):
        ...
        for person in placenta_abruption.loc[placenta_abruption].index:
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "placental_abruption", "timing": "antenatal"},
            )
    ...
    def apply_risk_of_antepartum_haemorrhage(self, gestation_of_interest):
        ...
        df.loc[
            antepartum_haemorrhage.loc[antepartum_haemorrhage].index, "ps_antepartum_haemorrhage"
        ...
        severe_women = (
            df.loc[antepartum_haemorrhage.loc[antepartum_haemorrhage].index, "ps_antepartum_haemorrhage"] == "severe"
        )
        ...
        for person in severe_women.loc[severe_women].index:
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "severe_antepartum_haemorrhage", "timing": "antenatal"},
            )
        ...
        for person in non_severe_women.loc[non_severe_women].index:
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "mild_mod_antepartum_haemorrhage", "timing": "antenatal"},
            )
    ...
    def apply_risk_of_premature_rupture_of_membranes_and_chorioamnionitis(self, gestation_of_interest):
        ...
        prom = pd.Series(
            self.rng.random_sample(len(at_risk.loc[at_risk])) < params["prob_prom_per_month"],
            index=at_risk.loc[at_risk].index,
        )
        ...
        for person in prom.loc[prom].index:
            logger.info(key="maternal_complication", data={"person": person, "type": "PROM", "timing": "antenatal"})

        # Determine if those with PROM will develop infection prior to care seeking
        infection = pd.Series(
            self.rng.random_sample(len(prom.loc[prom])) < params["prob_chorioamnionitis"], index=prom.loc[prom].index
        )
        ...
        for person in infection.loc[infection].index:
            ...
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "clinical_chorioamnionitis", "timing": "antenatal"},
            )
    ...
    def apply_risk_of_preterm_labour(self, gestation_of_interest):
        ...
        for person in preterm_labour.loc[preterm_labour].index:
            ...
            logger.debug(key="message", data=f"Mother {person} will go into preterm labour on " f"{new_due_date}")

            # And the labour onset event is scheduled for the new due date
            self.sim.schedule_event(labour.LabourOnsetEvent(self.sim.modules["Labour"], person), new_due_date)
    ...
    def induction_care_seeking_and_still_birth_risk(self, gestation_of_interest):
        ...
        care_seekers = pd.Series(
            self.rng.random_sample(len(post_term_women.loc[post_term_women])) < params["prob_seek_care_induction"],
        ...
        for person in care_seekers.loc[care_seekers].index:
            ...
            self.sim.modules["HealthSystem"].schedule_hsi_event(
                induction, priority=0, topen=self.sim.date, tclose=self.sim.date + DateOffset(days=1)
            )
    ...
    def care_seeking_pregnancy_loss_complications(self, individual_id, cause):
        ...
        if care_seeking:
            ...
            event = HSI_GenericEmergencyFirstAppt(self.sim.modules["PregnancySupervisor"], person_id=individual_id)
    ...
    def schedule_first_anc_contact_for_new_pregnancy(self, gestation_of_interest):
        ...
        if params["ps_analysis_in_progress"] and params["sens_analysis_max"]:
            ...
            late_initiation_anc4 = pd.Series(
                self.rng.random_sample(len(early_initiation_anc4.loc[~early_initiation_anc4]))
                < params["prob_late_initiation_anc4"],
            ...
            early_initiation_anc_below_4 = pd.Series(
                self.rng.random_sample(len(anc_below_4.loc[anc_below_4])) < params["prob_early_initiation_anc_below4"],
            ...
            for s in [
                early_initiation_anc4.loc[early_initiation_anc4],
            ...
            for s in [
                late_initiation_anc4.loc[late_initiation_anc4],
                early_initiation_anc_below_4.loc[~early_initiation_anc_below_4],
            ]:
...
class PregnancySupervisorEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        ectopic_risk = pd.Series(
            self.module.rng.random_sample(len(new_pregnancy.loc[new_pregnancy])) < params["prob_ectopic_pregnancy"],
            index=new_pregnancy.loc[new_pregnancy].index,
        )
        ...
        for person in ectopic_risk.loc[ectopic_risk].index:
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "ectopic_unruptured", "timing": "antenatal"},
            )
        ...
        multiples = pd.Series(
            self.module.rng.random_sample(len(multiple_risk.loc[multiple_risk])) < params["prob_multiples"],
            index=multiple_risk.loc[multiple_risk].index,
        )
        ...
        for person in multiples.loc[multiples].index:
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "multiple_pregnancy", "timing": "antenatal"},
            )
        ...
        for person in placenta_praevia.loc[placenta_praevia].index:
            logger.info(
                key="maternal_complication", data={"person": person, "type": "placenta_praevia", "timing": "antenatal"}
            )
        ...
        syphilis_risk = pd.Series(
            self.module.rng.random_sample(len(at_risk_women.loc[at_risk_women]))
        ...
        for person in syphilis_risk.loc[syphilis_risk].index:
            ...
            self.sim.schedule_event(
                SyphilisInPregnancyEvent(self.module, person), (self.sim.date + pd.Timedelta(days=onset_day))
            )
        ...
        if not params["ps_analysis_in_progress"] or (
            params["ps_analysis_in_progress"] and not params["sens_analysis_min"]
        ):
        ...
        care_seeking = pd.Series(
            self.module.rng.random_sample(len(potential_care_seekers.loc[potential_care_seekers]))
        ...
        for person in care_seeking.loc[care_seeking].index:
            if not df.at[person, "hs_is_inpatient"]:
                ...
                self.sim.modules["HealthSystem"].schedule_hsi_event(
                    inpatient_pregnancy_hsi, priority=0, topen=self.sim.date, tclose=self.sim.date + DateOffset(days=1)
                )
            else:
...
class EctopicPregnancyEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if (
            ...
            or not df.at[individual_id, "is_pregnant"]
            or (df.at[individual_id, "ps_ectopic_pregnancy"] != "not_ruptured")
            or (df.at[individual_id, "ps_gestational_age_in_weeks"] >= 9)
        ):
            return
        ...
        self.sim.modules["Contraception"].end_pregnancy(individual_id)
        pregnancy_helper_functions.store_dalys_in_mni(
            individual_id, self.module.mother_and_newborn_info, "ectopic_onset", self.sim.date
        )
        ...
        care_seeking_result = self.module.care_seeking_pregnancy_loss_complications(
            individual_id, cause="ectopic_pre_rupture"
        )
...
class EctopicPregnancyRuptureEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        logger.info(
            key="maternal_complication",
            data={"person": individual_id, "type": "ectopic_ruptured", "timing": "antenatal"},
        )

        # Set the variable
        df.at[individual_id, "ps_ectopic_pregnancy"] = "ruptured"
        pregnancy_helper_functions.store_dalys_in_mni(
            individual_id, self.module.mother_and_newborn_info, "ectopic_rupture_onset", self.sim.date
        )
...
class GestationalDiabetesGlycaemicControlEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if (
            ...
            or (mother.ps_gestational_age_in_weeks < 20)
            or ((mother.ps_gest_diab == "none") and (mother.ac_gest_diab_on_treatment == "none"))
        ):
            return
...
class SyphilisInPregnancyEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if (
            not df.at[individual_id, "is_alive"]
            or not df.at[individual_id, "is_pregnant"]
            or (individual_id not in mni)
            or (not (mni[individual_id]["pred_syph_infect"] == self.sim.date))
        ):
            return

        df.at[individual_id, "ps_syphilis"] = True
        logger.info(
            key="maternal_complication", data={"person": individual_id, "type": "syphilis", "timing": "antenatal"}
        )
...
class ParameterUpdateEvent(Event, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        ps_models_to_be_scaled = [
            [mod_ps["placenta_praevia"], "prob_placenta_praevia"],
        ...
        la_models_to_be_scaled = [
            [mod_la["uterine_rupture_ip"], "prob_uterine_rupture"],
...
class PregnancyAnalysisEvent(Event, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        if (
            params["alternative_anc_coverage"]
            or params["alternative_anc_quality"]
            or params["alternative_ip_anc_quality"]
            or params["sens_analysis_max"]
            or params["sens_analysis_min"]
        ):
            ...
            if params["alternative_anc_quality"] or params["sens_analysis_max"]:
                ...
                for parameter in [
                    ...
                    self.sim.modules["CareOfWomenDuringPregnancy"].current_parameters[parameter] = params[
                        "anc_availability_probability"
                    ]

            if params["alternative_ip_anc_quality"]:
                self.sim.modules["CareOfWomenDuringPregnancy"].current_parameters[
                    "squeeze_factor_threshold_an"
                ] = 10_000
...
class PregnancyLoggingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        women_reproductive_age = len(
            df.index[(df.is_alive & (df.sex == "F") & (df.age_years > 14) & (df.age_years < 50))]
        )
        pregnant_at_year_end = len(df.index[df.is_alive & df.is_pregnant])
        women_with_previous_sa = len(
            df.index[
                (df.is_alive & (df.sex == "F") & (df.age_years > 14) & (df.age_years < 50) & df.ps_prev_spont_abortion)
            ]
        )
        women_with_previous_pe = len(
            df.index[
                (df.is_alive & (df.sex == "F") & (df.age_years > 14) & (df.age_years < 50) & df.ps_prev_pre_eclamp)
            ]
        )
        women_with_hysterectomy = len(
            df.index[
                (df.is_alive & (df.sex == "F") & (df.age_years > 14) & (df.age_years < 50) & df.la_has_had_hysterectomy)
            ]
        )
        ...
        logger.info(
            key="preg_info",
            data={
                "women_repro_age": women_reproductive_age,
