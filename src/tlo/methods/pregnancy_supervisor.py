...
class PregnancySupervisor(Module):
    ...
    CAUSES_OF_DEATH = {
        ...
        "spontaneous_abortion": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "induced_abortion": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "antepartum_haemorrhage": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
        "severe_gestational_hypertension": Cause(
            gbd_causes="Maternal disorders", label="Maternal Disorders"
        ),
    ...
    PARAMETERS = {
        ...
        "rr_placenta_praevia_previous_cs": Parameter(
            Types.LIST,
            "relative risk of placenta praevia in a woman who has previously delivered via caesarean "
            "section",
        ),
        # SYPHILIS
        ...
        "rr_spont_abortion_prev_sa": Parameter(
            Types.LIST,
            "relative risk of spontaneous abortion in women who have previously experiences spontaneous "
            "abortion",
        ),
        "prob_complicated_sa": Parameter(
            Types.LIST,
            "probability that a woman who experiences spontaneous abortion with experience any "
            "complications",
        ),
        ...
        "prob_complicated_ia": Parameter(
            Types.LIST,
            "probability that a woman who experiences induced abortion with experience any "
            "complications",
        ),
        ...
        "aor_early_anc4_middle_wealth": Parameter(
            Types.LIST,
            "adjusted odds ratio of EANC4+ in women in the middle wealth quintile",
        ),
        "aor_early_anc4_richer_wealth": Parameter(
            Types.LIST,
            "adjusted odds ratio of EANC4+ in women in the richer wealth quintile",
        ),
        ...
        "aor_early_anc4_previously_married": Parameter(
            Types.LIST,
            "adjusted odds ratio of EANC4+ in women who were previously married (divorced/widowed)",
        ),
        ...
        "prob_glycaemic_control_diet_exercise": Parameter(
            Types.LIST,
            "probability a womans GDM is controlled by diet and exercise during the first month of "
            "treatment",
        ),
        "prob_glycaemic_control_orals": Parameter(
            Types.LIST,
            "probability a womans GDM is controlled by oral anti-diabetics during the first month of "
            "treatment",
        ),
        ...
        "ps_analysis_in_progress": Parameter(
            Types.BOOL,
            "Used within the pregnancy_helper_function to signify that analysis is currently being "
            "conducted",
        ),
    ...
    PROPERTIES = {
        ...
        "ps_abortion_complications": Property(
            Types.INT, "Bitset column holding types of abortion complication"
        ),
        ...
        "ps_antepartum_haemorrhage": Property(
            Types.CATEGORICAL,
            "severity of this woman antepartum haemorrhage",
    ...
    def read_parameters(self, data_folder):
        ...
        parameter_dataframe = pd.read_excel(
            Path(self.resourcefilepath) / "ResourceFile_PregnancySupervisor.xlsx",
        ...
        if "HealthBurden" in self.sim.modules.keys():
            self.parameters["ps_daly_weights"] = {
                ...
                "ectopic_rupture": self.sim.modules["HealthBurden"].get_daly_weight(
                    338
                ),
                ...
                "mild_anaemia_pp": self.sim.modules["HealthBurden"].get_daly_weight(
                    476
                ),
                "moderate_anaemia": self.sim.modules["HealthBurden"].get_daly_weight(
                    480
                ),
                "moderate_anaemia_pp": self.sim.modules["HealthBurden"].get_daly_weight(
                    478
                ),
                "severe_anaemia": self.sim.modules["HealthBurden"].get_daly_weight(478),
                "severe_anaemia_pp": self.sim.modules["HealthBurden"].get_daly_weight(
                    478
                ),
                ...
                "obstructed_labour": self.sim.modules["HealthBurden"].get_daly_weight(
                    348
                ),
                "uterine_rupture": self.sim.modules["HealthBurden"].get_daly_weight(
                    338
                ),
                ...
                "vesicovaginal_fistula": self.sim.modules[
                    "HealthBurden"
                ].get_daly_weight(349),
                "rectovaginal_fistula": self.sim.modules[
                    "HealthBurden"
                ].get_daly_weight(350),
            }
    ...
    def initialise_population(self, population):
        ...
        df.loc[
            previous_miscarriage.loc[previous_miscarriage].index,
    ...
    def initialise_simulation(self, sim):
        ...
        sim.schedule_event(
            PregnancySupervisorEvent(self), sim.date + DateOffset(days=0)
        )
        ...
        sim.schedule_event(
            PregnancyAnalysisEvent(self), Date(params["analysis_year"], 1, 1)
        )
        ...
        self.ps_linear_models = {
            ...
            # gestation
            "spontaneous_abortion": LinearModel.custom(
                pregnancy_supervisor_lm.spontaneous_abortion, parameters=params
            ),
            ...
            "maternal_anaemia": LinearModel.custom(
                pregnancy_supervisor_lm.maternal_anaemia, module=self
            ),
            ...
            "early_onset_labour": LinearModel.custom(
                pregnancy_supervisor_lm.preterm_labour, module=self
            ),
            ...
            "placenta_praevia": LinearModel.custom(
                pregnancy_supervisor_lm.placenta_praevia, parameters=params
            ),
            ...
            "placental_abruption": LinearModel.custom(
                pregnancy_supervisor_lm.placental_abruption, parameters=params
            ),
            ...
            "antepartum_haem": LinearModel.custom(
                pregnancy_supervisor_lm.antepartum_haem, parameters=params
            ),
            # This equation determines the monthly probability of a woman developing gestational diabetes
            "gest_diab": LinearModel.custom(
                pregnancy_supervisor_lm.gest_diab, parameters=params
            ),
            # This equation determines the monthly probability of a woman developing gestational hypertension
            "gest_htn": LinearModel.custom(
                pregnancy_supervisor_lm.gest_htn, parameters=params
            ),
            # This equation determines the monthly probability of a woman developing mild pre-eclampsia
            "pre_eclampsia": LinearModel.custom(
                pregnancy_supervisor_lm.pre_eclampsia, module=self
            ),
            ...
            "antenatal_stillbirth": LinearModel.custom(
                pregnancy_supervisor_lm.antenatal_stillbirth, module=self
            ),
        }
            ...
            if df.at[mother_id, "ps_gest_diab"] != "none":
                ...
                if not pd.isnull(mni[mother_id]["gest_diab_onset"]):
                    pregnancy_helper_functions.store_dalys_in_mni(
                        mother_id, mni, "gest_diab_resolution", self.sim.date
                    )
    ...
    def report_daly_values(self):
        ...
        logger.debug(
            key="message", data="This is PregnancySupervisor reporting my health values"
        )
        monthly_daly = dict()
        ...
        def acute_daly_calculation(person, complication):
            ...
            if (
                ...
                <= mni[person][f"{complication}_onset"]
                <= self.sim.date
            ):
                ...
                if mni[person][f"{complication}_onset"] != self.sim.date:
                    if monthly_daly[person] == 0:
                        logger.info(
                            key="error",
                            data=f"Daly wt not correctly assigned for person {person}",
                        )
        ...
        def chronic_daly_calculations(person, complication):
            ...
            if pd.isnull(mni[person][f"{complication}_resolution"]):
                if mni[person][f"{complication}_onset"] < (
                    self.sim.date - DateOffset(months=1)
                ):
                ...
                # days she has experience the complication
                    ...
                    days_since_onset = pd.Timedelta(
                        (self.sim.date - mni[person][f"{complication}_onset"]), unit="d"
                    )
                    daly_weight = days_since_onset.days * (
                        p[f"{complication}"] / DAYS_IN_YEAR
                    )
                ...
                if (
                    mni[person][f"{complication}_resolution"]
                    < mni[person][f"{complication}_onset"]
                ):
                    ...
                    if (
                        mni[person][f"{complication}_resolution"]
                        == (self.sim.date - DateOffset(months=1))
                    ) and (mni[person][f"{complication}_onset"] == self.sim.date):
                        return
                    ...
                    if (
                        not mni[person][f"{complication}_resolution"]
                        >= mni[person][f"{complication}_onset"]
                    ):
                        logger.info(
                            key="error",
                            data=f"Complication resolution has occurred before onset in"
                            f" {person}",
                        )
                        return
                    ...
                    days_free_of_comp_this_month = pd.Timedelta(
                        (self.sim.date - mni[person][f"{complication}_" f"resolution"]),
                        unit="d",
                    )
                    mid_way_calc = (
                        self.sim.date - DateOffset(months=1)
                    ) + days_free_of_comp_this_month
                    days_with_comp_this_month = pd.Timedelta(
                        (self.sim.date - mid_way_calc), unit="d"
                    )
                    daly_weight = days_with_comp_this_month.days * (
                        p[f"{complication}"] / DAYS_IN_YEAR
                    )
                    monthly_daly[person] += daly_weight
    ...
    def apply_linear_model(self, lm, df_slice):
        ...
        return self.rng.random_sample(len(df_slice)) < lm.predict(
            df_slice, year=self.sim.date.year
        )
    ...
    def schedule_anc_one(self, individual_id, anc_month):
        ...
        if anc_month == 2:
            ...
            weeks_of_visit = (
                self.rng.randint(
                    months_min_max[anc_month][0], months_min_max[anc_month][1]
                )
                - 8
            )
    ...
    def apply_risk_of_induced_abortion(self, gestation_of_interest):
        ...
        abortion = pd.Series(
            self.rng.random_sample(len(at_risk.loc[at_risk]))
    ...
    def apply_risk_of_abortion_complications(self, individual_id, cause):
        ...
        if self.rng.random_sample() < params["prob_haemorrhage_post_abortion"]:
            ...
            pregnancy_helper_functions.store_dalys_in_mni(
                individual_id, mni, "abortion_haem_onset", self.sim.date
            )
            logger.info(
                key="maternal_complication",
                data={
        ...
        if self.rng.random_sample() < params["prob_sepsis_post_abortion"]:
            ...
            pregnancy_helper_functions.store_dalys_in_mni(
                individual_id, mni, "abortion_sep_onset", self.sim.date
            )
            logger.info(
                key="maternal_complication",
                data={
        ...
        if not self.abortion_complications.has_any(
            [individual_id], "sepsis", "haemorrhage", "injury", first=True
        ):
        ...
        pregnancy_helper_functions.store_dalys_in_mni(
            individual_id, mni, "abortion_onset", self.sim.date
        )
    ...
    def apply_risk_of_anaemia(self, gestation_of_interest):
        ...
        df.loc[anaemia.loc[anaemia].index, "ps_anaemia_in_pregnancy"] = (
        ...
        for person in anaemia.loc[anaemia].index:
            ...
            pregnancy_helper_functions.store_dalys_in_mni(
                person,
                mni,
                f'{df.at[person, "ps_anaemia_in_pregnancy"]}_anaemia_onset',
                self.sim.date,
            )
    ...
    def apply_risk_of_gestational_diabetes(self, gestation_of_interest):
        ...
        for person in gest_diab.loc[gest_diab].index:
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "gest_diab", "timing": "antenatal"},
            )
    ...
    def apply_risk_of_hypertensive_disorders(self, gestation_of_interest):
        ...
        df.loc[pre_eclampsia.loc[pre_eclampsia].index, "ps_htn_disorders"] = (
            "mild_pre_eclamp"
        )
        ...
        df.loc[gest_hypertension.loc[gest_hypertension].index, "ps_htn_disorders"] = (
            "gest_htn"
        )
        ...
        for person in gest_hypertension.loc[gest_hypertension].index:
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "mild_gest_htn", "timing": "antenatal"},
            )
    ...
    def apply_risk_of_progression_of_hypertension(self, gestation_of_interest):
        ...
        def apply_risk(selected, risk_of_gest_htn_progression):
            ...
            risk_ghtn_remains_mild = 1.0 - (
                risk_of_gest_htn_progression + params["probs_for_mgh_matrix"][2]
            )

            # We reset the parameter here to allow for testing with the original parameter
            params["probs_for_mgh_matrix"] = [
            ...
            def log_new_progressed_cases(disease):
                ...
                assess_status_change = (current_status != disease) & (
                    new_status == disease
                )
        ...
        women_not_on_anti_htns = (
            ...
            & (df.ps_gestational_age_in_weeks == gestation_of_interest)
            & (
                df.ps_htn_disorders.str.contains(
                    "gest_htn|mild_pre_eclamp|severe_gest_htn|severe_pre_eclamp"
                )
            )
        ...
        for v in women_not_on_anti_htns.loc[women_not_on_anti_htns].index:
            if v in women_on_anti_htns.loc[women_on_anti_htns].index:
                logger.info(
                    key="error",
                    data="Risk of progression of HTN disorder is being applied to some women "
                    "twice",
                )
        ...
        apply_risk(
            women_on_anti_htns,
            (
                risk_progression_mild_to_severe_htn
    ...
    def apply_risk_of_placental_abruption(self, gestation_of_interest):
        ...
        df.loc[
            placenta_abruption.loc[placenta_abruption].index, "ps_placental_abruption"
        ] = True
    ...
    def apply_risk_of_antepartum_haemorrhage(self, gestation_of_interest):
        ...
        df.loc[
            antepartum_haemorrhage.loc[antepartum_haemorrhage].index,
    ...
    def apply_risk_of_premature_rupture_of_membranes_and_chorioamnionitis(
        self, gestation_of_interest
    ):
        """
        ...
        for person in prom.loc[prom].index:
            logger.info(
                key="maternal_complication",
                data={"person": person, "type": "PROM", "timing": "antenatal"},
            )

        # Determine if those with PROM will develop infection prior to care seeking
        infection = pd.Series(
            self.rng.random_sample(len(prom.loc[prom]))
    ...
    def apply_risk_of_preterm_labour(self, gestation_of_interest):
        ...
        for person in preterm_labour.loc[preterm_labour].index:
            ...
            self.sim.modules["Labour"].reset_due_date(
                id_or_index=person, new_due_date=new_due_date
            )

            logger.debug(
                key="message",
                data=f"Mother {person} will go into preterm labour on "
                f"{new_due_date}",
            )
    ...
    def update_variables_post_still_birth_for_data_frame(self, women):
        ...
        self.sim.modules["Labour"].reset_due_date(
            id_or_index=women.index, new_due_date=pd.NaT
        )
    ...
    def apply_risk_of_still_birth(self, gestation_of_interest):
        ...
        self.update_variables_post_still_birth_for_data_frame(
            still_birth.loc[still_birth]
        )
    ...
    def induction_care_seeking_and_still_birth_risk(self, gestation_of_interest):
        ...
        care_seekers = pd.Series(
            self.rng.random_sample(len(post_term_women.loc[post_term_women]))
        ...
        still_birth_risk = self.ps_linear_models["antenatal_stillbirth"].predict(
            non_care_seekers
        )
    ...
    def care_seeking_pregnancy_loss_complications(self, individual_id, cause):
        ...
        if cause == "ectopic_pre_rupture":
            care_seeking = (
                self.rng.random_sample()
                < params["prob_care_seeking_ectopic_pre_rupture"]
            )
        else:
            care_seeking = (
                self.rng.random_sample() < params["prob_seek_care_pregnancy_loss"]
            )
        ...
        if care_seeking:
            ...
            event = HSI_GenericEmergencyFirstAppt(
                self.sim.modules["PregnancySupervisor"], person_id=individual_id
            )
    ...
    def apply_risk_of_death_from_monthly_complications(self, individual_id):
        ...
        # If not we reset variables and the woman survives
            ...
            if (mother.ps_htn_disorders == "severe_pre_eclamp") and mni[individual_id][
                "new_onset_spe"
            ]:
    ...
    def schedule_first_anc_contact_for_new_pregnancy(self, gestation_of_interest):
        ...
        late_initiation_anc4 = pd.Series(
            self.rng.random_sample(
                len(early_initiation_anc4.loc[~early_initiation_anc4])
            )
        ...
        for v in late_initiation_anc4.loc[late_initiation_anc4].index:
            if v in early_initiation_anc4.loc[early_initiation_anc4].index:
                logger.info(
                    key="error",
                    data="Probability of ANC4 is being applied to some women twice",
                )
        ...
        early_initiation_anc_below_4 = pd.Series(
            self.rng.random_sample(len(anc_below_4.loc[anc_below_4]))
        ...
        def schedule_early_visit(df_slice):
            for person in df_slice.index:
                random_draw_gest_at_anc = self.rng.choice(
                    [2, 3, 4], p=params["prob_anc1_months_2_to_4"]
                )
                self.schedule_anc_one(
                    individual_id=person, anc_month=random_draw_gest_at_anc
                )
        ...
        def schedule_late_visit(df_slice):
            for person in df_slice.index:
                random_draw_gest_at_anc = self.rng.choice(
                    [5, 6, 7, 8, 9, 10], p=params["prob_anc1_months_5_to_9"]
                )
...
class PregnancySupervisorEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        foetal_age_in_days = (
            self.sim.date - df.loc[alive_and_preg, "date_of_last_pregnancy"]
        )
        ...
        if not (df.loc[alive_and_preg, "ps_gestational_age_in_weeks"] > 1).all().all():
            logger.info(
                key="error",
                data="Gestational age was incorrectly calculated for some women",
            )
        ...
        newly_pregnant = df.loc[
            alive_and_preg & (df["ps_gestational_age_in_weeks"] == 3)
        ]
        for person in newly_pregnant.index:
            pregnancy_helper_functions.update_mni_dictionary(
                self.module, individual_id=person
            )
        ...
        new_pregnancy = (
            df.is_alive & df.is_pregnant & (df.ps_gestational_age_in_weeks == 3)
        )
        ectopic_risk = pd.Series(
            self.module.rng.random_sample(len(new_pregnancy.loc[new_pregnancy]))
        ...
        df.loc[ectopic_risk.loc[ectopic_risk].index, "ps_ectopic_pregnancy"] = (
            "not_ruptured"
        )
        ...
        for person in ectopic_risk.loc[ectopic_risk].index:
            ...
            self.sim.schedule_event(
                ...
                (
                    self.sim.date
                    + pd.Timedelta(days=7 * 3 + self.module.rng.randint(0, 7 * 2))
                ),
            )
        ...
        multiples = pd.Series(
            self.module.rng.random_sample(len(multiple_risk.loc[multiple_risk]))
        ...
        df.loc[placenta_praevia.loc[placenta_praevia].index, "ps_placenta_praevia"] = (
            True
        )
        ...
        for person in syphilis_risk.loc[syphilis_risk].index:
            ...
            mni[person]["pred_syph_infect"] = self.sim.date + pd.Timedelta(
                days=onset_day
            )
            self.sim.schedule_event(
        ...
        for gestation_of_interest in [4, 8, 13, 17, 22]:
            self.module.apply_risk_of_spontaneous_abortion(
        ...
        for gestation_of_interest in [22, 27, 31, 35, 40]:
            self.module.apply_risk_of_hypertensive_disorders(
                gestation_of_interest=gestation_of_interest
            )
            self.module.apply_risk_of_gestational_diabetes(
                gestation_of_interest=gestation_of_interest
            )
            self.module.apply_risk_of_placental_abruption(
                gestation_of_interest=gestation_of_interest
            )
            self.module.apply_risk_of_antepartum_haemorrhage(
                gestation_of_interest=gestation_of_interest
            )
        ...
        for gestation_of_interest in [27, 31, 35, 40]:
            ...
            self.module.apply_risk_of_progression_of_hypertension(
                gestation_of_interest=gestation_of_interest
            )
            # And of death...
            self.module.apply_risk_of_death_from_hypertension(
                gestation_of_interest=gestation_of_interest
            )

        # From month 5-8 we apply risk of a woman going into early labour
        for gestation_of_interest in [22, 27, 31, 35]:
            self.module.apply_risk_of_preterm_labour(
                gestation_of_interest=gestation_of_interest
            )
        ...
        care_seeking = pd.Series(
            self.module.rng.random_sample(
                len(potential_care_seekers.loc[potential_care_seekers])
            )
        ...
        for gestation_of_interest in [27, 31, 35, 40]:
            self.module.apply_risk_of_still_birth(
                gestation_of_interest=gestation_of_interest
            )
        ...
        for gestation_of_interest in [41, 42, 43, 44, 45]:
            self.module.induction_care_seeking_and_still_birth_risk(
                gestation_of_interest=gestation_of_interest
            )
...
class EctopicPregnancyEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        pregnancy_helper_functions.store_dalys_in_mni(
            individual_id,
            self.module.mother_and_newborn_info,
            "ectopic_onset",
            self.sim.date,
        )
        ...
        if not care_seeking_result:
            ...
            self.sim.schedule_event(
                ...
                (
                    self.sim.date
                    + pd.Timedelta(days=7 * 2 + self.module.rng.randint(0, 7 * 2))
                ),
            )
...
class EctopicPregnancyRuptureEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if not df.at[individual_id, "is_alive"] or (
            df.at[individual_id, "ps_ectopic_pregnancy"] != "not_ruptured"
        ):
            return
        ...
        pregnancy_helper_functions.store_dalys_in_mni(
            individual_id,
            self.module.mother_and_newborn_info,
            "ectopic_rupture_onset",
            self.sim.date,
        )

        # We see if this woman will now seek care following rupture
        self.module.care_seeking_pregnancy_loss_complications(
            individual_id, cause="ectopic_ruptured"
        )
        ...
        self.sim.schedule_event(
            EarlyPregnancyLossDeathEvent(
                self.module, individual_id, cause="ectopic_pregnancy"
            ),
    ...
    def apply(self, individual_id):
        ...
        if self.module.rng.random_sample() < risk_of_death:
            ...
            if self.cause == "ectopic_pregnancy":
                ...
                self.module.abortion_complications.unset(
                    individual_id, "sepsis", "haemorrhage", "injury"
                )
...
class GestationalDiabetesGlycaemicControlEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        if (
            self.module.rng.random_sample()
            > params[f"prob_glycaemic_control_{mother.ac_gest_diab_on_treatment }"]
        ):
...
class SyphilisInPregnancyEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual_id):
        ...
        logger.info(
            key="maternal_complication",
            data={"person": individual_id, "type": "syphilis", "timing": "antenatal"},
        )
...
class ParameterUpdateEvent(Event, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        logger.debug(
            key="message",
            data="Now updating parameters in the maternal and perinatal health modules...",
        )
        ...
        la_models_to_be_scaled = [
            ...
            [
                mod_la["probability_delivery_health_centre"],
            ...
            if params["alternative_anc_quality"]:
                ...
                if "Malaria" in self.sim.modules:
                    iptp = self.sim.modules[
                        "Malaria"
                    ].item_codes_for_consumables_required["malaria_iptp"]
                    self.sim.modules[
                        "HealthSystem"
                    ].override_availability_of_consumables(
                ...
                for parameter in [
                    ...
                    "prob_intervention_delivered_ifa",
                    "prob_intervention_delivered_llitn",
                    "prob_intervention_delivered_llitn",
                    "prob_intervention_delivered_tt",
                    "prob_intervention_delivered_poct",
                    "prob_intervention_delivered_syph_test",
                    "prob_intervention_delivered_iptp",
...
class PregnancyLoggingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        yearly_prev_hysterectomy = (
            women_with_hysterectomy / women_reproductive_age
        ) * 100
