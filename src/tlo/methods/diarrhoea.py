...
class Diarrhoea(Module, GenericFirstAppointmentsMixin):
    ...
    CAUSES_OF_DEATH = {
        f"Diarrhoea_{path}": Cause(gbd_causes="Diarrheal diseases", label="Childhood Diarrhoea") for path in pathogens
    }

    # Declare Causes of Death and Disability
    CAUSES_OF_DISABILITY = {
        "Diarrhoea": Cause(gbd_causes="Diarrheal diseases", label="Childhood Diarrhoea") for path in pathogens
    }

    PARAMETERS = {
        # Parameters governing the incidence of infection with a pathogen that causes diarrhoea
        "base_inc_rate_diarrhoea_by_rotavirus": Parameter(
            Types.LIST,
            "incidence rate (per person-year)"
            " of diarrhoea caused by rotavirus in age groups 0-11, 12-23, 24-59 months ",
        ),
        "base_inc_rate_diarrhoea_by_shigella": Parameter(
            Types.LIST,
            "incidence rate (per person-year) "
            "of diarrhoea caused by shigella spp in age groups 0-11, 12-23, 24-59 months",
        ),
        "base_inc_rate_diarrhoea_by_adenovirus": Parameter(
            Types.LIST,
            "incidence rate (per person-year) "
            "of diarrhoea caused by adenovirus 40/41 in age groups 0-11, 12-23, 24-59 months",
        ),
        "base_inc_rate_diarrhoea_by_cryptosporidium": Parameter(
            Types.LIST,
            "incidence rate (per person-year) "
            "of diarrhoea caused by cryptosporidium in age groups 0-11, 12-23, 24-59 months",
        ),
        "base_inc_rate_diarrhoea_by_campylobacter": Parameter(
            Types.LIST,
            "incidence rate (per person-year) "
            "of diarrhoea caused by campylobacter spp in age groups 0-11, 12-23, 24-59 months",
        ),
        "base_inc_rate_diarrhoea_by_ETEC": Parameter(
            Types.LIST,
            "incidence rate (per person-year) " "of diarrhoea caused by ETEC in age groups 0-11, 12-23, 24-59 months",
        ),
        "base_inc_rate_diarrhoea_by_sapovirus": Parameter(
            Types.LIST,
            "incidence rate (per person-year) "
            "of diarrhoea caused by sapovirus in age groups 0-11, 12-23, 24-59 months",
        ),
        "base_inc_rate_diarrhoea_by_norovirus": Parameter(
            Types.LIST,
            "incidence rate (per person-year) "
            "of diarrhoea caused by norovirus in age groups 0-11, 12-23, 24-59 months",
        ),
        "base_inc_rate_diarrhoea_by_astrovirus": Parameter(
            Types.LIST,
            "incidence rate (per person-year) "
            "of diarrhoea caused by astrovirus in age groups 0-11, 12-23, 24-59 months",
        ),
        "base_inc_rate_diarrhoea_by_tEPEC": Parameter(
            Types.LIST,
            "incidence rate (per person-year) " "of diarrhoea caused by tEPEC in age groups 0-11, 12-23, 24-59 months",
        ),
        "rr_diarrhoea_HHhandwashing": Parameter(
            Types.REAL, "relative rate of diarrhoea with household handwashing with soap"
        ),
        "rr_diarrhoea_improved_sanitation": Parameter(Types.REAL, "relative rate of diarrhoea for improved sanitation"),
        "rr_diarrhoea_clean_water": Parameter(
            Types.REAL, "relative rate of diarrhoea for access to clean drinking water"
        ),
        "rr_diarrhoea_exclusive_vs_partial_breastfeeding_<6mo": Parameter(
            Types.REAL,
            "relative rate of diarrhoea for partial breastfeeding in <6 months old, "
            "compared to exclusive breastfeeding",
        ),
        "rr_diarrhoea_exclusive_vs_no_breastfeeding_<6mo": Parameter(
            Types.REAL,
            "relative rate of diarrhoea for no breastfeeding in <6 months old, " "compared to exclusive breastfeeding",
        ),
        "rr_diarrhoea_any_vs_no_breastfeeding_6_11mo": Parameter(
            Types.REAL,
            "relative rate of diarrhoea for no breastfeeding in 6 months old to 1 years old, "
            "compared to any breastfeeding at this age group",
        ),
        "rr_diarrhoea_untreated_HIV": Parameter(Types.REAL, "relative rate of diarrhoea for HIV positive status"),
        "rr_diarrhoea_SAM": Parameter(Types.REAL, "relative rate of diarrhoea for severe malnutrition"),
        # Parameters governing the type of diarrhoea (Watery [AWD: Acute Watery Diarrhoea ]or bloody)
        "proportion_AWD_in_rotavirus": Parameter(
            Types.REAL, "acute diarrhoea type caused in rotavirus-attributed diarrhoea"
        ),
        "proportion_AWD_in_shigella": Parameter(
            Types.REAL, "acute diarrhoea type caused in shigella-attributed diarrhoea"
        ),
        "proportion_AWD_in_adenovirus": Parameter(
            Types.REAL, "acute diarrhoea type caused in adenovirus-attributed diarrhoea"
        ),
        "proportion_AWD_in_cryptosporidium": Parameter(
            Types.REAL, "acute diarrhoea type caused in cryptosporidium-attributed diarrhoea"
        ),
        "proportion_AWD_in_campylobacter": Parameter(
            Types.REAL, "acute diarrhoea type caused in campylobacter-attributed diarrhoea"
        ),
        "proportion_AWD_in_ETEC": Parameter(Types.REAL, "acute diarrhoea type caused in ETEC-attributed diarrhoea"),
        "proportion_AWD_in_sapovirus": Parameter(
            Types.REAL, "acute diarrhoea type caused in sapovirus-attributed diarrhoea"
        ),
        "proportion_AWD_in_norovirus": Parameter(
            Types.REAL, "acute diarrhoea type caused in norovirus-attributed diarrhoea"
        ),
        "proportion_AWD_in_astrovirus": Parameter(
            Types.REAL, "acute diarrhoea type caused in astrovirus-attributed diarrhoea"
        ),
        "proportion_AWD_in_tEPEC": Parameter(Types.REAL, "acute diarrhoea type in tEPEC-attributed diarrhoea"),
        # Parameters governing the extent of dehydration
        "prob_dehydration_by_rotavirus": Parameter(Types.REAL, "probability of any dehydration caused by rotavirus"),
        "prob_dehydration_by_shigella": Parameter(Types.REAL, "probability of any dehydration caused by shigella"),
        "prob_dehydration_by_adenovirus": Parameter(Types.REAL, "probability of any dehydration caused by adenovirus"),
        "prob_dehydration_by_cryptosporidium": Parameter(
            Types.REAL, "probability of any dehydration caused by cryptosporidium"
        ),
        "prob_dehydration_by_campylobacter": Parameter(
            Types.REAL, "probability of any dehydration caused by campylobacter"
        ),
        "prob_dehydration_by_ETEC": Parameter(Types.REAL, "probability of any dehydration caused by ETEC"),
        "prob_dehydration_by_sapovirus": Parameter(Types.REAL, "probability of any dehydration caused by sapovirus"),
        "prob_dehydration_by_norovirus": Parameter(Types.REAL, "probability of any dehydration caused by norovirus"),
        "prob_dehydration_by_astrovirus": Parameter(Types.REAL, "probability of any dehydration caused by astrovirus"),
        "prob_dehydration_by_tEPEC": Parameter(Types.REAL, "probability of any dehydration caused by tEPEC"),
        "probability_of_severe_dehydration_if_some_dehydration": Parameter(
            Types.REAL, "probability that someone with diarrhoea and some dehydration develops severe " "dehydration"
        ),
        # Parameters governing the duration of the episode
        "prob_prolonged_diarr_rotavirus": Parameter(
            Types.REAL, "probability of prolonged episode in rotavirus-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_shigella": Parameter(
            Types.REAL, "probability of prolonged episode by shigella-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_adenovirus": Parameter(
            Types.REAL, "probability of prolonged episode by adenovirus-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_cryptosporidium": Parameter(
            Types.REAL, "probability of prolonged episode by cryptosporidium-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_campylobacter": Parameter(
            Types.REAL, "probability of prolonged episode by campylobacter-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_ETEC": Parameter(
            Types.REAL, "probability of prolonged episode by ETEC-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_sapovirus": Parameter(
            Types.REAL, "probability of prolonged episode by sapovirus-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_norovirus": Parameter(
            Types.REAL, "probability of prolonged episode by norovirus-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_astrovirus": Parameter(
            Types.REAL, "probability of prolonged episode by norovirus-attributed diarrhoea"
        ),
        "prob_prolonged_diarr_tEPEC": Parameter(
            Types.REAL, "probability of prolonged episode by tEPEC-attributed diarrhoea"
        ),
        "prob_prolonged_to_persistent_diarr": Parameter(
            Types.REAL, "probability of prolonged diarrhoea becoming persistent diarrhoea"
        ),
        "rr_bec_persistent_age>6mo": Parameter(
            Types.REAL, "relative rate of acute diarrhoea becoming persistent diarrhoea for children over 6 months"
        ),
        "rr_bec_persistent_HIV": Parameter(
            Types.REAL, "relative rate of acute diarrhoea becoming persistent diarrhoea for HIV positive"
        ),
        "rr_bec_persistent_SAM": Parameter(
            Types.REAL, "relative rate of acute diarrhoea becoming persistent diarrhoea for severely acute malnutrition"
        ),
        "rr_bec_persistent_stunted": Parameter(
            Types.REAL, "relative rate of acute diarrhoea becoming persistent diarrhoea for stunted children"
        ),
        "min_dur_acute": Parameter(
            Types.INT, "The minimum duration (in days) for an episode that is classified as an acute episode"
        ),
        "min_dur_prolonged": Parameter(
            Types.INT, "The minimum duration (in days) for an episode that is classified as a prolonged episode"
        ),
        "min_dur_persistent": Parameter(
            Types.INT, "The minimum duration (in days) for an episode that is classified as a persistent episode"
        ),
        "max_dur_persistent": Parameter(
            Types.INT, "The maximum duration (in days) for an episode that is classified as a persistent episode"
        ),
        # Parameters governing the occurence of other symptoms during the episode (fever, vomiting)
        "prob_fever_by_rotavirus": Parameter(Types.REAL, "probability of fever caused by rotavirus"),
        "prob_fever_by_shigella": Parameter(Types.REAL, "probability of fever caused by shigella"),
        "prob_fever_by_adenovirus": Parameter(Types.REAL, "probability of fever caused by adenovirus"),
        "prob_fever_by_cryptosporidium": Parameter(Types.REAL, "probability of fever caused by cryptosporidium"),
        "prob_fever_by_campylobacter": Parameter(Types.REAL, "probability of fever caused by campylobacter"),
        "prob_fever_by_ETEC": Parameter(Types.REAL, "probability of fever caused by ETEC"),
        "prob_fever_by_sapovirus": Parameter(Types.REAL, "probability of fever caused by sapovirus"),
        "prob_fever_by_norovirus": Parameter(Types.REAL, "probability of fever caused by norovirus"),
        "prob_fever_by_astrovirus": Parameter(Types.REAL, "probability of fever caused by astrovirus"),
        "prob_fever_by_tEPEC": Parameter(Types.REAL, "probability of fever caused by tEPEC"),
        "prob_vomiting_by_rotavirus": Parameter(Types.REAL, "probability of vomiting caused by rotavirus"),
        "prob_vomiting_by_shigella": Parameter(Types.REAL, "probability of vomiting caused by shigella"),
        "prob_vomiting_by_adenovirus": Parameter(Types.REAL, "probability of vomiting caused by adenovirus"),
        "prob_vomiting_by_cryptosporidium": Parameter(Types.REAL, "probability of vomiting caused by cryptosporidium"),
        "prob_vomiting_by_campylobacter": Parameter(Types.REAL, "probability of vomiting caused by campylobacter"),
        "prob_vomiting_by_ETEC": Parameter(Types.REAL, "probability of vomiting caused by ETEC"),
        "prob_vomiting_by_sapovirus": Parameter(Types.REAL, "probability of vomiting caused by sapovirus"),
        "prob_vomiting_by_norovirus": Parameter(Types.REAL, "probability of vomiting caused by norovirus"),
        "prob_vomiting_by_astrovirus": Parameter(Types.REAL, "probability of vomiting caused by astrovirus"),
        "prob_vomiting_by_tEPEC": Parameter(Types.REAL, "probability of vomiting caused by tEPEC"),
        # Parameters governing the risk of death due to Diarrhoea
        "adjustment_factor_on_cfr": Parameter(
            Types.REAL, "Factor by which fatality probabilities are multiplied (to be used in calibration)"
        ),
        "case_fatality_rate_AWD": Parameter(Types.REAL, "case fatality rate for acute watery diarrhoea cases"),
        "rr_diarr_death_bloody": Parameter(
            Types.REAL,
            "relative risk of diarrhoea death (compared to `case_fatality_rate_AWD` if the "
            'diarrhoea is of type "bloody" (i.e. dyssentry).',
        ),
        "rr_diarr_death_age24to59mo": Parameter(
            Types.REAL, "relative risk of diarrhoea death for ages 24 to 59 months"
        ),
        "rr_diarr_death_if_duration_longer_than_13_days": Parameter(
            Types.REAL, "relative risk of diarrhoea death if the duration episode is 13 days or longer"
        ),
        "rr_diarr_death_severe_dehydration": Parameter(
            Types.REAL, "relative risk of diarrhoea death for cases with severe dehyadration"
        ),
        "rr_diarr_death_untreated_HIV": Parameter(Types.REAL, "relative risk of diarrhoea death for untreated HIV"),
        "rr_diarr_death_SAM": Parameter(Types.REAL, "relative risk of diarrhoea death for severe acute malnutrition"),
        "rr_diarr_death_alri": Parameter(
            Types.REAL, "relative risk of diarrhoea death if concurrent lower respiratory infection"
        ),
        "rr_diarr_death_cryptosporidium": Parameter(
            Types.REAL, "relative risk of diarrhoea death if caused by cryptosporidium"
        ),
        "rr_diarr_death_shigella": Parameter(Types.REAL, "relative risk of diarrhoea death if caused by shigella"),
        # Parameters governing the care provided to those that present with Diarrhoea
        "sensitivity_severe_dehydration_visual_inspection": Parameter(
            Types.REAL, "sensitivity of IMCI severe dehydration algorithm for dehydration >9% loss of body weight"
        ),
        "specificity_severe_dehydration_visual_inspection": Parameter(
            Types.REAL, "specificity of IMCI severe dehydration algorithm for dehydration >9% loss of body weight"
        ),
        "prob_hospitalization_on_danger_signs": Parameter(
            Types.REAL, "probability of hospitalisation when danger signs are detected in an initial consultation"
        ),
        # Parameters governing the efficacy of treatments
        "prob_WHOPlanC_cures_dehydration_if_severe_dehydration": Parameter(
            Types.REAL, "probability that severe dehydration is cured by Treatment Plan C"
        ),
        "prob_ORS_cures_dehydration_if_severe_dehydration": Parameter(
            Types.REAL, "probability that severe dehydration is cured by ORS"
        ),
        "prob_ORS_cures_dehydration_if_non_severe_dehydration": Parameter(
            Types.REAL, "probability that non-severe dehydration is cured by ORS"
        ),
        "prob_antibiotic_cures_dysentery": Parameter(
            Types.REAL, "probability that blood-in-stool is removed by the use of antibiotics"
        ),
        "number_of_days_reduced_duration_with_zinc": Parameter(Types.INT, "number of days reduced duration with zinc"),
        ...
        "rr_severe_dehydration_due_to_rotavirus_with_R1_under1yo": Parameter(
            Types.REAL, "relative risk of severe dehydration with rotavirus vaccine, for under 1 years old."
        ),
        "rr_severe_dehydration_due_to_rotavirus_with_R1_over1yo": Parameter(
            Types.REAL, "relative risk of severe dehydration with rotavirus vaccine, for those aged 1 year and older."
        ),
    }

    PROPERTIES = {
        # ---- Core Properties of Actual Status and Intrinsic Properties of A Current Episode  ----
        "gi_has_diarrhoea": Property(Types.BOOL, "Whether or not the person currently has an episode of diarrhoea."),
        ...
        "gi_number_of_episodes": Property(Types.INT, "Number of episodes of diarrhoea caused by a pathogen"),
    ...
    def read_parameters(self, data_folder):
        ...
        self.load_parameters_from_dataframe(
            read_csv_files(Path(self.resourcefilepath) / "ResourceFile_Diarrhoea", files="Parameter_values")
        )
        ...
        for param_name, param_type in self.PARAMETERS.items():
            ...
            assert isinstance(p[param_name], param_type.python_type), (
                f'Parameter "{param_name}" is not read in correctly from the ' f"resourcefile."
            )
    ...
    def initialise_simulation(self, sim):
        ...
        * Register test for the determination of 'danger signs'
        ...
        if self.do_checks:
            ...
            sim.schedule_event(DiarrhoeaCheckPropertiesEvent(self), sim.date + pd.Timedelta(hours=23, minutes=59))
    ...
    def look_up_consumables(self):
        ...
        self.consumables_used_in_hsi["Antibiotics_for_Dysentery"] = {
            ...
            ic("Paracetamol syrup 120mg/5ml_0.0119047619047619_CMST"): 70,
        }  # 24mg/ml so 1680/24 = 70ml per dose
    ...
    def do_treatment(self, person_id, hsi_event):
        ...
        * Records that treatment is provided.
        ...
        gets_zinc = hsi_event.get_consumables(item_codes={self.consumables_used_in_hsi["Zinc"]: dose})
        ...
        if is_in_patient:
            if hsi_event.get_consumables(item_codes=self.consumables_used_in_hsi["Treatment_Severe_Dehydration"]):
                ...
                prob_remove_dehydration = (
                    p["prob_WHOPlanC_cures_dehydration_if_severe_dehydration"]
                    if dehydration_is_severe
            ...
            if hsi_event.get_consumables(item_codes=self.consumables_used_in_hsi["ORS"]):
                ...
                prob_remove_dehydration = (
                    self.parameters["prob_ORS_cures_dehydration_if_severe_dehydration"]
                    if dehydration_is_severe
                    else self.parameters["prob_ORS_cures_dehydration_if_non_severe_dehydration"]
                )
        ...
        if will_die:
            ...
            if gets_zinc:
                ...
                self.sim.schedule_event(
                    ...
                    max(
                        self.sim.date,
                        person.gi_scheduled_date_recovery
                        - pd.DateOffset(days=p["number_of_days_reduced_duration_with_zinc"]),
                    ),
                )
    ...
    def end_episode(self, person_id, outcome):
        ...
        * Enacts the death (if the outcome=='death'); Otherwise, removes symptoms and resets properties
        ...
        logger.info(
            key="end_of_case",
            data={"person_id": person_id, "date_of_onset": person.gi_date_of_onset, "outcome": outcome},
        ...
        if outcome == "death":
            ...
            self.sim.modules["Demography"].do_death(
                individual_id=person_id, cause="Diarrhoea_" + df.at[person_id, "gi_pathogen"], originating_module=self
            )
            ...
            ] = (False, np.nan, np.nan, np.nan, False, pd.NaT, pd.NaT, pd.NaT, pd.NaT)
    ...
    def check_properties(self):
        ...
        assert pd.isnull(df.loc[not_in_current_episode, ["gi_pathogen", "gi_type", "gi_dehydration"]]).all().all()
        assert not df.loc[not_in_current_episode, "gi_duration_longer_than_13days"].any()
        assert (
            pd.isnull(
                df.loc[
                    not_in_current_episode,
                    ["gi_date_of_onset", "gi_scheduled_date_recovery", "gi_scheduled_date_death", "gi_treatment_date"],
                ]
            )
            .all()
            .all()
        ...
        has_recovery_date = ~pd.isnull(
            df.loc[in_current_episode & pd.isnull(df.gi_treatment_date), "gi_scheduled_date_recovery"]
        )
        has_death_date = ~pd.isnull(
            df.loc[in_current_episode & pd.isnull(df.gi_treatment_date), "gi_scheduled_date_death"]
        )
    ...
    def do_at_generic_first_appt(
        ...
        **kwargs,
        ...
        danger_signs = diagnosis_function("imci_severe_dehydration_visual_inspection")

        # 2) Determine which HSI to use:
        is_inpatient = (  # Danger signs and hospitalized --> In-patient
            danger_signs and self.rng.rand() < self.parameters["prob_hospitalization_on_danger_signs"]
        )
        hsi_event_class = HSI_Diarrhoea_Treatment_Inpatient if is_inpatient else HSI_Diarrhoea_Treatment_Outpatient
...
class Models:
        ...
        def make_scaled_linear_model(patho):
            ...
            def make_linear_model(patho, intercept=1.0):
                ...
                return LinearModel(
                    ...
                    Predictor().when(
                        '(nb_breastfeeding_status == "non_exclusive") & (age_exact_years < 0.5)',
                        self.p["rr_diarrhoea_exclusive_vs_partial_breastfeeding_<6mo"],
                    ),
                    Predictor().when(
                        '(nb_breastfeeding_status == "none") & (0.5 < age_exact_years < 1)',
    ...
    def get_prob_persisent_if_prolonged(
        self,
        age_exact_years,
        un_HAZ_category,
    ...
    def get_dehydration(self, pathogen, va_rota_all_doses, age_years):
        ...
        if (pathogen == "rotavirus") and va_rota_all_doses:
            relative_prob_severe_dehydration_due_to_vaccine = (
                self.p["rr_severe_dehydration_due_to_rotavirus_with_R1_under1yo"]
                if age_years < 1
    ...
    def _get_probability_that_treatment_blocks_death(self, **kwargs):
        ...
        for i, case in enumerate(["before_treatment", "after_treatment"]):
            prob_death[case] = self.prob_death(
        ...
        return (
            (1.0 - (prob_death["after_treatment"] / prob_death["before_treatment"]))
            if prob_death["before_treatment"] != 0.0
            else 1.0
        )
...
class DiarrhoeaPollingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        for pathogen in m.pathogens:
            inc_of_acquiring_pathogen[pathogen] = models.linear_model_for_incidence_by_pathogen[pathogen].predict(
                df.loc[mask_could_get_new_diarrhoea_episode]
            )
...
class DiarrhoeaIncidentCase(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        duration_in_days = m.models.get_duration(
        ...
        props_new = {
            ...
            "gi_dehydration": m.models.get_dehydration(
                pathogen=self.pathogen, va_rota_all_doses=person.va_rota_all_doses, age_years=person.age_years
            ),
...
class DiarrhoeaDeathEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        if not ((self.sim.date == person.gi_scheduled_date_death) and pd.isnull(person.gi_scheduled_date_recovery)):
            return
...
class DiarrhoeaPropertiesOfOtherModules(Module):
    ...
    PROPERTIES = {
        ...
        "hv_art": Property(
            Types.CATEGORICAL,
            "temporary property for ART status",
        ...
        "un_HAZ_category": Property(
            Types.CATEGORICAL, "temporary property", categories=["HAZ<-3", "-3<=HAZ<-2", "HAZ>=-2"]
        ),
...
def increase_incidence_of_pathogens(diarrhoea_module):
    ...
    for pathogen in pathogens:
        diarrhoea_module.parameters[f"base_inc_rate_diarrhoea_by_{pathogen}"] = [
            0.95 / len(diarrhoea_module.pathogens)
        ] * 3
