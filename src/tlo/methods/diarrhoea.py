...
class Diarrhoea(Module):
    ...
    CAUSES_OF_DEATH = {
        f"Diarrhoea_{path}": Cause(
            gbd_causes="Diarrheal diseases", label="Childhood Diarrhoea"
        )
    ...
    PARAMETERS = {
        ...
        "rr_diarrhoea_improved_sanitation": Parameter(
            Types.REAL, "relative rate of diarrhoea for improved sanitation"
        ),
        ...
        "rr_diarrhoea_exclusive_vs_no_breastfeeding_<6mo": Parameter(
            Types.REAL,
            "relative rate of diarrhoea for no breastfeeding in <6 months old, "
            "compared to exclusive breastfeeding",
        ),
        ...
        "rr_diarrhoea_untreated_HIV": Parameter(
            Types.REAL, "relative rate of diarrhoea for HIV positive status"
        ),
        "rr_diarrhoea_SAM": Parameter(
            Types.REAL, "relative rate of diarrhoea for severe malnutrition"
        ),
        ...
        "proportion_AWD_in_ETEC": Parameter(
            Types.REAL, "acute diarrhoea type caused in ETEC-attributed diarrhoea"
        ),
        ...
        "proportion_AWD_in_tEPEC": Parameter(
            Types.REAL, "acute diarrhoea type in tEPEC-attributed diarrhoea"
        ),
        # Parameters governing the extent of dehydration
        "prob_dehydration_by_rotavirus": Parameter(
            Types.REAL, "probability of any dehydration caused by rotavirus"
        ),
        "prob_dehydration_by_shigella": Parameter(
            Types.REAL, "probability of any dehydration caused by shigella"
        ),
        "prob_dehydration_by_adenovirus": Parameter(
            Types.REAL, "probability of any dehydration caused by adenovirus"
        ),
        ...
        "prob_dehydration_by_ETEC": Parameter(
            Types.REAL, "probability of any dehydration caused by ETEC"
        ),
        "prob_dehydration_by_sapovirus": Parameter(
            Types.REAL, "probability of any dehydration caused by sapovirus"
        ),
        "prob_dehydration_by_norovirus": Parameter(
            Types.REAL, "probability of any dehydration caused by norovirus"
        ),
        "prob_dehydration_by_astrovirus": Parameter(
            Types.REAL, "probability of any dehydration caused by astrovirus"
        ),
        "prob_dehydration_by_tEPEC": Parameter(
            Types.REAL, "probability of any dehydration caused by tEPEC"
        ),
        "probability_of_severe_dehydration_if_some_dehydration": Parameter(
            Types.REAL,
            "probability that someone with diarrhoea and some dehydration develops severe "
            "dehydration",
        ),
        ...
        "prob_fever_by_rotavirus": Parameter(
            Types.REAL, "probability of fever caused by rotavirus"
        ),
        "prob_fever_by_shigella": Parameter(
            Types.REAL, "probability of fever caused by shigella"
        ),
        "prob_fever_by_adenovirus": Parameter(
            Types.REAL, "probability of fever caused by adenovirus"
        ),
        "prob_fever_by_cryptosporidium": Parameter(
            Types.REAL, "probability of fever caused by cryptosporidium"
        ),
        "prob_fever_by_campylobacter": Parameter(
            Types.REAL, "probability of fever caused by campylobacter"
        ),
        "prob_fever_by_ETEC": Parameter(
            Types.REAL, "probability of fever caused by ETEC"
        ),
        "prob_fever_by_sapovirus": Parameter(
            Types.REAL, "probability of fever caused by sapovirus"
        ),
        "prob_fever_by_norovirus": Parameter(
            Types.REAL, "probability of fever caused by norovirus"
        ),
        "prob_fever_by_astrovirus": Parameter(
            Types.REAL, "probability of fever caused by astrovirus"
        ),
        "prob_fever_by_tEPEC": Parameter(
            Types.REAL, "probability of fever caused by tEPEC"
        ),
        "prob_vomiting_by_rotavirus": Parameter(
            Types.REAL, "probability of vomiting caused by rotavirus"
        ),
        "prob_vomiting_by_shigella": Parameter(
            Types.REAL, "probability of vomiting caused by shigella"
        ),
        "prob_vomiting_by_adenovirus": Parameter(
            Types.REAL, "probability of vomiting caused by adenovirus"
        ),
        "prob_vomiting_by_cryptosporidium": Parameter(
            Types.REAL, "probability of vomiting caused by cryptosporidium"
        ),
        "prob_vomiting_by_campylobacter": Parameter(
            Types.REAL, "probability of vomiting caused by campylobacter"
        ),
        "prob_vomiting_by_ETEC": Parameter(
            Types.REAL, "probability of vomiting caused by ETEC"
        ),
        "prob_vomiting_by_sapovirus": Parameter(
            Types.REAL, "probability of vomiting caused by sapovirus"
        ),
        "prob_vomiting_by_norovirus": Parameter(
            Types.REAL, "probability of vomiting caused by norovirus"
        ),
        "prob_vomiting_by_astrovirus": Parameter(
            Types.REAL, "probability of vomiting caused by astrovirus"
        ),
        "prob_vomiting_by_tEPEC": Parameter(
            Types.REAL, "probability of vomiting caused by tEPEC"
        ),
        ...
        "case_fatality_rate_AWD": Parameter(
            Types.REAL, "case fatality rate for acute watery diarrhoea cases"
        ),
        ...
        "rr_diarr_death_untreated_HIV": Parameter(
            Types.REAL, "relative risk of diarrhoea death for untreated HIV"
        ),
        "rr_diarr_death_SAM": Parameter(
            Types.REAL, "relative risk of diarrhoea death for severe acute malnutrition"
        ),
        ...
        "rr_diarr_death_shigella": Parameter(
            Types.REAL, "relative risk of diarrhoea death if caused by shigella"
        ),
        ...
        "number_of_days_reduced_duration_with_zinc": Parameter(
            Types.INT, "number of days reduced duration with zinc"
        ),
    ...
    def read_parameters(self, data_folder):
        ...
        self.load_parameters_from_dataframe(
            pd.read_excel(
                Path(self.resourcefilepath) / "ResourceFile_Diarrhoea.xlsx",
        ...
        for param_name, param_type in self.PARAMETERS.items():
            ...
            assert isinstance(p[param_name], param_type.python_type), (
                f'Parameter "{param_name}" is not read in correctly from the '
                f"resourcefile."
            )
    ...
    def initialise_simulation(self, sim):
        ...
        * Register test for the determination of 'danger signs'
        ...
        if self.do_checks:
            ...
            sim.schedule_event(
                DiarrhoeaCheckPropertiesEvent(self),
        ...
        self.sim.modules["HealthSystem"].dx_manager.register_dx_test(
            imci_severe_dehydration_visual_inspection=DxTest(
                ...
                sensitivity=self.parameters[
                    "sensitivity_severe_dehydration_visual_inspection"
                ],
                specificity=self.parameters[
    ...
    def report_daly_values(self):
        ...
        return average_daly_weight_in_last_month.reindex(
            index=df.loc[df.is_alive].index, fill_value=0.0
        )

    def look_up_consumables(self):
        """Look up and store the consumables item codes used in each of the HSI."""
        get_item_codes_from_package_name = self.sim.modules[
            "HealthSystem"
        ...
        self.consumables_used_in_hsi["Treatment_Severe_Dehydration"] = (
            get_item_codes_from_package_name(package="Treatment of severe diarrhea")
        )
        self.consumables_used_in_hsi["Zinc_Under6mo"] = (
            get_item_codes_from_package_name(package="Zinc for Children 0-6 months")
        )
    ...
    def do_when_presentation_with_diarrhoea(
        self, person_id: int, hsi_event
    ) -> HSI_Event:
        """
        This routine is called when Diarrhoea is a symptom for a child attending a Generic HSI Appointment.
        It checks for danger signs and returns HSI Events to be scheduled appropriately.
        """

        # 1) Assessment of danger signs
        danger_signs = self.sim.modules["HealthSystem"].dx_manager.run_dx_test(
            dx_tests_to_run="imci_severe_dehydration_visual_inspection",
            hsi_event=hsi_event,
        )
        ...
        if danger_signs and (
            ...
            in_or_out = HSI_Diarrhoea_Treatment_Inpatient
        else:
            # No danger signs or otherwise not hospitalized --> Out-patient
            in_or_out = HSI_Diarrhoea_Treatment_Outpatient

        return in_or_out(person_id=person_id, module=self)
    ...
    def do_treatment(self, person_id, hsi_event):
        ...
        * Records that treatment is provided.
        ...
        if "Diarrhoea" not in self.sim.modules["SymptomManager"].causes_of(
            person_id, "diarrhoea"
        ):
            return
        ...
        if not (
            person.gi_has_diarrhoea
            and (
                person.gi_date_of_onset
                <= self.sim.date
                <= person.gi_date_end_of_last_episode
            )
        ):
            return
        ...
        if is_in_patient:
            if hsi_event.get_consumables(
                item_codes=self.consumables_used_in_hsi["Treatment_Severe_Dehydration"]
            ):
            ...
            if hsi_event.get_consumables(
                item_codes=self.consumables_used_in_hsi["ORS"]
            ):
        ...
        dehydration_after_treatment = (
            "none"
            if self.rng.rand() < prob_remove_dehydration
            else person.gi_dehydration
        )
        ...
        if type_of_diarrhoea_is_bloody and hsi_event.get_consumables(
            ...
            prob_clear_bacterial_infection = self.parameters[
        ...
        type_after_treatment = (
            "watery"
            if self.rng.rand() < prob_clear_bacterial_infection
            else person.gi_type
        )
        ...
        if will_die:
            if self.models.does_treatment_prevent_death(
                ...
                dehydration=(
                    person.gi_dehydration,
                    dehydration_after_treatment,
                ),  # <-- dehydration may have changed
                ...
                self.sim.schedule_event(
                    ...
                    + pd.DateOffset(
                        ...
                        - (
                            p["number_of_days_reduced_duration_with_zinc"]
                            if gets_zinc
                            else 0
                        )
                    ),
    ...
    def check_properties(self):
        ...
        assert (
            pd.isnull(
                df.loc[
                    not_in_current_episode, ["gi_pathogen", "gi_type", "gi_dehydration"]
                ]
            )
            .all()
            .all()
        ...
        assert not df.loc[
            not_in_current_episode, "gi_duration_longer_than_13days"
        ].any()
        assert (
            pd.isnull(
                df.loc[
        ...
        has_recovery_date = ~pd.isnull(
            df.loc[
                in_current_episode & pd.isnull(df.gi_treatment_date),
                "gi_scheduled_date_recovery",
            ]
        )
        ...
        assert not df.loc[
            df["gi_scheduled_date_death"] < self.sim.date, "is_alive"
        ].any()
        ...
        has_symptoms = {
            ...
            if "Diarrhoea"
            in self.sim.modules["SymptomManager"].causes_of(p, "diarrhoea")
        }
...
class Models:
    ...
    def __init__(self, module):
        ...
        self.linear_model_for_incidence_by_pathogen = (
            self.write_linear_model_for_incidence_of_pathogens()
        )
    ...
    def write_linear_model_for_incidence_of_pathogens(self):
        ...
        def make_scaled_linear_model(patho):
            ...
            def make_linear_model(patho, intercept=1.0):
                ...
                return LinearModel(
                    ...
                    .when("> 4", 0.0),
                    Predictor("li_no_access_handwashing").when(
                        False, self.p["rr_diarrhoea_HHhandwashing"]
                    ),
                    Predictor("li_no_clean_drinking_water").when(
                        False, self.p["rr_diarrhoea_clean_water"]
                    ),
                    Predictor("li_unimproved_sanitation").when(
                        False, self.p["rr_diarrhoea_improved_sanitation"]
                    ),
                    Predictor().when(
                        '(hv_inf == True) & (hv_art == "not")',
                        self.p["rr_diarrhoea_untreated_HIV"],
                    ),
                    Predictor("un_clinical_acute_malnutrition").when(
                        "SAM", self.p["rr_diarrhoea_SAM"]
                    ),
                    Predictor().when(
            ...
            actual_mean = unscaled_lm.predict(
                df.loc[df.is_alive & (df.age_years == 0)]
            ).mean()
            scaled_intercept = (
        ...
        for pathogen in self.module.pathogens:
            _incidence_equations_by_pathogen[pathogen] = make_scaled_linear_model(
                pathogen
            )
        ...
        if self.rng.rand() < prob_prolonged:
            if self.rng.rand() < prob_persistent_if_prolonged:
                ...
                return self.rng.randint(
                    self.p["min_dur_persistent"], self.p["max_dur_persistent"]
                )
            # "Prolonged" but not "persistent"
            return self.rng.randint(
                self.p["min_dur_prolonged"], self.p["min_dur_persistent"]
            )
    ...
    def get_type(self, pathogen):
        ...
        return (
            "watery"
            if self.rng.rand() < self.p[f"proportion_AWD_in_{pathogen}"]
            else "bloody"
        )
    ...
    def does_treatment_prevent_death(self, **kwargs):
        ...
        return self.rng.rand() < self._get_probability_that_treatment_blocks_death(
            **kwargs
        )
    ...
    def _get_probability_that_treatment_blocks_death(self, **kwargs):
        ...
        for i, case in enumerate(["before_treatment", "after_treatment"]):
            prob_death[case] = self.prob_death(
                **{
                    k: v[i] if is_iterable_and_not_string(v) else v
...
class DiarrhoeaPollingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def __init__(self, module):
        ...
        self.fraction_of_a_year_until_next_polling_event = (
            self.compute_fraction_of_year_between_polling_event()
        )
    ...
    def apply(self, population):
        ...
        mask_could_get_new_diarrhoea_episode = (
            ...
            & ~df["gi_has_diarrhoea"]
            & (
                (df.gi_date_end_of_last_episode < self.sim.date)
                | pd.isnull(df.gi_date_end_of_last_episode)
            )
        ...
        inc_of_acquiring_pathogen = pd.DataFrame(
            index=df.loc[mask_could_get_new_diarrhoea_episode].index
        )
        for pathogen in m.pathogens:
            inc_of_acquiring_pathogen[pathogen] = (
                models.linear_model_for_incidence_by_pathogen[pathogen].predict(
        ...
        for person_id, pathogen in outcome.items():
            ...
            self.sim.schedule_event(
                event=DiarrhoeaIncidentCase(
                    module=self.module, person_id=person_id, pathogen=pathogen
                ),
                date=random_date(
                    self.sim.date,
...
class DiarrhoeaIncidentCase(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        props_new = {
            ...
            "gi_date_end_of_last_episode": date_of_outcome
            + DateOffset(days=p["days_between_treatment_and_cure"]),
        ...
        if m.models.will_die(
            ...
            self.sim.schedule_event(
                DiarrhoeaNaturalRecoveryEvent(m, person_id), date_of_outcome
            )
        ...
        logger.info(
            ...
            data={
                ...
                "type": props_new["gi_type"],
                "dehydration": props_new["gi_dehydration"],
                "duration_longer_than_13days": props_new[
                    "gi_duration_longer_than_13days"
                ],
...
class DiarrhoeaDeathEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        if not (
            (self.sim.date == person.gi_scheduled_date_death)
            and pd.isnull(person.gi_scheduled_date_recovery)
        ):
            return
...
def make_treatment_perfect(diarrhoea_module):
    ...
    diarrhoea_module.parameters[
        "prob_WHOPlanC_cures_dehydration_if_severe_dehydration"
    ] = 1.0
    diarrhoea_module.parameters["prob_ORS_cures_dehydration_if_severe_dehydration"] = (
        1.0
    )
    diarrhoea_module.parameters[
        "prob_ORS_cures_dehydration_if_non_severe_dehydration"
    ...
    diarrhoea_module.parameters["sensitivity_severe_dehydration_visual_inspection"] = (
        1.0
    )
    diarrhoea_module.parameters["specificity_severe_dehydration_visual_inspection"] = (
        1.0
    )
