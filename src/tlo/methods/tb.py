    ...
    * scenario 1 constrains availablity of Xpert by setting probability of expert  to zero
    ...
    def apply(self, population):
        ...
        if scenario == 1:
            ...
            self.sim.modules['HealthSystem'].get_item_code_from_item_name ({187: 0.0})
        ...
        if scenario == 2:
           ...
           # self.sim.modules['HealthSystem'].override_availability_of_consumables({187: 0.85})
           self.sim.modules['HealthSystem'].get_item_code_from_item_name({175: 0.0})
        ...
        if scenario == 4:
            ...
            #self.sim.modules['HealthSystem'].override_availability_of_consumables({187: 0.85})
            self.sim.modules["Tb"].parameters["WHO scaling factor"] = 1.40
        ...
        if scenario == 6:
            ...
            self.sim.modules["Tb"].parameters["WHO scaling factor"] = 1.2
