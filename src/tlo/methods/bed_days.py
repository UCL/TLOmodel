...
# patients.
IN_PATIENT_ADMISSION = {'IPAdmission': 2}   # One of these for the admission and the other is for the discharge.
                                            # NB. Even patients who die whilst an in-patient require discharging.
                                            # The limitation is that the discharge appointment occurs on the same
                                            # day as the admission. See https://github.com/UCL/TLOmodel/issues/530
