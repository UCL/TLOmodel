...
def do_at_generic_first_appt(hsi_event, squeeze_factor):
...
class HSI_GenericFirstAppt_BaseClass(HSI_Event, IndividualScopeEventMixin):
    """Base Class for the GenericFirstAppt, which can occur at either level 0 or level 1."""
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        do_at_generic_first_appt(hsi_event=self, squeeze_factor=squeeze_factor)
...
class HSI_GenericFirstApptAtFacilityLevel1(HSI_GenericFirstAppt_BaseClass):
    """This is a Health System Interaction Event that represents the first interaction with the health system following
    the onset of non-emergency symptom(s). It occurs at level 1. Currently, this HSI is not generated by the
    HealthCareSeekingBehaviour module."""
