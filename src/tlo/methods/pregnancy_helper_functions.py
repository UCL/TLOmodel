...
def generate_mnh_outcome_counter():
    outcome_list = ['spontaneous_abortion',
                    'induced_abortion',
                    'complicated_spontaneous_abortion',
                    'complicated_induced_abortion',
                    'induced_abortion_injury',
                    'induced_abortion_sepsis',
                    'induced_abortion_haemorrhage',
                    'induced_abortion_other_comp',
                    'spontaneous_abortion_sepsis',
                    'spontaneous_abortion_haemorrhage',
                    'spontaneous_abortion_other_comp',
                    'gest_diab',
                    'clinical_chorioamnionitis',
                    'antenatal_stillbirth',
                    'ectopic_unruptured',
                    'multiple_pregnancy',
                    'placenta_praevia',
                    'ectopic_ruptured',
                    'syphilis',
                       ...
                       'obstructed_labour',
                       'sepsis_intrapartum',
                       'uterine_rupture', 'early_preterm_labour', 'late_preterm_labour', 'post_term_labour',
                       'intrapartum_stillbirth',
                       ...
                       'sepsis_intrapartum',
                       'uterine_rupture', 'early_preterm_labour', 'late_preterm_labour', 'post_term_labour',
                       'intrapartum_stillbirth', 'vesicovaginal_fistula', 'rectovaginal_fistula',
                       'secondary_postpartum_haemorrhage', 'pph_uterine_atony', 'pph_retained_placenta', 'pph_other',
                       'primary_postpartum_haemorrhage', 'sepsis_endometritis', 'sepsis_urinary_tract',
                       'sepsis_skin_soft_tissue', 'sepsis_postnatal', 'congenital_heart_anomaly', 'limb_or_musculoskeletal_anomaly',
                       'urogenital_anomaly',
