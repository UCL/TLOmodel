...
class ChronicSyndrome(Module, GenericFirstAppointmentsMixin):
    ...
    PARAMETERS = {
        ...
        "prob_of_symptoms": Parameter(Types.DICT, "Probabilities of developing each type of symptom at onset"),
    ...
    def read_parameters(self, data_folder):
        ...
        self.parameters["prob_of_symptoms"] = {"inappropriate_jokes": 0.95, "craving_sandwiches": 0.5}
        ...
        self.sim.modules["SymptomManager"].register_symptom(
            Symptom(name="inappropriate_jokes", odds_ratio_health_seeking_in_adults=3.0),
    ...
    def initialise_population(self, population):
        ...
        for symp in self.parameters["prob_of_symptoms"]:
            ...
            self.sim.modules["SymptomManager"].change_symptom(
                person_id=list(persons_id_with_symp), symptom_string=symp, add_or_remove="+", disease_module=self
            )
    ...
    def initialise_simulation(self, sim):
        ...
        self.sim.schedule_event(popwide_event, self.sim.date)
    ...
    def report_daly_values(self):
        ...
        for symptom, daly_wt in self.parameters["daly_wts"].items():
            health_values.loc[health_values.index.isin(self.sim.modules["SymptomManager"].who_has(symptom))] += daly_wt
