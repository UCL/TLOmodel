...
class ChronicSyndrome(Module):
    ...
    def read_parameters(self, data_folder):
        ...
        if "HealthBurden" in self.sim.modules.keys():
            ...
            self.parameters["daly_wts"] = {
                "inappropriate_jokes": self.sim.modules["HealthBurden"].get_daly_weight(
                    sequlae_code=86
                ),
                "craving_sandwiches": self.sim.modules["HealthBurden"].get_daly_weight(
                    sequlae_code=87
                ),
            }
        ...
        self.sim.modules["SymptomManager"].register_symptom(
            Symptom(
                name="inappropriate_jokes", odds_ratio_health_seeking_in_adults=3.0
            ),
    ...
    def initialise_simulation(self, sim):
        ...
        logger.debug(
            key="debug",
            data="The population wide HSI event has been scheduled successfully!",
        )
    ...
    def on_hsi_alert(self, person_id, treatment_id):
        ...
        if treatment_id == "Mockitis_TreatmentMonitoring":
            piggy_back_dx_at_appt = (
                HSI_ChronicSyndrome_SeeksEmergencyCareAndGetsTreatment(self, person_id)
            )
    ...
    def report_daly_values(self):
        ...
        logger.debug(
            key="debug", data="This is chronicsyndrome reporting my health values"
        )
...
class HSI_ChronicSyndrome_SeeksEmergencyCareAndGetsTreatment(
    ...
    def apply(self, person_id, squeeze_factor):
        logger.debug(
            key="debug",
            data=(
                "This is HSI_ChronicSyndrome_SeeksEmergencyCareAndGetsTreatment: "
    ...
    def did_not_run(self):
        logger.debug(
            key="debug",
            data="HSI_ChronicSyndrome_SeeksEmergencyCareAndGetsTreatment: did not run",
        )
        pass
...
class HSI_ChronicSyndrome_Outreach_Individual(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        logger.debug(
            key="debug",
            data=f"Outreach event running now for person: {person_id}",
        )
    ...
    def did_not_run(self):
        logger.debug(
            key="debug", data="HSI_ChronicSyndrome_Outreach_Individual: did not run"
        )
        pass
...
class HSI_ChronicSyndrome_PopulationWideBehaviourChange(
    ...
    def apply(self, population, squeeze_factor):
        logger.debug(
            key="debug",
            data="This is HSI_ChronicSyndrome_PopulationWideBehaviourChange",
        )
