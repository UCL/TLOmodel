...
class Demography(Module):
    ...
    def assign_closest_facility_level(self):
        ...
        facility_info  =pd.read_csv("resources/climate_change_impacts/facilities_with_lat_long_region.csv")# these are ones that were included in the regression model
