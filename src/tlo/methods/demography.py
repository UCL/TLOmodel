...
class Demography(Module):
    ...
    def initialise_population(self, population):
        ...
        # todo is this the actual population or the initial model population????
        pop_by_district = self.parameters['pop_2010'].groupby('District')['Count'].sum()
        ...
        self.initial_model_to_data_popsize_ratio_district = \
            self.compute_initial_model_to_data_popsize_ratio_by_district(district_pop=pop_by_district,
                                                                         model_pop=model_pop)
