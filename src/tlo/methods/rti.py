...
class RTI(Module):
    ...
    DATE_TO_REMOVE_DALY_COLUMNS = [
        f"rt_date_to_remove_daly_{i}" for i in INJURY_INDICES
    ]
    ...
    PARAMETERS = {
        ...
        "rr_injrti_age04": Parameter(
            Types.REAL, "risk ratio of RTI in age 0-4 compared to base rate of RTI"
        ),
        "rr_injrti_age59": Parameter(
            Types.REAL, "risk ratio of RTI in age 5-9 compared to base rate of RTI"
        ),
        "rr_injrti_age1017": Parameter(
            Types.REAL, "risk ratio of RTI in age 10-17 compared to base rate of RTI"
        ),
        ...
        "mean_los_ISS_less_than_4": Parameter(
            Types.REAL, "Mean length of stay for someone with an ISS score < 4"
        ),
        ...
        "daly_wt_unspecified_skull_fracture": Parameter(
            Types.REAL, "daly_wt_unspecified_skull_fracture - code 1674"
        ),
        "daly_wt_basilar_skull_fracture": Parameter(
            Types.REAL, "daly_wt_basilar_skull_fracture - code 1675"
        ),
        "daly_wt_epidural_hematoma": Parameter(
            Types.REAL, "daly_wt_epidural_hematoma - code 1676"
        ),
        "daly_wt_subdural_hematoma": Parameter(
            Types.REAL, "daly_wt_subdural_hematoma - code 1677"
        ),
        "daly_wt_subarachnoid_hematoma": Parameter(
            Types.REAL, "daly_wt_subarachnoid_hematoma - code 1678"
        ),
        "daly_wt_brain_contusion": Parameter(
            Types.REAL, "daly_wt_brain_contusion - code 1679"
        ),
        ...
        "daly_wt_abd_internal_organ_injury": Parameter(
            Types.REAL, "daly_wt_abd_internal_organ_injury - code 1700"
        ),
        ...
        "daly_wt_vertebrae_fracture": Parameter(
            Types.REAL, "daly_wt_vertebrae_fracture - code 1705"
        ),
        ...
        "daly_wt_dislocated_shoulder": Parameter(
            Types.REAL, "daly_wt_dislocated_shoulder - code 1711"
        ),
        "daly_wt_amputated_finger": Parameter(
            Types.REAL, "daly_wt_amputated_finger - code 1712"
        ),
        "daly_wt_amputated_thumb": Parameter(
            Types.REAL, "daly_wt_amputated_thumb - code 1713"
        ),
        ...
        "daly_wt_pelvis_fracture_short_term": Parameter(
            Types.REAL, "daly_wt_pelvis_fracture_short_term - code 1725"
        ),
        "daly_wt_pelvis_fracture_long_term": Parameter(
            Types.REAL, "daly_wt_pelvis_fracture_long_term - code 1726"
        ),
        "daly_wt_femur_fracture_short_term": Parameter(
            Types.REAL, "daly_wt_femur_fracture_short_term - code 1727"
        ),
        ...
        "daly_wt_dislocated_hip": Parameter(
            Types.REAL, "daly_wt_dislocated_hip - code 1729"
        ),
        "daly_wt_dislocated_knee": Parameter(
            Types.REAL, "daly_wt_dislocated_knee - code 1730"
        ),
        "daly_wt_amputated_toes": Parameter(
            Types.REAL, "daly_wt_amputated_toes - code 1731"
        ),
        ...
        "mean_icu_days": Parameter(
            Types.REAL, "The mean length of stay in the ICUfor those without TBI"
        ),
        ...
        "mean_tbi_icu_days": Parameter(
            Types.REAL, "The mean length of stay in the ICU for those with TBI"
        ),
        ...
        "head_prob_1101": Parameter(
            Types.REAL, "The probability that this person's head injury is a laceration"
        ),
        "head_prob_1114": Parameter(
            Types.REAL, "The probability that this person's head injury is a burn"
        ),
        ...
        "face_prob_2101": Parameter(
            Types.REAL, "The probability that this person's face injury is a laceration"
        ),
        "face_prob_2114": Parameter(
            Types.REAL, "The probability that this person's face injury is a burn"
        ),
        ...
        "neck_prob_3101": Parameter(
            Types.REAL, "The probability that this person's neck injury is a laceration"
        ),
        "neck_prob_3113": Parameter(
            Types.REAL, "The probability that this person's neck injury is a burn"
        ),
        ...
        "thorax_prob_4113": Parameter(
            Types.REAL, "The probability that this person's thorax injury is a burn"
        ),
        ...
        "blocked_interventions": Parameter(
            Types.LIST, "A list of interventions that are blocked in a simulation"
        ),
    ...
    PROPERTIES = {
        ...
        **{
        ...
        "rt_debugging_DALY_wt": Property(
            Types.REAL, "The true value of the DALY weight burden"
        ),
    ...
    CAUSES_OF_DEATH = {
        "RTI_death_without_med": Cause(
            gbd_causes="Road injuries", label="Transport Injuries"
        ),
        "RTI_death_with_med": Cause(
            gbd_causes="Road injuries", label="Transport Injuries"
        ),
        "RTI_unavailable_med": Cause(
            gbd_causes="Road injuries", label="Transport Injuries"
        ),
        "RTI_imm_death": Cause(gbd_causes="Road injuries", label="Transport Injuries"),
        "RTI_death_shock": Cause(
            gbd_causes="Road injuries", label="Transport Injuries"
        ),
    }
    ...
    def read_parameters(self, data_folder):
        ...
        dfd = pd.read_excel(
            Path(self.resourcefilepath) / "ResourceFile_RTI.xlsx",
        ...
        for body_part in body_part_strings:
            probabilities_to_assign_injuries = [
                val for key, val in p.items() if body_part in key
            ]
            sum_probabilities = sum(probabilities_to_assign_injuries)
            assert (sum_probabilities % 1 < 0.0001) or (
                sum_probabilities % 1 > 0.9999
            ), (
        ...
        self.sim.modules["SymptomManager"].register_symptom(
            Symptom.emergency("severe_trauma")
        )
        ...
        self.ASSIGN_INJURIES_AND_DALY_CHANGES = {
            ...
            "211": [
                [p["face_prob_211"], 2, 1, 1, 2],
                p["daly_wt_facial_fracture"],
                0,
                -p["daly_wt_facial_fracture"],
            ],
            "212": [
                [p["face_prob_212"], 2, 1, 2, 3],
                p["daly_wt_facial_fracture"],
                0,
                -p["daly_wt_facial_fracture"],
            ],
            ...
            "291": [
                [p["face_prob_291"], 2, 9, 1, 2],
                p["daly_wt_eye_injury"],
                0,
                -p["daly_wt_eye_injury"],
            ],
            ...
            "322": [
                [p["neck_prob_322"], 3, 2, 2, 3],
                p["daly_wt_neck_dislocation"],
                0,
                -p["daly_wt_neck_dislocation"],
            ],
            "323": [
                [p["neck_prob_323"], 3, 2, 3, 4],
                p["daly_wt_neck_dislocation"],
                0,
                -p["daly_wt_neck_dislocation"],
            ],
            ...
            "463": [
                [p["thorax_prob_463"], 4, 6, 3, 4],
                p["daly_wt_hemothorax"],
                0,
                -p["daly_wt_hemothorax"],
            ],
            "453a": [
            ...
            "453b": [
                [p["thorax_prob_453b"], 4, 5, 3, 4],
                p["daly_wt_lung_contusion"],
                0,
                -p["daly_wt_lung_contusion"],
            ],
            "412": [
                [p["thorax_prob_412"], 4, 1, 2, 3],
                p["daly_wt_rib_fracture"],
                0,
                -p["daly_wt_rib_fracture"],
            ],
            "414": [
                [p["thorax_prob_414"], 4, 1, 4, 5],
                p["daly_wt_flail_chest"],
                0,
                -p["daly_wt_flail_chest"],
            ],
            "441": [
            ...
            "782a": [
                [p["upper_ex_prob_782a"], 7, 8, 2, 3],
                p["daly_wt_amputated_finger"],
                0,
                0,
            ],
            "782b": [
            ...
            "782c": [
                [p["upper_ex_prob_782c"], 7, 8, 2, 3],
                p["daly_wt_amputated_thumb"],
                0,
                0,
            ],
            "783": [
            ...
            "882": [
                [p["lower_ex_prob_882"], 8, 8, 2, 3],
                p["daly_wt_amputated_toes"],
                0,
                0,
            ],
            "883": [
        ...
        non_zero_total_daly_change = (
            sum_check_daly_change_df.where(sum_check_daly_change_df > 0).dropna().index
        )
    ...
    def initialise_population(self, population):
        ...
        df.loc[df.is_alive, "rt_inj_severity"] = (
            "none"  # default: no one has been injured in a RTI
        )
        ...
        df.loc[df.is_alive, "rt_imm_death"] = (
            False  # default: no one is dead on scene of crash
        )
        df.loc[df.is_alive, "rt_diagnosed"] = False
        df.loc[df.is_alive, "rt_recovery_no_med"] = (
            False  # default: no recovery without medical intervention
        )
        df.loc[df.is_alive, "rt_post_med_death"] = (
            False  # default: no death after medical intervention
        )
        ...
        df.loc[df.is_alive, "rt_injuries_to_cast"] = pd.Series(
            [[] for _ in range(alive_count)]
        )
        df.loc[df.is_alive, "rt_injuries_for_minor_surgery"] = pd.Series(
            [[] for _ in range(alive_count)]
        )
        df.loc[df.is_alive, "rt_injuries_for_major_surgery"] = pd.Series(
            [[] for _ in range(alive_count)]
        )
        df.loc[df.is_alive, "rt_injuries_to_heal_with_time"] = pd.Series(
            [[] for _ in range(alive_count)]
        )
        df.loc[df.is_alive, "rt_injuries_for_open_fracture_treatment"] = pd.Series(
            [[] for _ in range(alive_count)]
        )
        df.loc[df.is_alive, "rt_injuries_left_untreated"] = pd.Series(
            [[] for _ in range(alive_count)]
        )
    ...
    def initialise_simulation(self, sim):
        ...
        sim.schedule_event(
            RTI_Check_Death_No_Med(self), sim.date + DateOffset(months=0)
        )
    ...
    def rti_do_when_diagnosed(self, person_id):
        ...
        _, counts = RTI.rti_find_and_count_injuries(
            person_injuries, RTI.INJURY_CODES[1:]
        )
    ...
    def rti_do_for_major_surgeries(self, person_id, count):
        ...
        if df.at[person_id, "is_alive"]:
            ...
            if count == 0:
                assert (
                    len(
                        set(person.rt_injuries_for_major_surgery)
                        & set(surgically_treated_codes)
                    )
                    > 0
            ...
            _, counts = RTI.rti_find_and_count_injuries(
                person_injuries, surgically_treated_codes
            )
            if counts == 0:
                logger.debug(
            ...
            if "Major Surgery" not in p["blocked_interventions"]:
                ...
                if count == 0:
                    df.at[person_id, "rt_injuries_left_untreated"] = df.at[
                        person_id, "rt_injuries_for_major_surgery"
                    ]
    ...
    def rti_do_for_minor_surgeries(self, person_id, count):
        ...
        # RTI module
        assert df.at[
            person_id, "rt_med_int"
        ], "Person sent for treatment did not go through rti med int"
        # Isolate the person
        if df.at[person_id, "is_alive"]:
            ...
            for code in df.at[person_id, "rt_injuries_for_minor_surgery"]:
                injury_column, _ = self.rti_find_injury_column(person_id, [code])
                if not pd.isnull(
                    df.at[person_id, RTI.INJURY_DATE_COLUMN_MAP[injury_column]]
                ):
                    logger.debug(
                        key="rti_general_message",
                        data=f"person {person_id} was assigned for a minor surgery but had already received "
            ...
            if count == 0:
                assert (
                    len(
                        set(df.at[person_id, "rt_injuries_for_minor_surgery"])
                        & set(surgically_treated_codes)
                    )
                    > 0
                ), "This person has asked for a minor surgery but does not need it"
            ...
            if "Minor Surgery" not in self.parameters["blocked_interventions"]:
                ...
                if count == 0:
                    df.at[person_id, "rt_injuries_left_untreated"] = df.at[
                        person_id, "rt_injuries_for_minor_surgery"
                    ]
                    # remove the injury code from this treatment option
    ...
    def rti_acute_pain_management(self, person_id):
        ...
        if df.at[person_id, "is_alive"]:
            ...
            assert df.at[
                person_id, "rt_med_int"
            ], "person sent here not been through rti med int"
            # Isolate the relevant injury information
            person_injuries = df.loc[[person_id], RTI.INJURY_COLUMNS]
            # check this person is injured, search they have an injury code that isn't "none".
            ...
            self.sim.modules["HealthSystem"].schedule_hsi_event(
                hsi_event=HSI_RTI_Acute_Pain_Management(
                    module=self, person_id=person_id
                ),
                priority=0,
    ...
    def rti_ask_for_suture_kit(self, person_id):
        ...
        if df.at[person_id, "is_alive"]:
            ...
            _, counts = RTI.rti_find_and_count_injuries(
                person_injuries, laceration_codes
            )
            if counts == 0:
                logger.debug(
                    key="rti_general_message",
    ...
    def rti_ask_for_shock_treatment(self, person_id):
        ...
        if df.at[person_id, "is_alive"]:
            assert df.at[
                person_id, "rt_in_shock"
            ], "person requesting shock treatment is not in shock"
    ...
    def rti_ask_for_fracture_casts(self, person_id):
        ...
        if df.at[person_id, "is_alive"]:
            ...
            assert (
                len(set(df.loc[person_id, "rt_injuries_to_cast"]) & set(fracture_codes))
                > 0
            ...
            if "Fracture Casts" not in self.parameters["blocked_interventions"]:
                ...
                df.at[person_id, "rt_injuries_left_untreated"] = df.at[
                    person_id, "rt_injuries_to_cast"
                ]
                df.at[person_id, "rt_injuries_to_cast"] = []
                # reset the time to check whether the person has died from their injuries
                df.loc[person_id, "rt_date_death_no_med"] = self.sim.date + DateOffset(
                    days=1
                )
    ...
    def rti_ask_for_open_fracture_treatment(self, person_id, counts):
        ...
        if df.at[person_id, "is_alive"]:
            ...
            _, counts = RTI.rti_find_and_count_injuries(
                person_injuries, open_fracture_codes
            )
            if counts == 0:
                logger.debug(
                    key="rti_general_message",
            ...
            for i in range(0, counts):
                ...
                self.sim.modules["HealthSystem"].schedule_hsi_event(
                    hsi_event=HSI_RTI_Open_Fracture_Treatment(
                        module=self, person_id=person_id
                    ),
                    priority=0,
    ...
    def rti_ask_for_tetanus(self, person_id):
        ...
        if df.at[person_id, "is_alive"]:
            ...
            _, counts = RTI.rti_find_and_count_injuries(
                person_injuries, codes_for_tetanus
            )
            if counts == 0:
                logger.debug(
                    key="rti_general_message",
    ...
    def rti_assign_daly_weights(self, injured_index):
        ...
        assert (
            sum(~df.loc[injured_index, "cause_of_death"].isin(rti_deaths))
            == len(injured_index)
        ...
        df.loc[injured_index, "rt_debugging_DALY_wt"] = df.loc[
            injured_index, "rt_disability"
        ]
        ...
        DALYweightunderlimit = df.index[
            df.rt_road_traffic_inc & ~df.rt_imm_death & (df["rt_disability"] <= 0)
        ]
    ...
    def rti_alter_daly_post_treatment(self, person_id, codes):
        ...
        df.at[person_id, "rt_debugging_DALY_wt"] = np.round(
            df.at[person_id, "rt_debugging_DALY_wt"], 4
        )
        ...
        if df.at[person_id, "rt_disability"] < 0:
            logger.warning(
                key="warning", data="rt disability < 0 in rti_alter_daly_post_treatment"
            )
            df.at[person_id, "rt_disability"] = 0

        if df.at[person_id, "rt_disability"] > 1:
            logger.warning(
                key="warning", data="rt disability > 1 in rti_alter_daly_post_treatment"
            )
            df.at[person_id, "rt_disability"] = 1
    ...
    def rti_swap_injury_daly_upon_treatment(self, person_id, codes):
        ...
        idx, counts = RTI.rti_find_and_count_injuries(
            person_injuries, list(relevant_codes)
        )
        assert (
            counts > 0
        ), "This person has asked to swap an injury code, but it is not swap-able"
        ...
        if df.at[person_id, "rt_disability"] < 0:
            logger.warning(
                key="warning",
                data="rt disability < 0 in rti_swap_injury_daly_upon_treatment",
            )
            df.at[person_id, "rt_disability"] = 0
        ...
        if df.at[person_id, "rt_disability"] > 1:
            logger.warning(
                key="warning",
                data="rt disability > 1 in rti_swap_injury_daly_upon_treatment",
            )
            df.at[person_id, "rt_disability"] = 1
    ...
    def rti_determine_LOS(self, person_id):
        ...
        if rt_iss_score < 4:
            days_until_treatment_end = draw_days(
                p["mean_los_ISS_less_than_4"], p["sd_los_ISS_less_than_4"]
            )
        elif 4 <= rt_iss_score < 9:
            days_until_treatment_end = draw_days(
                p["mean_los_ISS_4_to_8"], p["sd_los_ISS_4_to_8"]
            )
        elif 9 <= rt_iss_score < 16:
            days_until_treatment_end = draw_days(
                p["mean_los_ISS_9_to_15"], p["sd_los_ISS_9_to_15"]
            )
        elif 16 <= rt_iss_score < 25:
            days_until_treatment_end = draw_days(
                p["mean_los_ISS_16_to_24"], p["sd_los_ISS_16_to_24"]
            )
        elif 25 <= rt_iss_score:
            days_until_treatment_end = draw_days(
                p["mean_los_ISS_more_than_25"], p["sd_los_ISS_more_that_25"]
            )
        else:
    ...
    @staticmethod
    def rti_find_and_count_injuries(
        persons_injury_properties: pd.DataFrame, injury_codes: list
    ):
        """
    ...
    def rti_treated_injuries(self, person_id, tlo_injury_codes):
        ...
        injury_cols = person_injuries.index[
            person_injuries.isin(codes_to_remove)
        ].tolist()
    ...
    def on_birth(self, mother_id, child_id):
        ...
        df.at[child_id, "rt_inj_severity"] = (
            "none"  # default: no one has been injured in a RTI
        )
        for injury_index in RTI.INJURY_INDICES:
        ...
        df.at[child_id, "rt_med_int"] = (
            False  # default: no one has a had medical intervention
        )
        df.at[child_id, "rt_in_icu_or_hdu"] = False
        df.at[child_id, "rt_diagnosed"] = False
        df.at[child_id, "rt_recovery_no_med"] = (
            False  # default: no recovery without medical intervention
        )
        df.at[child_id, "rt_post_med_death"] = (
            False  # default: no death after medical intervention
        )
    ...
    def report_daly_values(self):
        ...
        logger.debug(
            key="rti_general_message", data="This is RTI reporting my daly values"
        )
        df = self.sim.population.props
    ...
    def rti_assign_injuries(self, number):
        ...
        number_of_injured_body_regions_distribution = p[
        ...
        for n in range(0, number):
            ...
            ninj = self.rng.choice(
                number_of_injured_body_regions_distribution[0],
            ...
            injurylocation = self.rng.choice(
                injlocdist[0], ninj, p=injlocdist[1], replace=False
            )
            ...
            for injlocs in injurylocation:
                ...
                injuries_at_location = [
                    injury
                    for injury in self.ASSIGN_INJURIES_AND_DALY_CHANGES.keys()
                    if injury.startswith(str(injlocs))
                ]
                # find the probability of each injury based on the above filter
                prob_of_each_injury_at_location = [
                    self.ASSIGN_INJURIES_AND_DALY_CHANGES[injury][0][0]
                    for injury in injuries_at_location
                ]
                ...
                injury_chosen = self.rng.choice(
                    injuries_at_location, p=prob_of_each_injury_at_location
                )
                ...
                predinjlocs.append(
                    self.ASSIGN_INJURIES_AND_DALY_CHANGES[injury_chosen][0][1]
                )
                # store the injury category chosen (used in logging)
                predinjcat.append(
                    self.ASSIGN_INJURIES_AND_DALY_CHANGES[injury_chosen][0][2]
                )
                # store the severity of the injury chosen
                injais.append(
                    self.ASSIGN_INJURIES_AND_DALY_CHANGES[injury_chosen][0][3]
                )
                # store the MAIS score
                injmais.append(
                    self.ASSIGN_INJURIES_AND_DALY_CHANGES[injury_chosen][0][4]
                )
        ...
        if len(inj_df) > 0:
            ...
            # rename the columns
            listed_injuries = listed_injuries.rename(
                columns=lambda x: "rt_injury_" + str(x + 1)
            )
        ...
        inc_amputations = (
            amputationcounts / ((n_alive - amputationcounts) * 1 / 12) * 100000
        )
        ...
        inc_sci = (
            spinalcordinjurycounts
            / ((n_alive - spinalcordinjurycounts) * 1 / 12)
            * 100000
        )
        inc_minor = (
            minorinjurycounts / ((n_alive - minorinjurycounts) * 1 / 12) * 100000
        )
        ...
        flattened_injuries = [
            str(item)
            for sublist in inj_df["Injury_codes"].to_list()
            for item in sublist
        ]
        lx_frac_codes = [
            "811",
        ...
        n_open_lx_fracs = len(
            [inj for inj in flattened_injuries if inj in lx_open_frac_codes]
        )
        if n_lx_fracs > 0:
    ...
    def do_rti_diagnosis_and_treatment(self, person_id):
        ...
        persons_injuries = df.loc[person_id, RTI.INJURY_COLUMNS]
        if (
            pd.isnull(df.at[person_id, "cause_of_death"])
            and not df.at[person_id, "rt_diagnosed"]
        ):
...
class RTIPollingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def __init__(self, module):
        ...
        self.rt_emergency_care_ISS_score_cut_off = p[
    ...
    def apply(self, population):
        ...
        # scene
        selected_for_rti_inj = selected_for_rti_inj.loc[
        ...
        died_elsewhere_index = selected_for_rti_inj[
            ~selected_for_rti_inj["cause_of_death"].isnull()
        ].index
        ...
        description = road_traffic_injuries.rti_assign_injuries(
            len(selected_for_rti_inj)
        )
        ...
        df.loc[selected_for_rti_inj.index, "rt_ISS_score"] = description.loc[
            selected_for_rti_inj.index, "ISS"
        ].astype(int)
        ...
        for col in matching_columns:
            df.loc[selected_for_rti_inj.index, col] = description.loc[
                selected_for_rti_inj.index, col
            ]
        ...
        assert len(
            df.loc[df.rt_road_traffic_inc & ~df.rt_imm_death, "rt_ISS_score"] > 0
        ...
        shock_index = potential_shock_index[
            self.prob_bleeding_leads_to_shock > rand_for_shock
        ]
        df.loc[shock_index, "rt_in_shock"] = True
        # log the percentage of those with RTIs in shock
        percent_in_shock = (
            len(shock_index) / len(selected_for_rti_inj)
            if len(selected_for_rti_inj) > 0
            else "none_injured"
        )
        logger.info(
        ...
        df.loc[selected_for_rti_inj.index, "rt_date_death_no_med"] = now + DateOffset(
            days=7
        )
        ...
        mild_rti_idx = injured_this_month.index[
            injured_this_month.is_alive & injured_this_month["rt_ISS_score"] < 15
        ]
        ...
        severe_rti_idx = injured_this_month.index[
            injured_this_month["rt_ISS_score"] >= 15
        ]
        ...
        assert sum(
            df.loc[
                df.rt_road_traffic_inc & ~df.rt_imm_death & (df.rt_date_inj == now),
                "rt_inj_severity",
            ]
            != "none"
        ...
        assert sum(
            df.loc[condition_to_be_sent_to_begin_non_emergency, "rt_injury_1"] != "none"
...
class RTI_Check_Death_No_Med(RegularEvent, PopulationScopeEventMixin):
    ...
    def __init__(self, module):
        ...
        self.daly_wt_foot_fracture_long_term_without_treatment = p[
        ...
        self.daly_wt_hip_fracture_long_term_without_treatment = p[
            "daly_wt_hip_fracture_long_term_without_treatment"
        ]
        self.daly_wt_pelvis_fracture_short_term = p[
        ...
        self.no_treatment_mortality_mais_cutoff = p[
    ...
    def apply(self, population):
        ...
        if len(df.loc[df["rt_date_death_no_med"] == now]) > 0:
            ...
            due_to_die_today_without_med_int = df.loc[
                df["rt_date_death_no_med"] == now
            ].index
            ...
            for person in due_to_die_today_without_med_int:
                ...
                if (rand_for_death < prob_death) and (
                    ...
                    for code in flattened_injuries:
                        ...
                        _, counts = road_traffic_injuries.rti_find_and_count_injuries(
                            persons_injuries, [code]
                        )
                        assert counts > 0
                        df.loc[
                            person, "rt_debugging_DALY_wt"
                        ] += swapping_daly_weights_lookup[swapable_code]
                        if df.loc[person, "rt_debugging_DALY_wt"] > 1:
                            df.loc[person, "rt_disability"] = 1
                        else:
                            df.loc[person, "rt_disability"] = df.loc[
                                person, "rt_debugging_DALY_wt"
                            ]
                        ...
                        persons_injuries = df.loc[[person], RTI.INJURY_COLUMNS]
                        non_empty_injuries = persons_injuries[
                            persons_injuries != "none"
                        ]
                        non_empty_injuries = non_empty_injuries.dropna(axis=1)
                        ...
                        if not df.loc[person, "rt_med_int"]:
                            if (
                                code
                                in self.module.NO_TREATMENT_RECOVERY_TIMES_IN_DAYS.keys()
                            ):
                                df.loc[person, date_to_remove_daly_column] = (
                                    self.sim.date
                                    + DateOffset(
                                        days=self.module.NO_TREATMENT_RECOVERY_TIMES_IN_DAYS[
                                            code
                                        ]
                                    )
                                )
                            ...
                            code_has_recovery_time = (
                                code
                                in self.module.NO_TREATMENT_RECOVERY_TIMES_IN_DAYS.keys()
                            )
                            code_is_left_untreated = (
                        ...
                        if code in df.loc[person, "rt_injuries_left_untreated"]:
                            ...
                            if code in df.loc[person, "rt_injuries_for_minor_surgery"]:
                                df.loc[person, "rt_injuries_for_minor_surgery"].remove(
                                    code
                                )
                            if code in df.loc[person, "rt_injuries_for_major_surgery"]:
                                df.loc[person, "rt_injuries_for_major_surgery"].remove(
                                    code
                                )
                            if code in df.loc[person, "rt_injuries_to_heal_with_time"]:
                                df.loc[person, "rt_injuries_to_heal_with_time"].remove(
                                    code
                                )
                            if code in df.loc[person, "rt_injuries_to_heal_with_time"]:
                                df.loc[person, "rt_injuries_to_heal_with_time"].remove(
...
class RTI_Recovery_Event(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        any_not_null = (
            df.loc[df.is_alive, RTI.DATE_TO_REMOVE_DALY_COLUMNS].notnull().any(axis=1)
        )
        ...
        for person in relevant_population:
            ...
            for date_column in RTI.DATE_TO_REMOVE_DALY_COLUMNS:
                ...
                if not pd.isnull(date_values[date_column]):
                    assert (
                        date_values[date_column] >= self.sim.date
                ...
                if date_values[date_column] == now:
                    ...
                    if counts == 0:
                        ...
                        road_traffic_injuries.rti_alter_daly_post_treatment(
                            person, code_to_remove
                        )
...
class HSI_RTI_Imaging_Event(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        road_traffic_injuries = self.sim.modules["RTI"]
        road_traffic_injuries.rti_injury_diagnosis(
            person_id, self.EXPECTED_APPT_FOOTPRINT
        )
...
class HSI_RTI_Medical_Intervention(HSI_Event, IndividualScopeEventMixin):
    ...
    def __init__(self, module, person_id):
        ...
        self.prob_depressed_skull_fracture = p[
            "prob_depressed_skull_fracture"
        ]  # proportion of depressed skull
        # fractures in https://doi.org/10.1016/j.wneu.2017.09.084
        self.prob_mild_burns = p[
            "prob_mild_burns"
        ]  # proportion of burns accross SSA with TBSA < 10
        ...
        self.prob_perm_disability_with_treatment_severe_TBI = p[
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        treatment_plans = {
            ...
            "112": [
                [
                    self.prob_depressed_skull_fracture,
                    1 - self.prob_depressed_skull_fracture,
                ],
                ["major", "HWT"],
            ],
            "113": [[1], ["HWT"]],
            ...
            "133a": [
                [
                    self.prob_TBI_require_craniotomy,
                    1 - self.prob_TBI_require_craniotomy,
                ],
                ["major", "HWT"],
            ],
            "133b": [
            ...
            "552": [
                [
                    self.prob_exploratory_laparotomy,
                    1 - self.prob_exploratory_laparotomy,
                ],
                ["major", "HWT"],
            ],
            "553": [
            ...
            "322": [
                [
                    self.prob_dislocation_requires_surgery,
                    1 - self.prob_dislocation_requires_surgery,
                ],
                ["minor", "HWT"],
            ],
            "323": [
        ...
        for code in treatment_plans.keys():
            _, counts = road_traffic_injuries.rti_find_and_count_injuries(
                person_injuries, [code]
            )
            if counts > 0:
                treatment_choice = self.module.rng.choice(
                    treatment_plans[code][1], p=treatment_plans[code][0]
                )
                ...
                if treatment_choice == "open":
                    open_fractures += 1
                    df.loc[person_id, "rt_injuries_for_open_fracture_treatment"].append(
                        code
                    )
        ...
        if (counts > 0) & ("include_spine_surgery" in self.allowed_interventions):
            ...
            column, code = road_traffic_injuries.rti_find_injury_column(
                person_id=person_id, codes=codes
            )
            ...
            columns, codes = (
                road_traffic_injuries.rti_find_all_columns_of_treated_injuries(
                    person_id, [code]
                )
            )
            for col in columns:
                ...
                assert (
                    df.loc[person_id, RTI.INJURY_DATE_COLUMN_MAP[col]] > self.sim.date
                )
        ...
        femur_fracture_skeletal_traction_mean_los = p[
        ...
        if df.loc[person_id, "rt_ISS_score"] > self.hdu_cut_off_iss_score:
            ...
            if counts > 0:
                self.icu_days = int(
                    self.module.rng.normal(mean_tbi_icu_days, sd_tbi_icu_days, 1)
                )
            else:
                self.icu_days = int(
                    self.module.rng.normal(mean_icu_days, sd_icu_days, 1)
                )
        ...
        if len(df.at[person_id, "rt_injuries_to_heal_with_time"]) > 0:
            ...
            tbi_injury = [
                injury
                for injury in tbi
                if injury in person["rt_injuries_to_heal_with_time"]
            ]
            if len(tbi_injury) > 0:
                ...
                if perm_injury < self.prob_perm_disability_with_treatment_severe_TBI:
                    ...
                    df.loc[person_id, "rt_injuries_to_heal_with_time"].append(
                        "P" + code
                    )
            ...
            codes_to_swap = [
                code for code in heal_with_time_codes if code in swapping_codes
            ]
            if len(codes_to_swap) > 0:
                road_traffic_injuries.rti_swap_injury_daly_upon_treatment(
                    person_id, codes_to_swap
                )
        ...
        if not pd.isnull(df.loc[person_id, "cause_of_death"]):
            ...
            if major_surgery_counts > 0:
                ...
                for count in range(0, major_surgery_counts):
                    road_traffic_injuries.rti_do_for_major_surgeries(
                        person_id=person_id, count=count
                    )
            if minor_surgery_counts > 0:
                # shedule minor surgeries
                for count in range(0, minor_surgery_counts):
                    road_traffic_injuries.rti_do_for_minor_surgeries(
                        person_id=person_id, count=count
                    )
        ...
        frac_codes = [
            code for code in frac_codes if code not in codes_treated_elsewhere
        ]
        ...
        for treatment in single_option_treatments:
            ...
            deliberately_untreated_injuries = df.loc[
                person_id, "rt_injuries_left_untreated"
            ]
            injuries_left_to_treat = [
                injury
                for injury in untreated_injuries
                if injury not in deliberately_untreated_injuries
            ]
            no_injuries_for_this_treatment = (
                len(
                    set(injuries_left_to_treat)
                    & set(single_option_treatments[treatment])
                )
                == 0
            )
            ...
            if condition_to_skip:
                ...
                if inj_counts > 0 & df.loc[person_id, "is_alive"]:
                    if treatment == "suture":
                        road_traffic_injuries.rti_ask_for_suture_kit(
                            person_id=person_id
                        )
                    if treatment == "burn":
                        road_traffic_injuries.rti_ask_for_burn_treatment(
                            person_id=person_id
                        )
                    if treatment == "fracture":
                        road_traffic_injuries.rti_ask_for_fracture_casts(
                            person_id=person_id
                        )
                    if treatment == "tetanus":
                        road_traffic_injuries.rti_ask_for_tetanus(person_id=person_id)
                    if treatment == "pain":
                        road_traffic_injuries.rti_acute_pain_management(
                            person_id=person_id
                        )
                    if treatment == "open":
...
class HSI_RTI_Fracture_Cast(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        _, fracturecastcounts = road_traffic_injuries.rti_find_and_count_injuries(
            person_injuries, codes
        )
        # check if they have a fracture that requires a sling
        codes = ["712a"]
        _, slingcounts = road_traffic_injuries.rti_find_and_count_injuries(
            person_injuries, codes
        )
        ...
        assert all(
            injuries in person_injuries.values for injuries in p["rt_injuries_to_cast"]
        )
        ...
        self.module.item_codes_for_consumables_required["fracture_treatment"] = {
            ...
            get_item_code(
                "Bandage, crepe 7.5cm x 1.4m long , when stretched"
            ): slingcounts,
        }
        is_cons_available = self.get_consumables(
            self.module.item_codes_for_consumables_required["fracture_treatment"]
        ...
        if is_cons_available:
            ...
            swapping_codes = [
                code
                for code in swapping_codes
                if code not in injuries_treated_elsewhere
            ]
...
class HSI_RTI_Open_Fracture_Treatment(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        _, open_fracture_counts = road_traffic_injuries.rti_find_and_count_injuries(
            person_injuries, codes
        )
        ...
        # been through the RTI med intervention
        assert df.loc[
            person_id, "rt_diagnosed"
        ], "person sent here has not been diagnosed"
        ...
        if open_fracture_counts > 0:
            self.module.item_codes_for_consumables_required[
                "open_fracture_treatment"
            ] = {
                get_item_code("Ceftriaxone 1g, PFR_each_CMST"): 1,
                get_item_code(
                    "Cetrimide 15% + chlorhexidine 1.5% solution.for dilution _5_CMST"
                ): 1,
        ...
        if is_cons_available:
            ...
            if code[0] in df.loc[person_id, "rt_injuries_for_open_fracture_treatment"]:
                df.loc[person_id, "rt_injuries_for_open_fracture_treatment"].remove(
                    code[0]
                )
        else:
            self.sim.modules["RTI"].schedule_hsi_event_for_tomorrow(self)
...
class HSI_RTI_Suture(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        _, lacerationcounts = road_traffic_injuries.rti_find_and_count_injuries(
            person_injuries, codes
        )
        # Check the person sent here didn't die due to rti, has been through A&E, through Med int
        assert df.loc[
            person_id, "rt_diagnosed"
        ], "person sent here has not been through A and E"
        assert df.loc[person_id, "rt_med_int"], "person sent here has not been treated"
...
class HSI_RTI_Burn_Management(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        _, burncounts = road_traffic_injuries.rti_find_and_count_injuries(
            person_injuries, codes
        )
        ...
        assert df.loc[
            person_id, "rt_diagnosed"
        ], "this person has not been through a and e"
        ...
        if burncounts > 0:
            ...
            if (burncounts > 1) or (
                (len(idx2) > 0) & (random_for_severe_burn > self.prob_mild_burns)
            ):
            ...
            if is_cons_available:
                ...
                swapping_codes = [
                    code for code in swapping_codes if code not in treatment_plan
                ]
                relevant_codes = np.intersect1d(
                    non_empty_injuries.values, swapping_codes
                )
                if len(relevant_codes) > 0:
                    road_traffic_injuries.rti_swap_injury_daly_upon_treatment(
                        person_id, relevant_codes
...
class HSI_RTI_Tetanus_Vaccine(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        assert df.loc[
            person_id, "rt_med_int"
        ], "This person has not been through rti med int"
        # check the person sent here has an injury treated by this module
        codes_for_tetanus = [
            "1101",
            "2101",
...
class HSI_RTI_Acute_Pain_Management(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        for severity in pain_dict.keys():
            _, counts = road_traffic_injuries.rti_find_and_count_injuries(
                person_injuries, pain_dict[severity]
            )
            if counts > 0:
                pain_level = severity
                break
        ...
        if pain_level == "severe":
            ...
            self.module.item_codes_for_consumables_required["pain_management"] = {
                get_item_code(
                    "morphine sulphate 10 mg/ml, 1 ml, injection (nt)_10_IDA"
                ): 1
            }
            is_cons_available = self.get_consumables(
                self.module.item_codes_for_consumables_required["pain_management"]
...
class HSI_RTI_Major_Surgeries(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        _, counts = road_traffic_injuries.rti_find_and_count_injuries(
            persons_injuries, surgically_treated_codes
        )
        if counts == 0:
            logger.debug(
                key="rti_general_message",
        ...
        relevant_codes = np.intersect1d(
            injuries_to_be_treated, surgically_treated_codes
        )
        ...
        if request_outcome:
            ...
            if self.treated_code in codes:
                ...
                if (
                    prob_perm_disability
                    < self.prob_perm_disability_with_treatment_severe_TBI
                ):
                    ...
                    df.loc[person_id, "rt_injuries_for_major_surgery"].append(
                        self.treated_code
                    )
                    assert len(injuries_to_be_treated) == len(
            ...
            if "include_spine_surgery" in self.allowed_interventions:
                ...
                if self.treated_code in codes:
                    ...
                    df.loc[person_id, "rt_injuries_for_major_surgery"].remove(
                        self.treated_code
                    )
                    self.treated_code = "P" + self.treated_code
                    ...
                    for injury in injuries_to_be_treated:
                        if (
                            injury
                            not in df.loc[person_id, "rt_injuries_for_major_surgery"]
                        ):
                            df.loc[person_id, "rt_injuries_for_major_surgery"].append(
                                injury
                            )
            ...
            swapping_codes = [
                code for code in swapping_codes if code in surgically_treated_codes
            ]
...
class HSI_RTI_Minor_Surgeries(HSI_Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id, squeeze_factor):
        ...
        relevant_codes = np.intersect1d(
            df.loc[person_id, "rt_injuries_for_minor_surgery"], surgically_treated_codes
        )
        ...
        if request_outcome:
            ...
            assert (
                treated_code not in df.loc[person_id, "rt_injuries_for_minor_surgery"]
...
class RTI_Medical_Intervention_Death_Event(Event, IndividualScopeEventMixin):
    ...
    def apply(self, person_id):
        ...
        for range_boundaries in probabilities_of_death.keys():
            if (
                df.loc[person_id].rt_ISS_score
                in probabilities_of_death[range_boundaries][0]
            ):
...
class RTI_No_Lifesaving_Medical_Intervention_Death_Event(
    Event, IndividualScopeEventMixin
):
    ...
    def apply(self, person_id):
        ...
        for col in non_empty_injuries:
            ...
            injury_treated_elsewhere = (
                non_empty_injuries[col].values.to_list()[0] in treatment_plan
            )
            injury_not_treated_by_major_surgery = (
                non_empty_injuries[col].values.to_list()[0] not in maj_surg_codes
            )
            condition_to_remove_column = (
                injury_treated_elsewhere or injury_not_treated_by_major_surgery
            )
        ...
        untreated_injuries = [
            code for code in untreated_injuries if code in life_threatening_injuries
        ]
        mais_scores = [1]
        for injury in untreated_injuries:
            mais_scores.append(
...
class RTI_Logging_Event(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        self.death_inc_numerator += (
            n_immediate_death + n_death_post_med + len(df.loc[df.rt_no_med_death])
        )
        ...
        if (n_in_RTI - len(df.loc[df.rt_imm_death])) > 0:
            percent_sought_care = n_sought_care / (
                n_in_RTI - len(df.loc[df.rt_imm_death])
            )
        else:
        ...
        if n_sought_care > 0:
            percentage_admitted_to_ICU_or_HDU = (
                len(df.loc[df.rt_med_int & df.rt_in_icu_or_hdu]) / n_sought_care
            )
        else:
        ...
        if (children_alive - children_in_RTI) > 0:
            inc_rti_in_children = (
                children_in_RTI / ((children_alive - children_in_RTI) * (1 / 12))
            ) * 100000
        else:
            inc_rti_in_children = 0
        if (n_alive - len(diedfromrtiidx)) > 0:
            inc_rti_death = (
                len(diedfromrtiidx) / ((n_alive - len(diedfromrtiidx)) * (1 / 12))
            ) * 100000
        else:
            inc_rti_death = 0
        if (n_alive - len(df.loc[df.rt_post_med_death])) > 0:
            inc_post_med_death = (
                len(df.loc[df.rt_post_med_death])
                / ((n_alive - len(df.loc[df.rt_post_med_death])) * (1 / 12))
            ) * 100000
        else:
            inc_post_med_death = 0
        if (n_alive - len(df.loc[df.rt_imm_death])) > 0:
            inc_imm_death = (
                len(df.loc[df.rt_imm_death])
                / ((n_alive - len(df.loc[df.rt_imm_death])) * (1 / 12))
            ) * 100000
        else:
            inc_imm_death = 0
        if (n_alive - len(df.loc[df.rt_no_med_death])) > 0:
            inc_death_no_med = (
                len(df.loc[df.rt_no_med_death])
                / ((n_alive - len(df.loc[df.rt_no_med_death])) * (1 / 12))
            ) * 100000
        else:
            inc_death_no_med = 0
        ...
        did_not_seek_healthcare = len(
            df.loc[df.rt_road_traffic_inc & ~df.rt_med_int & ~df.rt_diagnosed]
        )
        ...
        if n_alive > 0:
            inc_death_on_scene = (
                (len(df.loc[df.rt_imm_death]) / n_alive) * 100000 * (1 / 12)
            )
        else:
        ...
        try:
            percent_related_to_alcohol = len(
                injuredDemographics.loc[injuredDemographics.li_ex_alc]
        ...
        injured_demography_summary = {
            ...
            "male_age": injuredDemographics.loc[
                injuredDemographics["sex"] == "M", "age_years"
            ].values.tolist(),
            "female_age": injuredDemographics.loc[
                injuredDemographics["sex"] == "F", "age_years"
            ].values.tolist(),
