...
class Mockitis(Module):
    ...
    * `on_birth(mother, child)`
    ...
    def initialise_simulation(self, sim):
        ...
        individual = self.sim.population[0]
        sim.schedule_event(MockRegularIndividualEvent(module=self, person=individual),
                           sim.date + DateOffset(months=2))
...
class MockitisLoggingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        self.module.store['test_stat'].append(infected_total)
