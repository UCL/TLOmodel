    ...
    * `on_birth(mother, child)`
    ...
    PARAMETERS = {
        'p_infection': Parameter(
            Types.REAL, 'Probability that an unfected individual becomes infected'),
        'p_cure': Parameter(
            Types.REAL, 'Probability that an individual is cured'),
    ...
    def initialise_population(self, population):
        ...
        #df.loc means filter for that location
        #df.loc[x,y] = search for where x is true; and return values for  'y'
    ...
    def on_birth(self, mother, child):
        ...
        """
        # needs an inheritance to be initialised.
        child.mi_is_infected=mother.mi_is_infected
...
class MockitisDeathEvent(Event, IndividualScopeEventMixin):
    ...
    def apply(self, individual):
        ...
        if individual.is_alive:
            if individual.date_of_death == self.sim.date:
