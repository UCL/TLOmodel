...
def get_consumable_item_codes_cancers(self) -> Dict[str, int]:
    ...
    cons_dict["screening_biopsy_core"] = {get_item_code("Biopsy needle"): 1}
    ...
    cons_dict["treatment_chemotherapy"] = {get_item_code("Cyclophosphamide, 1 g"): 16800}
    ...
    if "ProstateCancer" == self.name:
        cons_dict["screening_psa_test_core"] = {get_item_code("Prostate specific antigen test"): 1}
        ...
        cons_dict["screening_cystoscopy_core"] = {get_item_code("Cystoscope"): 1}

    elif "OesophagealCancer" == self.name:
        cons_dict["screening_endoscopy_core"] = {get_item_code("Endoscope"): 1}
