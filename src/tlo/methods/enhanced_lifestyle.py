...
class Lifestyle(Module):
    ...
    PARAMETERS = {
        ...
        "init_p_wealth_urban": Parameter(
            Types.LIST, "List of probabilities of category given urban"
        ),
        "init_p_wealth_rural": Parameter(
            Types.LIST, "List of probabilities of category given rural"
        ),
        ...
        "init_or_higher_bmi_f": Parameter(
            Types.REAL, "odds ratio higher BMI if female"
        ),
        "init_or_higher_bmi_rural": Parameter(
            Types.REAL, "odds ratio higher BMI if rural"
        ),
        "init_or_higher_bmi_high_sugar": Parameter(
            Types.REAL, "odds ratio higher BMI if high sugar intake"
        ),
        "init_or_higher_bmi_age3049": Parameter(
            Types.REAL, "odds ratio higher BMI if age 30-49"
        ),
        "init_or_higher_bmi_agege50": Parameter(
            Types.REAL, "odds ratio higher BMI if age ge 50"
        ),
        "init_or_higher_bmi_tob": Parameter(
            Types.REAL, "odds ratio higher BMI if use tobacco"
        ),
        "init_or_higher_bmi_per_higher_wealth": Parameter(
            Types.REAL, "odds ratio higher BMI per higer wealth level"
        ),
        "init_or_higher_bmi_per_higher_wealth_level": Parameter(
            Types.REAL,
            "odds ratio for higher initial bmi category per higher wealth level",
        ),
        "init_p_high_sugar": Parameter(
            Types.REAL, "initital proportion with high sugar intake"
        ),
        "init_p_high_salt_urban": Parameter(
            Types.REAL, "initital proportion with high salt intake"
        ),
        "init_or_high_salt_rural": Parameter(
            Types.REAL, "odds ratio high salt if rural"
        ),
        "init_p_ex_alc_m": Parameter(
            Types.REAL, "initital proportion of men with excess alcohol use"
        ),
        "init_p_ex_alc_f": Parameter(
            Types.REAL, "initital proportion of women with excess alcohol use"
        ),
        "init_p_low_ex_urban_m": Parameter(
            Types.REAL, "initital proportion of men with low exercise urban"
        ),
        ...
        "init_p_tob_age1519_m_wealth1": Parameter(
            Types.REAL,
            "initital proportion of 15-19 year old men using "
            "tobacco, wealth level 1 ",
        ),
        "init_or_tob_f": Parameter(Types.REAL, "odds ratio tobacco use females"),
        "init_or_tob_age2039_m": Parameter(
            Types.REAL, "odds ratio tobacco use age2039 in men"
        ),
        "init_or_tob_agege40_m": Parameter(
            Types.REAL, "odds ratio tobacco use age40+ in men"
        ),
        "init_or_tob_wealth2": Parameter(
            Types.REAL, "odds ratio tobacco use wealth level 2"
        ),
        "init_or_tob_wealth3": Parameter(
            Types.REAL, "odds ratio tobacco use wealth level 3"
        ),
        "init_or_tob_wealth4": Parameter(
            Types.REAL, "odds ratio tobacco use wealth level 4"
        ),
        "init_or_tob_wealth5": Parameter(
            Types.REAL, "odds ratio tobacco use wealth level 5"
        ),
        "init_dist_mar_stat_age1520": Parameter(
            Types.LIST, "proportions never, current, div_wid age 15-20 baseline"
        ),
        "init_dist_mar_stat_age2030": Parameter(
            Types.LIST, "proportions never, current, div_wid age 20-30 baseline"
        ),
        "init_dist_mar_stat_age3040": Parameter(
            Types.LIST, "proportions never, current, div_wid age 30-40 baseline"
        ),
        "init_dist_mar_stat_age4050": Parameter(
            Types.LIST, "proportions never, current, div_wid age 40-50 baseline"
        ),
        "init_dist_mar_stat_age5060": Parameter(
            Types.LIST, "proportions never, current, div_wid age 50-60 baseline"
        ),
        "init_dist_mar_stat_agege60": Parameter(
            Types.LIST, "proportions never, current, div_wid age 60+ baseline"
        ),
        "init_age2030_w5_some_ed": Parameter(
            Types.REAL,
            "proportions of low wealth 20-30 year olds with some "
            "education at baseline",
        ),
        "init_or_some_ed_age0513": Parameter(
            Types.REAL, "odds ratio of some education at baseline age 5-13"
        ),
        "init_or_some_ed_age1320": Parameter(
            Types.REAL, "odds ratio of some education at baseline age 13-20"
        ),
        "init_or_some_ed_age2030": Parameter(
            Types.REAL, "odds ratio of some education at baseline age 20-30"
        ),
        "init_or_some_ed_age3040": Parameter(
            Types.REAL, "odds ratio of some education at baseline age 30-40"
        ),
        "init_or_some_ed_age4050": Parameter(
            Types.REAL, "odds ratio of some education at baseline age 40-50"
        ),
        "init_or_some_ed_age5060": Parameter(
            Types.REAL, "odds ratio of some education at baseline age 50-60"
        ),
        ...
        "init_or_some_ed_sec_age1320": Parameter(
            Types.REAL, "odds ratio of secondary education age 13-20"
        ),
        "init_or_some_ed_sec_age3040": Parameter(
            Types.REAL, "odds ratio of secondary education age 30-40"
        ),
        "init_or_some_ed_sec_age4050": Parameter(
            Types.REAL, "odds ratio of secondary education age 40-50"
        ),
        "init_or_some_ed_sec_age5060": Parameter(
            Types.REAL, "odds ratio of secondary education age 50-60"
        ),
        "init_or_some_ed_sec_agege60": Parameter(
            Types.REAL, "odds ratio of secondary education age 60+"
        ),
        ...
        "init_p_wood_burn_stove_urban": Parameter(
            Types.REAL, "initial probability of wood_burn_stove given urban"
        ),
        # note that init_p_wood_burn_stove is also used as the one-off probability of wood_burn_stove '
        #                                                     'true to false upon move from rural to urban'
        "init_or_wood_burn_stove_rural": Parameter(
            Types.REAL, "initial odds ratio of wood_burn_stove if rural"
        ),
        ...
        "init_or_no_access_handwashing_per_lower_wealth": Parameter(
            Types.REAL,
            "initial odds ratio of no_" "access_handwashing per lower wealth " "level",
        ),
        "init_rp_some_ed_age0513": Parameter(
            Types.REAL, "relative prevalence of some education at baseline age 5-13"
        ),
        "init_rp_some_ed_age1320": Parameter(
            Types.REAL, "relative prevalence of some education at baseline age 13-20"
        ),
        "init_rp_some_ed_age2030": Parameter(
            Types.REAL, "relative prevalence of some education at baseline age 20-30"
        ),
        "init_rp_some_ed_age3040": Parameter(
            Types.REAL, "relative prevalence of some education at baseline age 30-40"
        ),
        "init_rp_some_ed_age4050": Parameter(
            Types.REAL, "relative prevalence of some education at baseline age 40-50"
        ),
        "init_rp_some_ed_age5060": Parameter(
            Types.REAL, "relative prevalence of some education at baseline age 50-60"
        ),
        "init_rp_some_ed_per_higher_wealth": Parameter(
            Types.REAL,
            "relative prevalence of some education at baseline per higher wealth level",
        ),
        "init_rp_some_ed_sec_age1320": Parameter(
            Types.REAL, "relative prevalence of secondary education age 15-20"
        ),
        "init_rp_some_ed_sec_age3040": Parameter(
            Types.REAL, "relative prevalence of secondary education age 30-40"
        ),
        "init_rp_some_ed_sec_age4050": Parameter(
            Types.REAL, "relative prevalence of secondary education age 40-50"
        ),
        "init_rp_some_ed_sec_age5060": Parameter(
            Types.REAL, "relative prevalence of secondary education age 50-60"
        ),
        "init_rp_some_ed_sec_agege60": Parameter(
            Types.REAL, "relative prevalence of secondary education age 60+"
        ),
        ...
        "r_urban": Parameter(
            Types.REAL, "probability per 3 months of change from rural to urban"
        ),
        "r_rural": Parameter(
            Types.REAL, "probability per 3 months of change from urban to rural"
        ),
        ...
        "rr_higher_bmi_urban": Parameter(
            Types.REAL, "probability per 3 months of increase in bmi category if "
        ),
        "rr_higher_bmi_f": Parameter(
            Types.REAL, "rate ratio for increase in bmi category for females"
        ),
        "rr_higher_bmi_age3049": Parameter(
            Types.REAL, "rate ratio for increase in bmi category for age 30-49"
        ),
        "rr_higher_bmi_agege50": Parameter(
            Types.REAL, "rate ratio for increase in bmi category for age ge 50"
        ),
        "rr_higher_bmi_tob": Parameter(
            Types.REAL, "rate ratio for increase in bmi category for tobacco users"
        ),
        ...
        "rr_lower_bmi_tob": Parameter(
            Types.REAL, "rate ratio for lower bmi category for tobacco users"
        ),
        "rr_lower_bmi_pop_advice_weight": Parameter(
            Types.REAL,
            "probability per 3 months of decrease in bmi category "
            "given population advice/campaign on weight",
        ),
        "r_high_salt_urban": Parameter(
            Types.REAL, "probability per 3 months of high salt intake if urban"
        ),
        "rr_high_salt_rural": Parameter(
            Types.REAL, "rate ratio for high salt if rural"
        ),
        "r_not_high_salt": Parameter(
            Types.REAL, "probability per 3 months of not high salt intake"
        ),
        "rr_not_high_salt_pop_advice_salt": Parameter(
            Types.REAL,
            "probability per 3 months of not high salt given"
            "population advice/campaign on salt",
        ),
        "r_high_sugar": Parameter(
            Types.REAL, "probability per 3 months of high sugar intake"
        ),
        "r_not_high_sugar": Parameter(
            Types.REAL, "probability per 3 months of not high sugar intake"
        ),
        "rr_not_high_sugar_pop_advice_sugar": Parameter(
            Types.REAL,
            "probability per 3 months of not high sugar given"
        ...
        "r_not_tob": Parameter(
            Types.REAL,
            "probability per 3 months of change from tobacco using to "
            "not tobacco using",
        ),
        "rr_tob_f": Parameter(Types.REAL, "rate ratio tobacco if female"),
        "rr_tob_age2039": Parameter(
            Types.REAL, "risk ratio for tobacco using if age 20-39 compared with 15-19"
        ),
        "rr_tob_agege40": Parameter(
            Types.REAL, "risk ratio for tobacco using if age >= 40 compared with 15-19"
        ),
        "rr_tob_wealth": Parameter(
            Types.REAL,
            "risk ratio for tobacco using per 1 higher wealth level "
            "(higher wealth level = lower wealth)",
        ),
        "rr_not_tob_pop_advice_tobacco": Parameter(
            Types.REAL,
            "probability per 3 months of quitting tobacco given"
            "population advice/campaign on tobacco",
        ),
        "r_ex_alc": Parameter(
            Types.REAL,
            "probability per 3 months of change from not excess alcohol to "
            "excess alcohol",
        ),
        "r_not_ex_alc": Parameter(
            Types.REAL,
            "probability per 3 months of change from excess alcohol to "
            "not excess alcohol",
        ),
        "rr_ex_alc_f": Parameter(
            Types.REAL,
            "risk ratio for becoming excess alcohol if female rather than male",
        ),
        "rr_not_ex_alc_pop_advice_alcohol": Parameter(
            Types.REAL,
            "probability per 3 months of not excess alcohol given"
            "population advice/campaign on alcohol",
        ),
        "r_mar": Parameter(
            Types.REAL, "probability per 3 months of marriage when age 15-30"
        ),
        "r_div_wid": Parameter(
            Types.REAL,
            "probability per 3 months of becoming divorced or widowed, "
        ...
        "proportion_of_men_that_are_assumed_to_be_circumcised_at_birth": Parameter(
            Types.REAL,
            "Proportion of men that are assumed to be circumcised at birth."
            "The men are assumed to be circumcised at birth.",
        ),
        "proportion_of_men_circumcised_at_initiation": Parameter(
            Types.REAL,
            "Proportion of men (of all ages) that are assumed to be circumcised at the initiation of the"
            "simulation.",
        ),
    ...
    PROPERTIES = {
        ...
        "li_wealth": Property(
            Types.CATEGORICAL,
            "wealth level: 1 (high) to 5 (low)",
            categories=[1, 2, 3, 4, 5],
        ),
        "li_bmi": Property(
            Types.INT,
            "bmi: 1 (<18) 2 (18-24.9)  3 (25-29.9) 4 (30-34.9) 5 (35+)"
            "bmi is 0 until age 15",
        ),
        "li_exposed_to_campaign_weight_reduction": Property(
            Types.BOOL,
            "currently exposed to population campaign for "
        ...
        "li_date_not_tob": Property(
            Types.DATE, "date last transitioned from tob to not tob"
        ),
        ...
        "li_ed_lev": Property(
            Types.CATEGORICAL,
            "education level achieved as of now",
            categories=[1, 2, 3],
        ),
        ...
        "li_no_access_handwashing": Property(
            Types.BOOL,
            "no_access_handwashing - no water, no soap, no other "
            "cleaning agent - as in DHS",
        ),
        "li_no_clean_drinking_water": Property(
            Types.BOOL, "no drinking water from an improved source"
        ),
        ...
        "li_date_acquire_improved_sanitation": Property(
            Types.DATE, "date transition to urban"
        ),
        "li_date_acquire_access_handwashing": Property(
            Types.DATE, "date acquire access to handwashing"
        ),
        "li_date_acquire_clean_drinking_water": Property(
            Types.DATE, "date acquire clean drinking water"
        ),
        "li_date_acquire_non_wood_burn_stove": Property(
            Types.DATE, "date acquire non-wood burning stove"
        ),
    ...
    def initialise_population(self, population):
        ...
        df = (
            population.props
        )  # a shortcut to the data-frame storing data for individuals
        m = self
        rng = m.rng
        ...
        df.loc[urban_index, "li_wealth"] = rng.choice(
            ...
            p=m.parameters["init_p_wealth_urban"],
        )
        df.loc[rural_index, "li_wealth"] = rng.choice(
            [1, 2, 3, 4, 5],
            size=len(rural_index),
            p=m.parameters["init_p_wealth_rural"],
        )
        ...
        init_odds_low_ex_urban_m = m.parameters["init_p_low_ex_urban_m"] / (
        ...
        init_odds_tob_age1519_m_wealth1 = m.parameters[
        ...
        odds_tob.loc[(df.sex == "M") & (df.age_years >= 40)] *= m.parameters[
        ...
        p_some_ed.loc[df.age_years.between(13, 19)] *= m.parameters[
            "init_rp_some_ed_age1320"
        ]
        p_some_ed.loc[df.age_years.between(30, 39)] *= m.parameters[
            "init_rp_some_ed_age3040"
        ]
        p_some_ed.loc[df.age_years.between(40, 49)] *= m.parameters[
            "init_rp_some_ed_age4050"
        ]
        p_some_ed.loc[df.age_years.between(50, 59)] *= m.parameters[
        ...
        p_ed_lev_3 = pd.Series(
            m.parameters["init_prop_age2030_w5_some_ed_sec"], index=age_gte5
        )

        p_ed_lev_3.loc[(df.age_years < 13)] = 0
        p_ed_lev_3.loc[df.age_years.between(13, 19)] *= m.parameters[
            "init_rp_some_ed_sec_age1320"
        ]
        p_ed_lev_3.loc[df.age_years.between(30, 39)] *= m.parameters[
            "init_rp_some_ed_sec_age3040"
        ]
        p_ed_lev_3.loc[df.age_years.between(40, 49)] *= m.parameters[
            "init_rp_some_ed_sec_age4050"
        ]
        p_ed_lev_3.loc[df.age_years.between(50, 59)] *= m.parameters[
            "init_rp_some_ed_sec_age5060"
        ]
        p_ed_lev_3.loc[(df.age_years >= 60)] *= m.parameters[
        ...
        df.loc[
            df.age_years.between(5, 12) & (df["li_ed_lev"] == 1) & df.is_alive,
            "li_in_ed",
        ] = False
        df.loc[
            df.age_years.between(5, 12) & (df["li_ed_lev"] == 2) & df.is_alive,
            "li_in_ed",
        ] = True
        df.loc[
            df.age_years.between(13, 19) & (df["li_ed_lev"] == 3) & df.is_alive,
            "li_in_ed",
        ] = True

        # -------------------- UNIMPROVED SANITATION ---------------------------------------------------
        init_odds_unimproved_sanitation = m.parameters[
        ...
        odds_unimproved_sanitation = pd.Series(
            init_odds_unimproved_sanitation, index=alive_idx
        )

        # update odds according to determinants of unimproved sanitation (rural status the only determinant)
        odds_unimproved_sanitation.loc[df.is_alive & ~df.li_urban] *= m.parameters[
            "init_or_unimproved_sanitation_rural"
        ]

        prob_unimproved_sanitation = odds_unimproved_sanitation / (
            1 + odds_unimproved_sanitation
        )

        random_draw = pd.Series(rng.random_sample(size=len(alive_idx)), index=alive_idx)

        df.loc[alive_idx, "li_unimproved_sanitation"] = (
            random_draw < prob_unimproved_sanitation
        )

        # -------------------- NO CLEAN DRINKING WATER ---------------------------------------------------
        init_odds_no_clean_drinking_water = m.parameters[
            "init_p_no_clean_drinking_water_urban"
        ] / (1 - m.parameters["init_p_no_clean_drinking_water_urban"])

        odds_no_clean_drinking_water = pd.Series(
            init_odds_no_clean_drinking_water, index=alive_idx
        )

        odds_no_clean_drinking_water.loc[df.is_alive & ~df.li_urban] *= m.parameters[
            "init_or_no_clean_drinking_water_rural"
        ]

        prob_no_clean_drinking_water = odds_no_clean_drinking_water / (
            1 + odds_no_clean_drinking_water
        )

        random_draw = pd.Series(rng.random_sample(size=len(alive_idx)), index=alive_idx)

        df.loc[alive_idx, "li_no_clean_drinking_water"] = (
            random_draw < prob_no_clean_drinking_water
        )

        # -------------------- WOOD BURN STOVE ---------------------------------------------------

        init_odds_wood_burn_stove = m.parameters["init_p_wood_burn_stove_urban"] / (
            1 - m.parameters["init_p_wood_burn_stove_urban"]
        )

        odds_wood_burn_stove = pd.Series(init_odds_wood_burn_stove, index=alive_idx)

        odds_wood_burn_stove.loc[df.is_alive & ~df.li_urban] *= m.parameters[
        ...
        odds_no_access_handwashing = pd.Series(
            1 / (1 - m.parameters["init_p_no_access_handwashing_wealth1"]),
            index=alive_idx,
        )

        odds_no_access_handwashing.loc[wealth2_idx] *= m.parameters[
        ...
        prob_no_access_handwashing = odds_no_access_handwashing / (
            1 + odds_no_access_handwashing
        )

        random_draw = pd.Series(rng.random_sample(size=len(alive_idx)), index=alive_idx)

        df.loc[alive_idx, "li_no_access_handwashing"] = (
            random_draw < prob_no_access_handwashing
        )
        ...
        # update odds according to determinants of unimproved sanitation (rural status the only determinant)
        odds_high_salt.loc[df.is_alive & ~df.li_urban] *= m.parameters[
        ...
        df.loc[alive_idx, "li_high_sugar"] = (
            random_draw < m.parameters["init_p_high_sugar"]
        )
        ...
        if len(age_ge15_idx) > 0:
            ...
            agege15_w_idx = df.index[
                df.is_alive & (df.sex == "F") & (df.age_years >= 15)
            ]
            agege15_rural_idx = df.index[
                df.is_alive & ~df.li_urban & (df.age_years >= 15)
            ]
            agege15_high_sugar_idx = df.index[
                df.is_alive & df.li_high_sugar & (df.age_years >= 15)
            ]
            agege3049_idx = df.index[
                df.is_alive & (df.age_years >= 30) & (df.age_years < 50)
            ]
            agege50_idx = df.index[df.is_alive & (df.age_years >= 50)]
            agege15_tob_idx = df.index[df.is_alive & df.li_tob & (df.age_years >= 15)]
            agege15_wealth2_idx = df.index[
                df.is_alive & (df.li_wealth == 2) & (df.age_years >= 15)
            ]
            agege15_wealth3_idx = df.index[
                df.is_alive & (df.li_wealth == 3) & (df.age_years >= 15)
            ]
            agege15_wealth4_idx = df.index[
                df.is_alive & (df.li_wealth == 4) & (df.age_years >= 15)
            ]
            agege15_wealth5_idx = df.index[
                df.is_alive & (df.li_wealth == 5) & (df.age_years >= 15)
            ]
            ...
            def update_df_odds_bmi(bmi: str, power: int):
                ...
                df_odds_probs_bmi_levels.loc[agege15_wealth2_idx, bmi] *= (
                    m.parameters["init_or_higher_bmi_per_higher_wealth_level"] ** 2
                ) ** power
                df_odds_probs_bmi_levels.loc[agege15_wealth3_idx, bmi] *= (
                    m.parameters["init_or_higher_bmi_per_higher_wealth_level"] ** 3
                ) ** power
                df_odds_probs_bmi_levels.loc[agege15_wealth4_idx, bmi] *= (
                    m.parameters["init_or_higher_bmi_per_higher_wealth_level"] ** 4
                ) ** power
                df_odds_probs_bmi_levels.loc[agege15_wealth5_idx, bmi] *= (
                    m.parameters["init_or_higher_bmi_per_higher_wealth_level"] ** 5
                ) ** power
            ...
            bmi_cat = dfxx.apply(
                lambda p_bmi: rng.choice(dfxx.columns, p=p_bmi), axis=1
            )
        ...
        will_be_circ = (
            self.rng.rand(len(men))
            < self.parameters["proportion_of_men_circumcised_at_initiation"]
        )
    ...
    def on_birth(self, mother_id, child_id):
        ...
        df.at[child_id, "li_unimproved_sanitation"] = df.at[
            _id_inherit_from, "li_unimproved_sanitation"
        ]
        df.at[child_id, "li_no_access_handwashing"] = df.at[
            _id_inherit_from, "li_no_access_handwashing"
        ]
        df.at[child_id, "li_no_clean_drinking_water"] = df.at[
            _id_inherit_from, "li_no_clean_drinking_water"
        ]
        df.at[child_id, "li_wood_burn_stove"] = df.at[
            _id_inherit_from, "li_wood_burn_stove"
        ]
    ...
    def determine_who_will_be_sexworker(self, months_since_last_poll):
        ...
        proportion_that_will_stop_being_sexworker = (
            params["fsw_transition"] * months_since_last_poll / 12
        )
        will_stop = sw_idx[
            rng.rand(len(sw_idx)) < proportion_that_will_stop_being_sexworker
        ]
    ...
    def compute_bmi_proportions_of_interest(self):
        ...
        n_agege15_wealth1 = (
            df.is_alive & (df.age_years >= 15) & (df.li_wealth == 1)
        ).sum()
        n_agege15_wealth5 = (
            df.is_alive & (df.age_years >= 15) & (df.li_wealth == 5)
        ).sum()
        ...
        n_bmi_45_f = (
            df.is_alive & (df.age_years >= 15) & (df.li_bmi >= 4) & (df.sex == "F")
        ).sum()
        prop_bmi_45_f = n_bmi_45_f / n_agege15_f
        n_bmi_45_m = (
            df.is_alive & (df.age_years >= 15) & (df.li_bmi >= 4) & (df.sex == "M")
        ).sum()
        prop_bmi_45_m = n_bmi_45_m / n_agege15_m
        n_bmi_45_urban = (
            df.is_alive & (df.age_years >= 15) & (df.li_bmi >= 4) & df.li_urban
        ).sum()
        n_bmi_45_rural = (
            df.is_alive & (df.age_years >= 15) & (df.li_bmi >= 4) & ~df.li_urban
        ).sum()
        ...
        n_bmi_45_wealth1 = (
            df.is_alive & (df.age_years >= 15) & (df.li_bmi >= 4) & (df.li_wealth == 1)
        ).sum()
        prop_bmi_45_wealth1 = n_bmi_45_wealth1 / n_agege15_wealth1
        n_bmi_45_wealth5 = (
            df.is_alive & (df.age_years >= 15) & (df.li_bmi >= 4) & (df.li_wealth == 5)
        ).sum()
        ...
        if prop_bmi_5_urban_m_not_high_sugar_age1529_not_tob_wealth1 > 0:
            bmi_proportions = {
                ...
                "prop_bmi_5_urban_m_not_high_sugar_age1529_not_tob_wealth1": prop_bmi_5_urban_m_not_high_sugar_age1529_not_tob_wealth1,
            }
        else:
            bmi_proportions = {
                "prop_bmi_1": prop_bmi_1,
                ...
                "prop_bmi_45_wealth1": prop_bmi_45_wealth1,
                "prop_bmi_45_wealth5": prop_bmi_45_wealth5,
                "prop_bmi_5_urban_m_not_high_sugar_age1529_not_tob_wealth1": 0,
            }
...
class LifestyleEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        rural_to_urban = currently_rural[
            m.rng.random_sample(size=len(currently_rural)) < m.parameters["r_urban"]
        ]
        df.loc[rural_to_urban, "li_urban"] = True

        # handle new transitions to rural
        urban_to_rural = currently_urban[
            rng.random_sample(size=len(currently_urban)) < m.parameters["r_rural"]
        ]
        ...
        df.loc[adults_not_low_ex, "li_low_ex"] = (
            rng.random_sample(len(adults_not_low_ex)) < eff_p_low_ex
        )
        ...
        eff_rate_not_low_ex.loc[
            df.li_exposed_to_campaign_exercise_increase
        ...
        all_idx_campaign_exercise_increase = df.index[
            df.is_alive
            & (self.sim.date == m.parameters["start_date_campaign_exercise_increase"])
        ]
        df.loc[
            all_idx_campaign_exercise_increase,
        ...
        eff_p_tob.loc[(df.age_years >= 20) & (df.age_years < 40)] *= m.parameters[
            "rr_tob_age2039"
        ]
        eff_p_tob.loc[df.age_years >= 40] *= m.parameters["rr_tob_agege40"]
        eff_p_tob.loc[df.sex == "F"] *= m.parameters["rr_tob_f"]
        eff_p_tob *= m.parameters["rr_tob_wealth"] ** (
            pd.to_numeric(df.loc[adults_not_tob, "li_wealth"]) - 1
        )

        df.loc[adults_not_tob, "li_tob"] = (
            rng.random_sample(len(adults_not_tob)) < eff_p_tob
        )
        ...
        eff_rate_not_tob.loc[df.li_exposed_to_campaign_quit_smoking] *= m.parameters[
        ...
        all_idx_campaign_quit_smoking = df.index[
            df.is_alive
            & (self.sim.date == m.parameters["start_date_campaign_quit_smoking"])
        ]
        ...
        not_ex_alc_f = df.index[
            ~df.li_ex_alc & df.is_alive & (df.sex == "F") & (df.age_years >= 15)
        ]
        not_ex_alc_m = df.index[
            ~df.li_ex_alc & df.is_alive & (df.sex == "M") & (df.age_years >= 15)
        ]
        ...
        df.loc[not_ex_alc_m, "li_ex_alc"] = (
            rng.random_sample(len(not_ex_alc_m)) < m.parameters["r_ex_alc"]
        )
        df.loc[now_ex_alc, "li_ex_alc"] = ~(
            rng.random_sample(len(now_ex_alc)) < m.parameters["r_not_ex_alc"]
        )
        ...
        all_idx_campaign_alcohol_reduction = df.index[
            df.is_alive
            & (self.sim.date == m.parameters["start_date_campaign_alcohol_reduction"])
        ]
        df.loc[
            all_idx_campaign_alcohol_reduction,
            "li_exposed_to_campaign_alcohol_reduction",
        ] = True

        # -------------------- MARITAL STATUS ------------------------------------------------------

        curr_never_mar = df.index[
            df.is_alive & df.age_years.between(15, 29) & (df.li_mar_stat == 1)
        ]
        ...
        age5 = df.index[
            (df.age_exact_years >= 5) & (df.age_exact_years < 5.25) & df.is_alive
        ]
        ...
        prob_primary *= m.parameters["rp_ed_primary_higher_wealth"] ** (
        ...
        age13_in_primary = df.index[
            (df.age_years == 13) & df.is_alive & df.li_in_ed & (df.li_ed_lev == 2)
        ]

        # they have a probability of gaining secondary education (level 3), based on wealth
        prob_secondary = pd.Series(
            m.parameters["p_ed_secondary"], index=age13_in_primary
        )
        prob_secondary *= m.parameters["rp_ed_secondary_higher_wealth"] ** (
        ...
        p_leave_ed *= m.parameters["rr_stop_ed_lower_wealth"] ** (
        ...
        newly_improved_sanitation_idx = unimproved_sanitaton_idx[
            random_draw < eff_rate_improved_sanitation
        ]
        df.loc[newly_improved_sanitation_idx, "li_unimproved_sanitation"] = False
        df.loc[newly_improved_sanitation_idx, "li_date_acquire_improved_sanitation"] = (
            self.sim.date
        )

        # probability of improved sanitation upon moving to urban from rural
        unimproved_sanitation_newly_urban_idx = df.index[
            df.li_unimproved_sanitation
            & df.is_alive
        ...
        eff_prev_unimproved_sanitation_urban = pd.Series(
            m.parameters["init_p_unimproved_sanitation_urban"],
        ...
        eff_rate_access_handwashing = pd.Series(
            m.parameters["r_access_handwashing"], index=no_access_handwashing_idx
        )

        random_draw = rng.random_sample(len(no_access_handwashing_idx))

        newly_access_handwashing_idx = no_access_handwashing_idx[
            random_draw < eff_rate_access_handwashing
        ]
        df.loc[newly_access_handwashing_idx, "li_no_access_handwashing"] = False
        df.loc[newly_access_handwashing_idx, "li_date_acquire_access_handwashing"] = (
            self.sim.date
        )
        ...
        no_clean_drinking_water_idx = df.index[
            df.li_no_clean_drinking_water & df.is_alive
        ]
        ...
        newly_clean_drinking_water_idx = no_clean_drinking_water_idx[
            random_draw < eff_rate_clean_drinking_water
        ]
        df.loc[newly_clean_drinking_water_idx, "li_no_clean_drinking_water"] = False
        df.loc[
            newly_clean_drinking_water_idx, "li_date_acquire_clean_drinking_water"
        ] = self.sim.date

        # probability of no clean drinking water upon moving to urban from rural
        no_clean_drinking_water_newly_urban_idx = df.index[
            df.li_no_clean_drinking_water
            & df.is_alive
            & (df.li_date_trans_to_urban == self.sim.date)
        ]
        ...
        eff_prev_no_clean_drinking_water_urban = pd.Series(
            m.parameters["init_p_no_clean_drinking_water_urban"],
            index=no_clean_drinking_water_newly_urban_idx,
        )

        df.loc[
            no_clean_drinking_water_newly_urban_idx, "li_no_clean_drinking_water"
        ...
        eff_rate_non_wood_burn_stove = pd.Series(
            m.parameters["r_non_wood_burn_stove"], index=wood_burn_stove_idx
        )

        random_draw = rng.random_sample(len(wood_burn_stove_idx))

        newly_non_wood_burn_stove_idx = wood_burn_stove_idx[
            random_draw < eff_rate_non_wood_burn_stove
        ]
        df.loc[newly_non_wood_burn_stove_idx, "li_wood_burn_stove"] = False
        df.loc[newly_non_wood_burn_stove_idx, "li_date_acquire_non_wood_burn_stove"] = (
            self.sim.date
        )
        ...
        eff_rate_high_salt = pd.Series(
            m.parameters["r_high_salt_urban"], index=not_high_salt_idx
        )
        ...
        eff_rate_not_high_salt = pd.Series(
            m.parameters["r_not_high_salt"], index=high_salt_idx
        )
        ...
        all_idx_campaign_salt_reduction = df.index[
            df.is_alive & (self.sim.date == Date(2010, 7, 1))
        ]
        df.loc[
            all_idx_campaign_salt_reduction, "li_exposed_to_campaign_salt_reduction"
        ] = True

        # -------------------- HIGH SUGAR ----------------------------------------------------------

        not_high_sugar_idx = df.index[~df.li_high_sugar & df.is_alive]
        eff_p_high_sugar = pd.Series(
            m.parameters["r_high_sugar"], index=not_high_sugar_idx
        )
        ...
        eff_rate_not_high_sugar = pd.Series(
            m.parameters["r_not_high_sugar"], index=high_sugar_idx
        )
        ...
        df.loc[
            all_idx_campaign_sugar_reduction, "li_exposed_to_campaign_sugar_reduction"
        ] = True
        ...
        age15_idx = df.index[
            df.is_alive & (df.age_exact_years >= 15) & (df.age_exact_years < 15.25)
        ]
        df.loc[age15_idx, "li_bmi"] = 3

        # possible increase in category of bmi

        bmi_cat_1_to_4_idx = df.index[
            df.is_alive & (df.age_years >= 15) & df.li_bmi.between(1, 4)
        ]
        eff_rate_higher_bmi = pd.Series(
            m.parameters["r_higher_bmi"], index=bmi_cat_1_to_4_idx
        )
        ...
        eff_rate_higher_bmi[df.age_years.between(30, 49)] *= m.parameters[
        ...
        eff_rate_higher_bmi[df.li_wealth == 2] *= (
            m.parameters["rr_higher_bmi_per_higher_wealth"] ** 2
        )
        eff_rate_higher_bmi[df.li_wealth == 3] *= (
            m.parameters["rr_higher_bmi_per_higher_wealth"] ** 3
        )
        eff_rate_higher_bmi[df.li_wealth == 4] *= (
            m.parameters["rr_higher_bmi_per_higher_wealth"] ** 4
        )
        eff_rate_higher_bmi[df.li_wealth == 5] *= (
            m.parameters["rr_higher_bmi_per_higher_wealth"] ** 5
        )
        eff_rate_higher_bmi[df.li_high_sugar] *= m.parameters[
            "rr_higher_bmi_high_sugar"
        ]

        random_draw = rng.random_sample(len(bmi_cat_1_to_4_idx))
        newly_increase_bmi_cat_idx = bmi_cat_1_to_4_idx[
            random_draw < eff_rate_higher_bmi
        ]
        df.loc[newly_increase_bmi_cat_idx, "li_bmi"] = df["li_bmi"] + 1

        # possible decrease in category of bmi

        bmi_cat_3_to_5_idx = df.index[
            df.is_alive & df.li_bmi.between(3, 5) & (df.age_years >= 15)
        ]
        eff_rate_lower_bmi = pd.Series(
            m.parameters["r_lower_bmi"], index=bmi_cat_3_to_5_idx
        )
        ...
        newly_decrease_bmi_cat_idx = bmi_cat_3_to_5_idx[
            random_draw < eff_rate_lower_bmi
        ]
        ...
        df.loc[
            all_idx_campaign_weight_reduction, "li_exposed_to_campaign_weight_reduction"
        ] = True

        # --- FSW ---
        self.module.determine_who_will_be_sexworker(
            months_since_last_poll=self.repeat_months
        )
...
class LifestylesLoggingEvent(RegularEvent, PopulationScopeEventMixin):
    ...
    def apply(self, population):
        ...
        logger.info(
            ...
            data=[
                df.loc[
                    df.is_alive & (df.sex == "M") & (df.age_years >= 15)
                ].li_is_circ.mean()
            ],
        )
        ...
        if sum(women_1549) > 0:
            ...
            logger.info(key="proportion_1549_women_sexworker", data=[0])
