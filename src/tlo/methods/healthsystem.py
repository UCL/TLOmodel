...
class HealthSystem(Module):
    ...
    def get_cons_availability(self):
        """Get consumables availability. (Should be equal to what is specified by the parameter, but overwrite with
    ...
    def is_treatment_id_allowed(self, treatment_id: str) -> bool:
        ...
        if not self.service_availability:
            ...
            for s in self.service_availability:
                if '*' in s:
                    stub = s.split('*')[0]
                    if treatment_id.TREATMENT_ID.startswith(stub):
                        return True
        return False
    ...
    def _get_info_about_facility(self, facility_id: int):
        ...
        return FacilityInfo(
            ...
            level=facility_info.Facility_Level,
    ...
    def apply(self, population):
        ...
        if list_of_individual_hsi_event_tuples_due_today:
            ...
            footprints_of_all_individual_level_hsi_event = [
                event_tuple.hsi_event._cached_time_requests
