...
class HealthSystem(Module):
    ...
    def __init__(
        ...
        print("DEBUG: HealthSystem __init__ starting", flush=True)
            ...
            if len(set_capabilities_still_available) > 0:
                ...
                if self.sim.date > next_event_tuple.tclose:
                    ...
                    if not climate_disrupted:
                        ...
                        # than medical staff leaving earlier than planned if seeing another patient
                        # would take them into overtime.
                        if out_of_resources:
                            # Do not run,
                            # Call did_not_run for the hsi_event
                            rtn_from_did_not_run = event.did_not_run()
