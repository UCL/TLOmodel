...
# pd.DataFrame({'Cause = Other':
#                   df.groupby('DeathEvent_Cause').get_group('Other').DeathEvent_Age,
#               'Cause = HIV':
#                   df.groupby('DeathEvent_Cause').get_group('HIV').DeathEvent_Age}).plot.hist(stacked=True)
# plt.show()
