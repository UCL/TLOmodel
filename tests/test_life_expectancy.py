...
def calculate_probability_of_dying(interval_width, fraction_of_last_age_survived, sex, _person_years_at_risk, _number_of_deaths_in_interval) -> pd.DataFrame:
...
def _estimate_life_expectancy(
    ...
    for sex in ['M', 'F']:
        probability_of_dying_in_interval1 = calculate_probability_of_dying(interval_width, fraction_of_last_age_survived, sex, _person_years_at_risk,
        ...
        probability_of_dying_in_interval.at['90'] = 1
        assert probability_of_dying_in_interval1 == probability_of_dying_in_interval
