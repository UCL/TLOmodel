...
def get_dummy_hsi(sim, mother_id, id, fl):
    ...
    hsi_event.facility_info = FacilityInfo(id=id, name=f"Facility_Level_{fl}_Balaka", level=fl, region="Southern")
...
def test_analysis_analysis_events_run_as_expected_and_update_parameters(seed):
    ...
    assert nbparams["prob_pnc_check_newborn"] == l_current_params["pnc_availability_odds"] / (
        l_current_params["pnc_availability_odds"] + 1
    )
...
def test_analysis_events_force_availability_of_consumables_when_scheduled_in_anc(seed):
    ...
    first_anc.facility_info = FacilityInfo(id=1, name="Facility_Level_1a_Balaka", level="1a", region="Southern")
...
def test_analysis_events_force_availability_of_consumables_for_sba_analysis(seed):
    ...
    sba.facility_info = FacilityInfo(id=3, name="Facility_Level_2_Balaka", level="2", region="Southern")
    ...
    cemonc.facility_info = FacilityInfo(id=3, name="Facility_Level_2_Balaka", level="2", region="Southern")
...
def test_analysis_events_force_availability_of_consumables_for_pnc_analysis(seed):
    ...
    # Next define the actual HSI of interest
    pnc = labour.HSI_Labour_ReceivesPostnatalCheck(module=sim.modules["Labour"], person_id=mother_id)
    pnc.facility_info = FacilityInfo(id=3, name="Facility_Level_2_Balaka", level="2", region="Southern")
...
def test_analysis_events_force_availability_of_consumables_for_newborn_hsi(seed):
    ...
    nb_pnc.facility_info = FacilityInfo(id=3, name="Facility_Level_2_Balaka", level="2", region="Southern")
