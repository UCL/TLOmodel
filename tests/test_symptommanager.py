...
def test_make_a_symptom():
    ...
    assert hasattr(symp, 'odds_emergency_care_seeking_in_children')
    assert hasattr(symp, 'odds_emergency_care_seeking_in_adults')
...
def test_register_duplicate_symptoms():
    ...
    symp_with_different_properties = Symptom(name='symptom', odds_emergency_care_seeking_in_children=True)
