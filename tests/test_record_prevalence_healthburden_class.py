...
class HealthBurden(Module):
    ...
    disease_prevalence_log_keys = {'stunting': {'prevalence': ["(0, 'HAZ<-3')", "(0, '-3<=HAZ<-2')", "(0, 'HAZ>=-2')",
                             ...
                             'prostate_cancer': {
                                 'summary_stats': ['total_none', 'total_prostate_confined', 'total_local_ln',
                                                   'total_metastatic']},  # numbers
                             'other_adult_cancers': {
                                 'summary_stats': ['total_none', 'total_metastatic', 'total_site_confined',
                                                   'total_local_ln']},  # numebers
                             'tb': {'tb_prevalence': ['tbPrevActive', 'tbPrevActiveAdult', 'tbPrevActiveChild',
                                                      'tbPrevLatent', 'tbPrevLatentAdult', 'tbPrevLatentChild']}
                             }
